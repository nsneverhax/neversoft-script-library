...
script create_playlist_menu 
	...
	if NOT gotparam no_buss_push
		printpushpopdebuginfo push name = 'create_playlist_menu'
		pushsoundbussparams
		setsoundbussparams $default_bussset time = 0.5
	endif
	if gotparam pop_sound_buss
		printpushpopdebuginfo pop name = 'create_playlist_menu'
		popsoundbussparams
	endif
	if infrontend
