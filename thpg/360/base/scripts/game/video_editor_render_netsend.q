...
script ve_render_edit 
	...
	if ($ve_render_submission = none)
		...
		if isps3
			<legal_box_text> = "Submits your video score only. No actual video data, footage, music, or other materials will be transferred or uploaded from your PLAYSTATION®3 console."
		else
