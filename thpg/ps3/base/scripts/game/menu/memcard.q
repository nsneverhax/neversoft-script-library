...
script memcard_start_saving_icon_anim 
	...
	if isps3
		if gotparam manual_save
			text = "Saving, please do not turn off your system"
		else
			text = "Autosaving, please do not turn off your system"
		endif
	else
