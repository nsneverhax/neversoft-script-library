...
script create_select_outfit_menu \{player = 1}
	...
	if ($current_num_players = 1)
		...
		displaytext {
			...
			pos = (($gs_element_offsets [2]) + (0.0, -19.0))
			scale = 1.3
			font = fontgrid_title_gh3
			just = [center center]
			rgba = [160 80 30 255]
		...
		if (<uppercasestring> = <test_string> && <str_len> > 12)
			setscreenelementprops \{id = os_outfit_style_id_p1
				scale = 1}
			fit_text_in_rectangle id = os_outfit_style_id_p1 dims = ((170.0, 0.0) + (<height> * (0.0, 1.0))) pos = ($gs_element_offsets [3] - (-2.0, 9.0))
...
script select_outfit_create_style_menu \{player = 1}
	...
	if ($current_num_players = 1)
		...
		setscreenelementprops id = os_outfit_name_id_p1 rgba = [250 250 200 255] scale = 1 pos = (($gs_element_offsets [2]) + (0.0, -19.0))
		getscreenelementdims \{id = os_outfit_name_id_p1}
		if (<width> > 240)
			setscreenelementprops \{id = os_outfit_name_id_p1
				scale = 1}
...
script destroy_select_style_menu \{player = 1}
	...
	if ($current_num_players = 1)
		...
		getuppercasestring <curr_style>
		setscreenelementprops id = os_outfit_style_id_p1 text = <uppercasestring>
		setscreenelementprops id = os_outfit_name_id_p1 scale = 1.3 pos = (($gs_element_offsets [2]) + (0.0, -19.0))
		getscreenelementdims \{id = os_outfit_name_id_p1}
		if (<width> > 240)
			setscreenelementprops \{id = os_outfit_name_id_p1
				scale = 1.0}
...
script select_outfit_style_highlight \{player = 1
	...
	if ($current_num_players = 1)
		...
		if (<uppercasestring> = <test_string> && <str_len> > 10)
			setscreenelementprops \{id = os_outfit_style_id_p1
				scale = 1}
			fit_text_in_rectangle id = os_outfit_style_id_p1 dims = ((180.0, 0.0) + (<height> * (0.0, 1.0))) pos = ($gs_element_offsets [3] - (-2.0, 9.0))
		elseif (<uppercasestring> != <test_string> && <str_len> > 16)
			setscreenelementprops \{id = os_outfit_style_id_p1
				scale = 0.75}
		else
