...
wii_add_error2 = 'The friend you are attempting to add already exists in your roster.'
...
wii_saveload_wiimenu = 'Return to the Wii Menu Screen'
...
script get_string_wii \{message = unknown}
	...
	switch <message>
		...
		case no_save_boot
		localized_string = 'No Guitar Hero III save data present. Guitar Hero III uses an Autosave feature. 3 User Blocks of space is required to save game data.\\n\\n Do you want to create a save file now?'
		case no_save_ingame
