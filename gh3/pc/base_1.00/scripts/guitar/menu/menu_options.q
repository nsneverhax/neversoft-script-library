...
script create_options_menu 
	...
	displaytext parent = om_container text = "OPTIONS" pos = (733.0, 110.0) scale = 1.7 just = [center center] rgba = [50 0 0 255] font = text_a11_large z = 10 rot = (<rot> -3) noshadow
	displaytext parent = om_container text = "OPTIONS" pos = (728.0, 115.0) scale = 1.7 just = [center center] rgba = [160 130 105 255] font = text_a11_large z = 9 rot = (<rot> -2) noshadow
