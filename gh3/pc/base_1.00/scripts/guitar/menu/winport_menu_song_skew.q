...
script winport_create_calibrate_lag_menu \{from_in_game = 1}
	...
	upper_helper = "Some computer hardware may cause audio and gameplay to fall out of sync.  If you keep losing sync on sections of steady notes, try adjusting this value."
	createscreenelement {
