...
script winport_calibrate_lag_fill_options \{z = 100}
	...
	new_menu scrollid = winport_cl_scroll vmenuid = winport_cl_vmenu menu_pos = (485.0, 380.0) event_handlers = <calib_eh> exclusive_device = None text_left default_colors = 0
