...
script menu_select_controller_move_up \{controller_index = 0
	...
	formatText checksumName = controller_icon_id 'controller%d_icon' d = <controller_index>
	printf "menu_select_controller_move_up: controller%d_icon" d = <controller_index>
...
script menu_select_controller_move_down \{controller_index = 0}
	unfocus_all_controllers
	formatText checksumName = controller_icon_id 'controller%d_icon' d = <controller_index>
	printf "menu_select_controller_move_down: controller%d_icon" d = <controller_index>
	if ScreenElementExists id = <controller_icon_id>
		<controller_icon_id> :GetTags
		if (<location> = p1)
			if ($p1_ready)
...
script menu_select_controller_try_to_continue \{from_arcadeplay = 0}
	printf "menu_select_controller_try_to_continue: start with controller %d" d = <controller_index>
	formatText checksumName = controller_icon_id 'controller%d_icon' d = <controller_index>
	unfocus_all_controllers
	<controller_icon_id> :GetTags
	if (<location> = p1)
