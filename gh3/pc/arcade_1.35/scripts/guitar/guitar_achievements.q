...
script Achievements_SongWon 
	if ($game_mode = p1_career)
		...
		if ($current_difficulty = beginner)
			total_points_in_career_mode_beginner = (<total_points_in_career_mode_beginner> + $player1_status.score)
			SetGlobalTags achievement_info params = {total_points_in_career_mode_beginner = <total_points_in_career_mode_beginner>}
		endif
