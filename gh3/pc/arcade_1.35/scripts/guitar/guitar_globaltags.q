...
script setup_globaltags 
	globaltag_checksum = initial_v173
...
script setup_init_arcade_adjustments 
	SetGlobalTags \{arcade_adjustments
		params = {
			arcade_credits_for_standard = 4
			arcade_credits_for_continue = 4
			arcade_credits_for_premium = 4
			arcade_credits_for_axeclub = 2
			arcade_credits_per_coin = 1
			arcade_num_bill_pulses = 4
			arcade_credits_for_bonus = 0
			arcade_num_bonus_credits = 4
...
script setup_init_arcade_hardware_adjustments 
	SetGlobalTags \{arcade_hardware_adjustments
		params = {
			...
			master_game_volume = -6
			master_attract_volume = -18
			arcade_attract_audio_on = 0
