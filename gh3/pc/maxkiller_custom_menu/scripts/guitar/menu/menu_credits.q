...
script scrolling_list_add_item \{i = 0}
	...
	if ($0xd4e9be3f = 1)
		0xede04f5d = 0xb9b1474c
	else
		0xede04f5d = credits
	endif
	getarraysize ($<0xede04f5d>)
	if (<i> = <array_size>)
	...
	if structurecontains structure = ($<0xede04f5d> [<i>]) item
		text = (($<0xede04f5d> [<i>]).item)
	else
		text = " "
	endif
	if structurecontains structure = ($<0xede04f5d> [<i>]) heading
		scale = <scale_head>
		color = <color_head>
	...
	if structurecontains structure = ($<0xede04f5d> [<i>]) title
		scale = <scale_title>
		color = <color_title>
		color_shadow = [20 10 5 90]
		shadow_offs = (3.0, 3.0)
	endif
	if structurecontains structure = ($<0xede04f5d> [<i>]) small
		scale = 0.5
		color = <color_body>
		color_shadow = [0 0 0 255]
		shadow_offs = (1.0, 1.0)
