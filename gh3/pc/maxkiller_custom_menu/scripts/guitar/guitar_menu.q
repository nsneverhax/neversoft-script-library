...
script create_main_menu 
	...
	0x61b685d5 = (<training_text_off> + (10.0, 64.0))
	0x028c0a0b = (1.2, 1.2)
	options_text_off = (<0x61b685d5> + (-30.0, 53.0))
	...
	gm_hlinfolist = [
		...
		{
			posl = (<0x61b685d5> + <hilite_off> + (-36.0, 5.0))
			posr = (<0x61b685d5> + <hilite_off> + (183.0, 5.0))
			bedims = (36.0, 36.0)
			posh = (<0x61b685d5> + <hilite_off> + (-12.0, 0.0))
			hdims = (205.0, 43.0)
		}
		{
	...
	createscreenelement {
		...
		text = ""
		event_handlers = [
			{focus retail_menu_focus params = {id = 0x37acddbe}}
			{focus setscreenelementprops params = {id = 0x37acddbe no_shadow}}
			{focus guitar_menu_highlighter params = {
					hlindex = 5
					hlinfolist = <gm_hlinfolist>
					be1id = <bookend1id>
			...
			{unfocus setscreenelementprops params = {id = 0x37acddbe shadow shadow_offs = (3.0, 3.0) shadow_rgba = [0 0 0 255]}}
			{unfocus retail_menu_unfocus params = {id = 0x37acddbe}}
