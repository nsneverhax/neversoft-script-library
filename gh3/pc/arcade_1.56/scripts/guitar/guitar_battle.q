battle_beginner_drain_offset = 0
...
script battle_trigger_on 
	...
	switch <other_player_difficulty>
		case beginner
		<drain_time> = (<drain_time> + $battle_beginner_drain_offset)
		case easy
...
script battle_death_lick \{death_speed = 0.2}
	if NOT ($boss_battle = 1)
		switch <difficulty>
			case beginner
			<death_speed> = ($battlemode_powerups [7].beginner_kill_rate)
			case easy
...
script battle_lightning 
	...
	switch <difficulty>
		case beginner
		<flicker_ammount> = ($battlemode_powerups [0].beginner_flicker)
		case easy
...
script battle_up_difficulty 
	...
	if (<time> > $<other_player_status>.diffup_notes)
		...
		switch <original_difficulty>
			case beginner
			broadcastevent Type = <Type> data = {difficulty = beginner difficulty_text_nl = 'beginner'}
			case easy
			broadcastevent Type = <Type> data = {difficulty = easy difficulty_text_nl = 'easy'}
			case medium
			broadcastevent Type = <Type> data = {difficulty = medium difficulty_text_nl = 'medium'}
...
script battle_whammy_attack 
	...
	switch <difficulty>
		case beginner
		<repair_ammount> = ($battlemode_powerups [6].beginner_repair)
		case easy
...
script battle_broken_string 
	...
	switch <difficulty>
		case beginner
		<repair_ammount> = ($battlemode_powerups [5].beginner_repair)
		case easy
