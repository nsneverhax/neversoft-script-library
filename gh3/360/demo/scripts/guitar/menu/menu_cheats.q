...
script create_cheats_menu 
	...
	if ($entering_cheat = 0)
		...
		displaySprite \{parent = cheats_warning_container
			...
			z = 100}
		displayText \{parent = cheats_warning_container
			Pos = (640.0, 478.0)
			id = first_warning
			just = [
				center
			...
			text = "WARNING: Some active cheats do not work in career modes and online."
			rgba = [
				186
				105
				0
		...
		displayText \{parent = cheats_warning_container
			...
			text = "Also, achievment unlocking and leaderboard posts are turned off."
			rgba = [
				186
				105
				0
	...
	text_params2 = {parent = cheats_vmenu Type = TextElement font = text_a5 rgba = [255 245 225 255] z_priority = 50 rot_angle = 1 Scale = 0.63}
	...
	CreateScreenElement {
		...
		event_handlers = [
			{focus cheats_morph_hilite params = {Pos = (346.0, 206.0)}}
	...
	CreateScreenElement {
		...
		event_handlers = [
			{focus cheats_morph_hilite params = {Pos = (346.0, 229.0)}}
	...
	CreateScreenElement {
		...
		event_handlers = [
			{focus cheats_morph_hilite params = {Pos = (346.0, 252.0)}}
	...
	CreateScreenElement {
		...
		event_handlers = [
			{focus cheats_morph_hilite params = {Pos = (346.0, 275.0)}}
	...
	CreateScreenElement {
		...
		event_handlers = [
			{focus cheats_morph_hilite params = {Pos = (346.0, 298.0)}}
	...
	CreateScreenElement {
		...
		event_handlers = [
			{focus cheats_morph_hilite params = {Pos = (346.0, 321.0)}}
	...
	CreateScreenElement {
		...
		event_handlers = [
			{focus cheats_morph_hilite params = {Pos = (346.0, 344.0)}}
	...
	CreateScreenElement {
		...
		text = "enter cheat"
		event_handlers = [
			{focus cheats_morph_hilite params = {Pos = (346.0, 375.0)}}
