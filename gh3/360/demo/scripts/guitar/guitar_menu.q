...
script create_main_menu 
	...
	0x0ff4474e = (<leaderboards_text_off> + (40.0, 44.0))
	0xe5539404 = (1.2, 1.1)
	...
	gm_hlInfoList = [
		{
			...
			beDims = (40.0, 40.0)
			posH = (<career_text_off> + <hilite_off> + (-10.0, 0.0))
			hDims = (240.0, 57.0)
		} ,
		{
		...
		} ,
		{
			...
			beDims = (38.0, 38.0)
			posH = (<multiplayer_text_off> + <hilite_off> + (-10.0, 0.0))
			hDims = (320.0, 43.0)
		} ,
		{
		...
		} ,
		{
			...
			beDims = (34.0, 34.0)
			posH = (<leaderboards_text_off> + <hilite_off> + (-10.0, -1.0))
			hDims = (232.0, 40.0)
		} ,
		{
			...
			beDims = (36.0, 36.0)
			posH = (<options_text_off> + <hilite_off> + (-12.0, 0.0))
			hDims = (205.0, 43.0)
		} ,
		{
			posL = (<0x0ff4474e> + <hilite_off> + (-30.0, 5.0))
			posR = (<0x0ff4474e> + <hilite_off> + (93.0, 5.0))
			beDims = (36.0, 36.0)
			posH = (<0x0ff4474e> + <hilite_off> + (-10.0, 0.0))
			hDims = (110.0, 43.0)
		}
	]
	<gm_hlIndex> = 0
	...
	CreateScreenElement {
		...
		parent = vmenu_main_menu
		font = <main_menu_font>
		text = "quit placeholder"
		event_handlers = [
			{focus retail_menu_focus params = {id = 0xa3c3e96d}}
			{focus SetScreenElementProps params = {id = 0xa3c3e96d no_shadow}}
			{focus guitar_menu_highlighter params = {
					hlIndex = 7
					hlInfoList = <gm_hlInfoList>
					be1ID = <bookEnd1ID>
			...
			{unfocus SetScreenElementProps params = {id = 0xa3c3e96d Shadow shadow_offs = (3.0, 3.0) shadow_rgba = [0 0 0 255]}}
			{unfocus retail_menu_unfocus params = {id = 0xa3c3e96d}}
