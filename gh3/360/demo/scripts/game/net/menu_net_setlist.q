...
script net_deselect_song 
	...
	SetArrayElement ArrayName = net_setlist_songs globalarray index = (<songlist_index> -2) NewValue = NULL
	SetArrayElement ArrayName = net_setlist_tiers globalarray index = (<songlist_index> -2) NewValue = 0
endscript
