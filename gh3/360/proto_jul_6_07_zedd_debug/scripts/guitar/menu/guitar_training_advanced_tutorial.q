...
script training_4_1_explain 
	...
	training_play_sound \{sound = 0x43d447fa
		wait}
endscript
...
script training_4_2_show_guitar 
	...
	training_play_sound sound = 0xcd5b4019
	...
	training_wait_for_sound sound = 0xcd5b4019
endscript
...
script training_4_2_zoom_guitar 
	...
	training_play_sound sound = 0x8afb3ac9
...
script training_4_2_complete_message 
	...
	training_play_sound sound = 0xb79b1379 wait
...
script training_4_3_explain 
	...
	training_play_sound sound = 0x01f14087 wait
...
script training_4_4_show_guitar 
	...
	training_create_strum_sprites
	pose_strum_fingers pos = middle
	training_play_sound sound = 0x6dd1868d
	...
	pose_fret_fingers color = green
	wait 3 seconds ignoreslomo
	training_wait_for_sound sound = 0x6dd1868d
endscript
...
script training_4_4_complete_message 
	...
	training_play_sound sound = 0x2a71fc5d wait
	destroyscreenelement id = lesson_title_text
endscript
...
script training_4_5_explain 
	...
	training_show_task_header
	training_play_sound sound = 0xa17b8613 wait
	setslomo 1.0
	setslomo_song slomo = 1.0
endscript
...
script training_4_5_complete_message 
	...
	unpausegh3sounds
	unpausegame
	training_play_sound sound = 0xe6dbfcc3 wait
	destroyscreenelement id = lesson_title_text
	createscreenelement {
		type = textelement
		parent = training_container
	...
	training_play_sound sound = 0x7859fb3d wait
	destroyscreenelement id = lesson_title_text
endscript
