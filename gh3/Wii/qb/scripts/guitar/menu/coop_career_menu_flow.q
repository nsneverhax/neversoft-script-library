...
script coop_career_autosave_or_setlist 
	...
	if (<autosave> = 1)
		if ($progression_unlock_tier_last_song = 1)
			hack_ps2_set_saveload_successor_checksum \{coop_career_select_venue_fs}
		else
			hack_ps2_set_saveload_successor_checksum \{coop_career_setlist_fs}
		endif
...
coop_career_select_venue_fs = {
	...
	actions = [
		...
		}
		{
			...
			flow_state = coop_career_split_off_flow_for_character_select_fs
		}
	]
}
