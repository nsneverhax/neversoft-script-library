...
script GuitarEvent_SongWon \{battle_win = 0}
	...
	if NOT ($is_attract_mode = 1)
		...
		if GotParam \{song_complete}
			Change Achievements_SongWonFlag = <song_complete>
		else
...
next_next_beat_time = -1
time_to_next_next_beat = -1
next_next_beat_time2 = -1
time_to_next_next_beat2 = -1

script tempo_matching_iterator 
	printf channel = tempo qs(0x9a1ee7b1) d = <time_offset>
	get_song_prefix song = <song_name>
	...
	Change \{next_next_beat_time = -1}
	Change \{time_to_next_next_beat = -1}
	Change \{next_next_beat_time2 = -1}
	Change \{time_to_next_next_beat2 = -1}
	...
	if NOT (<array_Size> = 0)
		...
		if (<fretbar_count> = <timesig_num>)
			...
			printf channel = tempo qs(0x37f4437c) m = <measure_count> d = ($<song> [<array_entry> - 1])
		else
			printf channel = tempo qs(0x3e2c5a3b) d = ($<song> [<array_entry> - 1])
		endif
		if (<array_entry> < <final_array_entry>)
			...
			if (<next_array_entry> < <final_array_entry>)
				Change next_next_beat_time = ($<song> [<next_array_entry>])
				Change time_to_next_next_beat = ($next_next_beat_time - <marker>)
			else
				Change next_next_beat_time = ($next_beat_time)
				Change time_to_next_next_beat = ($time_to_next_beat)
			endif
		...
		if (<even> = 1)
			...
			if (<next_array_entry> < <final_array_entry>)
				...
				if (<next_array_entry> < <final_array_entry>)
					Change next_next_beat_time2 = ($<song> [<next_array_entry>])
					Change time_to_next_next_beat2 = ($next_beat_time2 - <marker>)
				else
					Change next_next_beat_time2 = ($next_beat_time2)
					Change time_to_next_next_beat2 = ($time_to_next_beat2)
				endif
			else
				Change \{next_beat_time2 = -1}
				Change \{time_to_next_beat2 = -1}
...
script anim_you_rock 
	...
	You_Rock :se_setprops \{background_01_scale = (0.01, 0.4)}
	You_Rock :se_setprops \{background_02_scale = (0.01, 0.42000002)}
	You_Rock :se_setprops \{background_04_scale = (0.01, 0.6)}
	You_Rock :se_setprops \{background_05_scale = (0.01, 0.42000002)}
	You_Rock :se_setprops \{background_06_scale = (0.01, 0.8)}
	You_Rock :se_setprops \{yr_bg_top_scale = (0.4, 0.01)}
	You_Rock :se_setprops \{yr_bg_bot_scale = (0.5, 0.01)}
	You_Rock :se_setprops \{yr_bg_bot_02_scale = (0.25, 0.01)}
	You_Rock :se_setprops \{yr_white_stripe_01_alpha = 0}
	You_Rock :se_setprops \{yr_white_stripe_03_alpha = 0}
	You_Rock :se_setprops \{yr_white_stripe_04_alpha = 0}
	You_Rock :se_setprops \{yr_white_stripe_07_alpha = 0}
	You_Rock :se_setprops \{yr_black_stripe_01_alpha = 0}
	You_Rock :se_setprops \{yr_black_stripe_03_alpha = 0}
	You_Rock :se_setprops \{yr_white_stripe_02_alpha = 0}
	You_Rock :se_setprops \{yr_white_stripe_02b_alpha = 0}
	You_Rock :se_setprops \{yr_black_stripe_01b_alpha = 0}
	You_Rock :se_setprops \{yr_white_stripe_01b_alpha = 0}
	You_Rock :se_setprops \{yr_black_stripe_01c_alpha = 0}
	You_Rock :se_setprops \{yr_black_stripe_01d_alpha = 0}
	You_Rock :se_setprops \{yr_white_stripe_05_alpha = 0}
	You_Rock :se_setprops \{yr_white_stripe_09_alpha = 0}
	You_Rock :se_setprops \{yr_white_stripe_10_alpha = 0}
	You_Rock :se_setprops \{yr_black_stripe_06_alpha = 0}
	You_Rock :se_setprops \{yr_black_stripe_02_alpha = 0}
	You_Rock :se_setprops \{yr_black_stripe_04_alpha = 0}
	You_Rock :se_setprops \{yr_white_stripe_b01_alpha = 0}
	You_Rock :se_setprops \{yr_white_stripe_b02_alpha = 0}
	You_Rock :se_setprops \{yr_bg_top_alpha = 0}
	You_Rock :se_setprops \{yr_bg_bot_alpha = 0}
	You_Rock :se_setprops \{yr_bg_bot_02_alpha = 0}
	You_Rock :se_setprops \{title_alpha = 0}
	You_Rock :se_setprops \{text_alpha = 0}
	Wait \{0.8
		Seconds}
	You_Rock :se_setprops \{you_rock_master_alpha = 1}
	You_Rock :se_setprops \{background_01_alpha = 1}
	You_Rock :se_setprops \{background_01_scale = (3.0, 0.3)
		time = 0.03
		motion = ease_in}
	You_Rock :se_waitprops
	You_Rock :se_setprops \{yr_white_stripe_b01_alpha = 1
		time = 0.02}
	You_Rock :se_setprops \{yr_white_stripe_04_alpha = 1
		time = 0.02}
	You_Rock :se_setprops \{yr_white_stripe_10_alpha = 1}
	You_Rock :se_setprops \{yr_white_stripe_10_scale = (0.120000005, 2.6899998)
		time = 0.02
		motion = ease_in}
	You_Rock :se_waitprops
	You_Rock :se_setprops \{yr_black_stripe_03_alpha = 1
		time = 0.02}
	You_Rock :se_setprops \{yr_white_stripe_01_alpha = 1
		time = 0.02}
	You_Rock :se_setprops \{background_02_alpha = 1}
	You_Rock :se_setprops \{background_02_scale = (3.0, 0.42000002)
		time = 0.02
		motion = ease_in}
	You_Rock :se_waitprops
	You_Rock :se_setprops \{yr_white_stripe_b02_alpha = 1
		time = 0.02}
	You_Rock :se_setprops \{yr_black_stripe_01d_alpha = 1}
	You_Rock :se_setprops \{yr_black_stripe_01d_scale = (0.09500001, 0.8)
		time = 0.02}
	You_Rock :se_waitprops
	You_Rock :se_setprops \{yr_white_stripe_03_alpha = 1
		time = 0.02}
	You_Rock :se_setprops \{background_04_alpha = 1}
	You_Rock :se_setprops \{background_04_scale = (3.0, 0.6)
		time = 0.02
		motion = ease_in}
	You_Rock :se_waitprops
	You_Rock :se_setprops \{yr_black_stripe_02_alpha = 1}
	You_Rock :se_setprops \{yr_black_stripe_02_scale = (0.05, 1.5)
		time = 0.02
		motion = ease_in}
	You_Rock :se_waitprops
	You_Rock :se_setprops \{yr_white_stripe_05_alpha = 1}
	You_Rock :se_setprops \{yr_white_stripe_05_scale = (0.044999998, 4.0)
		time = 0.02
		motion = ease_in}
	You_Rock :se_waitprops
	You_Rock :se_setprops \{yr_white_stripe_02_alpha = 1
		time = 0.02}
	You_Rock :se_setprops \{background_05_alpha = 1}
	You_Rock :se_setprops \{background_05_scale = (3.0, 0.42000002)
		time = 0.02
		motion = ease_in}
	You_Rock :se_waitprops
	You_Rock :se_setprops \{yr_white_stripe_02b_alpha = 1
		time = 0.02}
	You_Rock :se_setprops \{yr_black_stripe_01_alpha = 1
		time = 0.02}
	You_Rock :se_setprops \{yr_bg_bot_alpha = 1}
	You_Rock :se_setprops \{yr_bg_bot_scale = (0.5, 1.4)
		time = 0.02
		motion = ease_in}
	You_Rock :se_setprops \{yr_bg_bot_02_alpha = 1}
	You_Rock :se_setprops \{yr_bg_bot_02_scale = (0.25, 1.5)
		time = 0.02
		motion = ease_in}
	You_Rock :se_waitprops
	You_Rock :se_setprops \{yr_black_stripe_06_alpha = 1
		time = 0.02}
	You_Rock :se_setprops \{background_06_alpha = 1}
	You_Rock :se_setprops \{background_06_scale = (3.0, 0.8)
		time = 0.02
		motion = ease_in}
	You_Rock :se_waitprops
	You_Rock :se_setprops \{yr_white_stripe_09_alpha = 1
		time = 0.02}
	You_Rock :se_setprops \{yr_bg_top_alpha = 1}
	You_Rock :se_setprops \{yr_bg_top_scale = (0.4, 1.3)
		time = 0.02
		motion = ease_in}
	You_Rock :se_waitprops
	You_Rock :se_setprops \{yr_black_stripe_04_alpha = 1
		time = 0.02}
	You_Rock :se_setprops \{yr_black_stripe_04_scale = (0.4, 1.3)
		time = 0.02
		motion = ease_in}
	You_Rock :se_waitprops
	You_Rock :se_setprops \{yr_white_stripe_01b_alpha = 1
		time = 0.02}
	Wait \{0.5
		Seconds}
	You_Rock :se_setprops \{background_03_alpha = 0
		time = 0.1}
	Wait \{0.03
		Seconds}
	You_Rock :se_setprops \{background_05_alpha = 0
		time = 0.1}
	Wait \{0.03
		Seconds}
	You_Rock :se_setprops \{yr_white_stripe_10_scale = (0.120000005, 0.69)
		time = 0.02
		motion = ease_in}
	You_Rock :se_waitprops
	Wait \{0.03
		Seconds}
	You_Rock :se_setprops \{background_04_alpha = 0
		time = 0.1}
	Wait \{0.03
		Seconds}
	You_Rock :se_setprops \{yr_white_stripe_05_scale = (0.044999998, 1.0)
		time = 0.02
		motion = ease_in}
	You_Rock :se_waitprops
	Wait \{0.03
		Seconds}
	You_Rock :se_setprops \{background_06_alpha = 0
		time = 0.1}
	Wait \{0.01
		Seconds}
	You_Rock :se_setprops \{yr_black_stripe_04_alpha = 0
	...
	Wait \{0.03
		Seconds}
	You_Rock :se_setprops \{background_02_alpha = 0
		time = 0.1}
	Wait \{0.03
		Seconds}
	You_Rock :se_setprops \{yr_black_stripe_01c_scale = (0.17, 0.9)
		time = 0.02
		motion = ease_in}
	You_Rock :se_waitprops
	Wait \{0.03
		Seconds}
	You_Rock :se_setprops \{text_scale = (1.0, 1.2)}
	You_Rock :se_waitprops
	...
	Wait \{0.02
		Second}
	You_Rock :se_setprops \{background_01_alpha = 0
		time = 0.1}
	Wait \{0.03
		Seconds}
	You_Rock :se_setprops \{text_scale = (0.2, 0.5)}
	You_Rock :se_waitprops
	You_Rock :se_setprops text_text = <text>
	You_Rock :se_setprops \{text_alpha = 1
		time = 0.02}
	Wait \{0.02
		Second}
	You_Rock :se_setprops \{text_scale = (4.5, 6.2)
		time = 0.03}
	You_Rock :se_waitprops
	Wait \{0.01}
	You_Rock :se_setprops \{text_scale = (1.0, 1.2)
	...
	You_Rock :se_waitprops
	Wait \{0.01}
	You_Rock :se_setprops \{text_scale = (2.3, 2.6)
		time = 0.02}
	You_Rock :se_waitprops
	Wait \{0.01}
	You_Rock :se_setprops \{text_scale = (1.5, 1.8)
		time = 0.02}
	You_Rock :se_waitprops
	Wait \{2
		Seconds}
