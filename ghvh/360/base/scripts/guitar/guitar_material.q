		...
		list = [
			{
				...
				MaterialProps = [
					...
					{
						Name = m_samppass0diffuse
						textureproperty = `tex\models\highway\temp01.dds`
					}
				]
			}
		]
...
ingame_materials = [
	...
	}
	{
		...
		base_props = [
			{
				Name = m_samppass0diffuse
				textureproperty = `tex\models\highway\bm_ice01.dds`
			}
		]
		list = [
			{
	...
	}
	{
		...
		list = [
			{
				Name = mat_ice_chunk01
				MaterialProps = [
					{
						Name = m_sampanimation
						textureproperty = `tex\models\highway\ice_chunk01.dds`
					}
					{
						Name = m_psPass0MaterialColor
						vectorproperty = $col_white
	...
	}
	{
		...
		list = [
			{
				Name = mat_vh_perfglow01
				MaterialProps = [
					{
						Name = m_samppass0diffuse
						textureproperty = `tex\models\highway\vocalhwy_perfglow01.dds`
					}
				]
			}
		]
	...
	}
	{
		...
		list = [
			...
			{
				Name = mat_open_note_star_power_star
				MaterialProps = [
					{
						Name = m_psPass0MaterialColor
						vectorproperty = $col_kick_star
			...
			{
				Name = mat_open_note_star_hammer
				MaterialProps = [
					{
						Name = m_psPass0MaterialColor
						vectorproperty = $col_purple
			...
			{
				Name = mat_open_note_star_power_hammer
				MaterialProps = [
					{
						Name = m_psPass0MaterialColor
						vectorproperty = $col_kick_star
			...
			{
				Name = mat_open_note_star_power_star_hammer
				MaterialProps = [
					{
						Name = m_psPass0MaterialColor
						vectorproperty = $col_kick_star
			...
			}
			{
				...
				MaterialProps = [
					...
					{
						Name = m_samppass1diffuse
						textureproperty = `tex\models\highway\button_open_note_battle01.dds`
					}
					{
						Name = m_pspass2materialcolor
						vectorproperty = [
			...
			{
				Name = mat_open_note_battle_hammer
				MaterialProps = [
					{
						Name = m_psPass0MaterialColor
						vectorproperty = $col_purple
...
script create_materials_from_list 
	...
	if (<material_array_size> > 0)
		...
		printf channel = material qs(0xd1f787aa) a = (<prop>.Name)
...
script destroy_materials_from_list 
	...
	if (<material_array_size> > 0)
		...
		begin
		<prop> = (<list> [<item>])
		printf channel = material qs(0x7f297553) a = (<prop>.Name)
