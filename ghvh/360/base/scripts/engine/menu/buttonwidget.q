...
script button_widget_add_item \{widget_id = widget
	...
	generic_menu_set_total_length id = <id> parent = <parent_id>
endscript
...
script focus_button_widget 
	if ScreenElementExists id = <widget_id>
		...
		if ScreenElementExists id = <text_id>
			<text_id> :se_setprops rgba = ($menu_focus_color)
		endif
...
script unfocus_button_widget 
	if ScreenElementExists id = <widget_id>
		<widget_id> :GetSingleTag text_id
		if ScreenElementExists id = <text_id>
			<text_id> :se_setprops rgba = ($menu_unfocus_color)
		endif
	endif
endscript
