cas_female_lose_anim = [
	...
	}
	{
		...
		drummer_anim_name = d_jeff_lose_fearful
	...
	}
	{
		...
		drummer_anim_name = d_kris_lose_pretentious
	...
	}
	{
		...
		drummer_anim_name = d_kris_lose_tantrum
	...
	}
	{
		...
		singer_anim_name = s_jeff_lose_walkoff
	}
	{
		hidden
		desc_id = lose_walkoff_guitar
		frontend_desc = qs(0x6ea3bec2)
		frontend_anim_name = car_female_lose_walkoff
		guitarist_anim_name = g_jeff_lose_walkoff
		bassist_anim_name = b_jeff_lose_walkoff
		drummer_anim_name = d_jeff_lose_walkoff
		singer_anim_name = g_jeff_lose_walkoff
	}
]
cas_male_lose_anim = [
	{
		...
		bassist_anim_name = gsbd_b_lose_angryatcrowd01
		drummer_anim_name = gsbd_d_lose_angryatcrowd01
	...
	}
	{
		...
		drummer_anim_name = d_jeff_lose_depressed
	...
	}
	{
		...
		drummer_anim_name = d_jeff_lose_pretentious
	...
	}
	{
		...
		drummer_anim_name = gsbd_d_lose_tantrum01
	...
	}
	{
		...
		bassist_anim_name = gbsd_g_lose_bass01
		drummer_anim_name = gbsd_g_lose_drum01
		singer_anim_name = gbsd_g_lose_singer01
	}
	{
		desc_id = lose_wolf
		hidden
		guitarist_anim_name = gbsd_b_lose_guitar01
		bassist_anim_name = [
			gbsd_b_lose_bass01
			gbsd_b_lose_b01
		]
		drummer_anim_name = gbsd_b_lose_drum01
		singer_anim_name = gbsd_b_lose_singer01
	}
	{
		desc_id = lose_alex
		hidden
		guitarist_anim_name = gbsd_d_lose_guitar01
		bassist_anim_name = gbsd_d_lose_bass01
		drummer_anim_name = [
			gbsd_d_lose_drum01
			gbsd_d_lose_b01
		]
		singer_anim_name = gbsd_d_lose_singer01
	}
	{
		desc_id = lose_david
		hidden
		guitarist_anim_name = gbsd_s_lose_guitar01
		bassist_anim_name = gbsd_s_lose_bass01
		drummer_anim_name = gbsd_s_lose_drum01
		singer_anim_name = [
	...
	}
	{
		...
		rhythm_anim_name = bdgs_g_guitarist_lose_01
	}
]
