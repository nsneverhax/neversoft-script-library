cas_female_legs = [
	...
	{
		desc_id = f_rock_legs_hotpants
		frontend_desc = qs(0x87dae698)
		mesh = 'models/CAR/Female/F_Rock_Legs_HotPants.skin'
		materials = [
			f_rock_legs_hotpants_primary
		]
		acc_skeleton = skel_f_rock_legs_hotpants
		acc_ragdoll = rag_f_rock_legs_hotpants
		acc_bones = [
			bone_acc_legs_01
			bone_acc_legs_02
			bone_acc_legs_03
