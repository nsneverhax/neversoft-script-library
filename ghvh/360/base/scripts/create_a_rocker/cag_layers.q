guitar_body_vh1 = [
	{
		pattern = 'tex/models/Characters/Layers/CAG/VH/GTR_Body_Style_VH1_LD_01.dds'
		frontend_desc = qs(0x86c44faf)
		$cag_layers_factoredglobal_0
	}
]
guitar_body_vh2 = [
	{
		pattern = 'tex/models/Characters/Layers/CAG/VH/GTR_Body_Style_VH2_LD_01.dds'
		frontend_desc = qs(0x4b2f3b98)
		$cag_layers_factoredglobal_0
	}
]
guitar_body_vh4 = [
	{
		pattern = 'tex/models/Characters/Layers/CAG/VH/GTR_Body_Style_VH4_LD_01.dds'
		frontend_desc = qs(0x02109270)
		$cag_layers_factoredglobal_0
	}
]
guitar_body_vhshark = [
	{
		pattern = 'tex/models/Characters/Layers/CAG/VH/GTR_Body_Style_VHShark_LD_01.dds'
		frontend_desc = qs(0xce1e134b)
		$cag_layers_factoredglobal_0
	}
]
guitar_body_vhfstrat = [
	{
		pattern = 'tex/models/Characters/Layers/CAG/VH/GTR_Body_Style_VHFstrat_LD_01.dds'
		frontend_desc = qs(0x7fc97f0e)
		$cag_layers_factoredglobal_0
	}
]
guitar_body_vhwolf = [
	{
		pattern = 'tex/models/Characters/Layers/CAG/VH/GTR_Body_Style_VHWolf_LD_01.dds'
		frontend_desc = qs(0x2dc4d1d1)
		$cag_layers_factoredglobal_0
	}
]
guitar_body_vhdlr = [
	{
		pattern = 'tex/models/Characters/Layers/CAG/VH/GTR_Body_Style_VHDLR_LD_01.dds'
