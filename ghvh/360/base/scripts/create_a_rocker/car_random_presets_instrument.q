			...
			cap = [
				{
					...
					pre_layer = [
						...
						{
							texture = `tex/models/characters/layers/cag/gtr_headtock09_dtl_04.img`
							flags = 36
							Color = red_2
						}
					]
