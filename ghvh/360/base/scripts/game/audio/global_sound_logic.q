...
script setup_all_crowd_sounds_based_on_zone 
	...
	if ((<pakname> = 'z_tool') || (<pakname> = 'z_icecave'))
		<venuesize> = 'Large_EXT'
		formatText checksumName = transitiontemp 'Crowd_Transition_%s_Poor_To_Med' s = <venuesize> AddToStringLookup = true
		Change current_crowd_transition_bad_to_neutral = <transitiontemp>
		formatText checksumName = transitiontemp 'Crowd_Transition_%s_Med_To_Poor' s = <venuesize> AddToStringLookup = true
...
script gh_sfx_intro_warmup_fast 
	...
	if ($is_metallifacts = 1)
		setsoundbussparams {Crowd_Beds = {vol = (($default_BussSet.Crowd_Beds.vol))} time = 4}
	else
		setsoundbussparams {Crowd_Beds = {vol = (($default_BussSet.Crowd_Beds.vol))} time = 2}
	endif
endscript
...
menu_music_songs = [
	{
		Stream = menu_music_ainttalkinboutlove
		array = ainttalkinboutlove_menumusic_fretbars
		delay = 0.0
		vol = 1
		offset = 0
	}
	{
		Stream = menu_music_jamiescryin
		array = jamiescryin_menumusic_fretbars
		delay = 0.0
		vol = 1
		offset = 0
	}
	{
		Stream = menu_music_runningwiththedevil
		array = runningwiththedevil_menumusic_fretbars
		delay = 0.0
		vol = 1
		offset = 0
	}
	{
		Stream = menu_music_andthecradlewillrock
		array = andthecradlewillrock_menumusic_fretbars
		delay = 0.0
		vol = -1
		offset = 0
	}
	{
		Stream = menu_music_jump
		array = jump_menumusic_fretbars
		delay = 0.0
		vol = 1
		offset = 0
	}
	{
		Stream = menu_music_meanstreet
		array = meanstreet_menumusic_fretbars
		delay = 0.0
		vol = 1
		offset = 0
	}
	{
		Stream = menu_music_panama
		array = panama_menumusic_fretbars
		delay = 0.0
		vol = 1
		offset = 0
	}
	{
		Stream = menu_music_unchained
		array = unchained_menumusic_fretbars
		delay = 0.0
		vol = 1
		offset = 0
	}
	{
		Stream = menu_music_youreallygotme
		array = youreallygotme_menumusic_fretbars
		delay = 0.0
		vol = 1
		offset = 0
	}
...
script play_win_lose_anim_sound \{skip = 0}
	...
	if NOT (<pak> = z_tool)
		if GotParam \{event}
			switch <event>
				case eddie_lose_01
				SoundEvent \{event = eddie_lose_01}
				case wolf_lose_01
				printf \{channel = sfx
					qs(0x9ab11372)}
				SoundEvent \{event = wolf_lose_01}
				case wolf_lose_02
				SoundEvent \{event = wolf_lose_02}
				case mic_feedback
...
script stopplay_win_lose_anim_sound 
	if GotParam \{eddie_lose_01}
		StopSoundEvent \{eddie_lose_guitar01
			fade_time = 1.0
			fade_type = linear}
	endif
	if GotParam \{wolf_lose_01}
		StopSoundEvent \{wolf_lose_bass01
			fade_time = 1.0
			fade_type = linear}
	endif
	if GotParam \{wolf_lose_02}
		StopSoundEvent \{wolf_lose_bass02
			fade_time = 1.0
			fade_type = linear}
	endif
...
script ecstacyofgold 
	SoundEvent \{event = ecstacyofgoldcrowds}
	Skate8_SFX_Backgrounds_New_Area \{BG_SFX_Area = $current_crowd_looping_bg_area_good}
	PlaySound \{ecstacyofgold
		vol = 4}
	setsoundbussparams {Crowd_Beds = {vol = (($default_BussSet.Crowd_Beds.vol) - 4)} time = 0.1 ignoreslomo}
	Wait \{1
		Second
		ignoreslomo}
	setsoundbussparams {Crowd_Beds = {vol = (($default_BussSet.Crowd_Beds.vol) + 6)} time = 35 ignoreslomo}
endscript

script ecstacyofgoldcrowds 
	Wait \{0.1
		Seconds
		ignoreslomo}
	PlaySound \{ext_lg_crowd_swell_sh_l_01
		vol = 2
		pan1x = -1.0
		pan1y = 0.24000001}
	PlaySound \{ext_lg_crowd_swell_sh_r_01
		vol = 2
		pan1x = 1.0
		pan1y = 0.24000001}
	Wait \{26
		Seconds
		ignoreslomo}
	PlaySound \{ext_lg_crowd_swell_md_l_01
		vol = 2
		pan1x = -1.0
		pan1y = 0.24000001}
	PlaySound \{ext_lg_crowd_swell_md_r_01
		vol = 2
		pan1x = 1.0
		pan1y = 0.24000001}
	Wait \{18
		Seconds
		ignoreslomo}
	PlaySound \{large_ext_crowd_song_transition
		vol = 15
		pan1x = -1.0
		pan1y = 0.24000001
		pan2x = 1.0
	...
	Wait \{3
		Seconds}
	PlaySound \{ext_lg_crowd_swell_lg_l_01
		vol = 6
		pan1x = -1.0
		pan1y = 0.24000001}
	PlaySound \{ext_lg_crowd_swell_lg_r_01
		vol = 6
		pan1x = 1.0
		pan1y = 0.24000001}
	Wait \{2
		Seconds
		ignoreslomo}
	PlaySound \{ext_lg_crowd_applause_l_01
		vol = 2
		pan1x = -1.0
		pan1y = 0.24000001}
	PlaySound \{ext_lg_crowd_applause_r_01
		vol = 2
		pan1x = 1.0
		pan1y = 0.24000001}
endscript
...
script ui_sfx_select 
	if generic_menu_check_big_sfx_state
		PlaySound \{select_sound_big}
	else
		PlaySound \{select_sound_small
			vol = -3}
	endif
endscript
...
script save_confirmed_sfx 
	Wait \{0.1
		Seconds}
	PlaySound \{band_mode_ready
		vol = -7}
endscript

script james_song_1 
	PlaySound \{james_vo_song_1
		vol = 1}
	Wait \{2.5
		Seconds}
	ghm_adjustcrowdintrosurge
endscript

script james_song_2 
	PlaySound \{james_vo_song_2
		vol = 1}
	Wait \{1.3
		Seconds}
	ghm_adjustcrowdintrosurge
...
script james_generic_1 
	PlaySound \{james_vo_generic_1}
	Wait \{2.9
		Seconds}
	ghm_adjustcrowdintrosurge
endscript

script james_generic_10 
	PlaySound \{james_vo_generic_10}
	Wait \{1.5
		Seconds}
	ghm_adjustcrowdintrosurge
endscript

script james_generic_11 
	PlaySound \{james_vo_generic_11}
	Wait \{1.1
		Seconds}
	ghm_adjustcrowdintrosurge
endscript

script james_generic_12 
	PlaySound \{james_vo_generic_12
		vol = 1}
	Wait \{1.2
		Seconds}
	ghm_adjustcrowdintrosurge
...
script james_generic_13 
	PlaySound \{james_vo_generic_13
		vol = 2}
	Wait \{1.2
		Seconds}
	ghm_adjustcrowdintrosurge
...
script james_generic_14 
	PlaySound \{james_vo_generic_14
		vol = 1}
	Wait \{1.5
		Seconds}
	ghm_adjustcrowdintrosurge
...
script james_generic_15 
	PlaySound \{james_vo_generic_15
		vol = 1}
	Wait \{0.8
		Seconds}
	ghm_adjustcrowdintrosurge
...
script james_generic_16 
	PlaySound \{james_vo_generic_16
		vol = 2}
	Wait \{1.2
		Seconds}
	ghm_adjustcrowdintrosurge
...
script james_generic_17 
	PlaySound \{james_vo_generic_17
		vol = 2}
	Wait \{0.5
		Seconds}
	ghm_adjustcrowdintrosurge
...
script james_generic_18 
	PlaySound \{james_vo_generic_18
		vol = 1}
	Wait \{1.7
		Seconds}
	ghm_adjustcrowdintrosurge
...
script james_generic_19 
	PlaySound \{james_vo_generic_19
		vol = 2}
	Wait \{1.2
		Seconds}
	ghm_adjustcrowdintrosurge
...
script james_generic_2 
	PlaySound \{james_vo_generic_2}
	Wait \{1.0
		Seconds}
	ghm_adjustcrowdintrosurge
endscript

script james_generic_20 
	PlaySound \{james_vo_generic_20
		vol = 2}
	Wait \{1.0
		Seconds}
	ghm_adjustcrowdintrosurge
...
script james_generic_3 
	PlaySound \{james_vo_generic_3}
	Wait \{3.4
		Seconds}
	ghm_adjustcrowdintrosurge
endscript

script james_generic_4 
	PlaySound \{james_vo_generic_4
		vol = 1}
	Wait \{2.2
		Seconds}
	ghm_adjustcrowdintrosurge
...
script james_generic_5 
	PlaySound \{james_vo_generic_5}
	Wait \{1.3
		Seconds}
	ghm_adjustcrowdintrosurge
endscript

script james_generic_6 
	PlaySound \{james_vo_generic_6}
	Wait \{1.5
		Seconds}
	ghm_adjustcrowdintrosurge
endscript

script james_generic_7 
	PlaySound \{james_vo_generic_7
		vol = 1}
	Wait \{1.5
		Seconds}
	ghm_adjustcrowdintrosurge
...
script james_generic_8 
	PlaySound \{james_vo_generic_8
		vol = 1}
	Wait \{2.0
		Seconds}
	ghm_adjustcrowdintrosurge
...
script james_generic_9 
	PlaySound \{james_vo_generic_9
		vol = 2}
	Wait \{3.0
		Seconds}
	ghm_adjustcrowdintrosurge
...
script james_encore_2 
	PlaySound \{james_vo_encore_2
		vol = 2}
	Wait \{3.0
		Seconds}
	ghm_adjustcrowdintrosurge
...
script practicedrums_fadein 
	...
	Wait \{5
		Seconds}
	setsoundbussparams {drums_ingame = {vol = (($default_BussSet.drums_ingame.vol))} time = 3.0}
endscript
