...
script jam_tutorial_ghtunes 
	...
	launchevent \{type = unfocus
		target = current_menu}
	jam_tutorial_add_arrow \{pos = (600.0, 212.0)
		life = 2
		scale = 0.5
		rot = 90}
	wait \{3
		seconds}
	jam_tutorial_add_arrow \{pos = (600.0, 246.0)
		life = 2
		scale = 0.5
		rot = 90}
	jam_tutorial_add_arrow \{pos = (600.0, 280.0)
		life = 2
		scale = 0.5
		rot = 90}
	wait \{4
		seconds}
	jam_tutorial_add_arrow \{pos = (540.0, 350.0)
		life = 2
		scale = 0.5
		rot = 90}
	wait \{2
		seconds}
	jam_tutorial_add_arrow \{pos = (580.0, 420.0)
		life = 2
		scale = 0.5
		rot = 90}
