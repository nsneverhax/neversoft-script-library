...
script ui_boot_attract_spawned 
	...
	if isps3
		addarrayelement array = <event_handlers> element = {{pad_l2 ui_boot_attract_wait_for_input params = {}}}
		addarrayelement array = <array> element = {{pad_r2 ui_boot_attract_wait_for_input params = {}}}
...
attract_mode_info = [
	{
		...
		song = panama
		mode = p4_quickplay
		guitar_character_id = eddie_van_halen
		bass_character_id = wolfie
		drum_character_id = alex
		vocals_character_id = dlr
	}
	{
		level = load_z_rome
		song = eruption
