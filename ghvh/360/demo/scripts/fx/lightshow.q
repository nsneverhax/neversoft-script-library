...
lightshow_coloroverrideblend = 1.0
...
script lightshow_addnodeflags 
	...
	createnodeflag \{ls_perf_vanhalen}
endscript
...
script venue_pulsequarteronevents \{amount = 1.03
		time = 0.1}
	if gotparam \{delay}
		requireparams \{[
				events
...
script venue_pulsequarterany 
	setspawninstancelimits \{max = 8
		management = ignore_spawn_request}
	venue_pulsequarteronevents \{events = [
			hitnote_green
			hitnote_red
			hitnote_yellow
			hitnote_blue
