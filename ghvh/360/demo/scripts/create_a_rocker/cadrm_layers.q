singlebasskit2_finishes = [
	...
	{
		pattern = 'tex/models/Characters/Layers/CADrm/Drumshell_VH_01.dds'
		frontend_desc = qs(0x8e478687)
		$cadrm_layers_factoredglobal_27
	}
	{
		pattern = 'tex/models/Characters/Layers/CADrm/Drumshell_VH_02.dds'
		frontend_desc = qs(0xa56ad544)
		$cadrm_layers_factoredglobal_27
	}
	{
		pattern = 'tex/models/Characters/Layers/CADrm/Drumshell_VH_03.dds'
		frontend_desc = qs(0xbc71e405)
		$cadrm_layers_factoredglobal_0
	}
	{
		pattern = 'tex/models/Characters/Layers/CADrm/Drumshell_VH_04.dds'
		frontend_desc = qs(0xf33072c2)
		$cadrm_layers_factoredglobal_27
	}
	{
		pattern = 'tex/models/Characters/Layers/CADrm/Drumshell_VH_05.dds'
		frontend_desc = qs(0xea2b4383)
		$cadrm_layers_factoredglobal_27
	}
]
singlebasskit2_finishes_bassdrum = [
	...
	{
		pattern = 'tex/models/Characters/Layers/CADrm/bass_skin_VH_01.dds'
		frontend_desc = qs(0x8e478687)
		$cadrm_layers_factoredglobal_28
	}
	{
		pattern = 'tex/models/Characters/Layers/CADrm/bass_skin_VH_02.dds'
		frontend_desc = qs(0xa56ad544)
		$cadrm_layers_factoredglobal_28
	}
	{
		pattern = 'tex/models/Characters/Layers/CADrm/bass_skin_VH_03.dds'
		frontend_desc = qs(0xbc71e405)
		$cadrm_layers_factoredglobal_28
	}
	{
		pattern = 'tex/models/Characters/Layers/CADrm/bass_skin_VH_04.dds'
		frontend_desc = qs(0xf33072c2)
		$cadrm_layers_factoredglobal_28
	}
	{
		pattern = 'tex/models/Characters/Layers/CADrm/bass_skin_VH_05.dds'
		frontend_desc = qs(0x16194fcd)
		$cadrm_layers_factoredglobal_28
	}
	{
		pattern = 'tex/models/Characters/Layers/CADrm/bass_skin_VH_05B.dds'
		frontend_desc = qs(0x3d341c0e)
		$cadrm_layers_factoredglobal_28
	}
]
