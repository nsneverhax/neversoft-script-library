cas_male_legs = [
	...
	}
	{
		...
		frontend_desc = qs(0xf7cb9f35)
		mesh = 'models/CAR/Male/M_Punk_Legs_Bullet.skin'
		materials = [
			m_punk_legs_bullet_primary
			m_punk_legs_bullet_secondary
		]
		random_weight = 1.0
		acc_skeleton = skel_m_punk_legs_bullet
		acc_ragdoll = rag_m_punk_legs_bullet
		acc_bones = [
			bone_acc_legs_01
			bone_acc_legs_02
			bone_acc_legs_03
	...
	}
	{
		...
		frontend_desc = qs(0x2e3355e5)
		mesh = 'models/CAR/Male/M_VH_Legs_DLR.skin'
		materials = [
			m_vh_legs_dlr_primary
		]
		random_weight = 0.0
		genre = [
			rock
		...
		price = 200
		locked
		polaroid = voc_linedleather
	}
	{
		desc_id = m_vh_legs_dlr_vintage
		frontend_desc = qs(0x468ee121)
		mesh = 'models/CAR/Male/M_VH_Legs_DLR_Vintage.skin'
		acc_skeleton = skel_m_vh_legs_dlr_vintage
		acc_ragdoll = rag_m_vh_legs_dlr_vintage
		acc_bones = [
			bone_acc_legs_01
			bone_acc_legs_02
			bone_acc_legs_03
		...
		price = 200
		locked
		polaroid = voc_spandexsash
	}
	{
		desc_id = m_vh_legs_eddie_vintage
		frontend_desc = qs(0xc04584d7)
		mesh = 'models/CAR/Male/M_VH_Legs_Eddie_Vintage.skin'
		materials = [
			m_vh_legs_eddie_vintage_primary
			m_vh_legs_eddie_vintage_secondary
		]
		random_weight = 0.0
		genre = [
			rock
		...
		price = 200
		locked
		polaroid = gtr_vintageslacks
	}
	{
		desc_id = m_vh_legs_wolf
		frontend_desc = qs(0x329d074f)
		mesh = 'models/CAR/Male/M_VH_Legs_Wolf.skin'
		materials = [
			m_vh_legs_wolf_primary
		]
		random_weight = 1.0
		random_weight = 0.0
		genre = [
		...
		price = 200
		locked
		polaroid = bas_darkpatched
	}
	{
		desc_id = m_vh_legs_wolf_vintage
		frontend_desc = qs(0xec1321fd)
		mesh = 'models/CAR/Male/M_VH_Legs_Wolf_Vintage.skin'
		materials = [
			m_vh_legs_wolf_vintage_primary
			m_vh_legs_wolf_vintage_secondary
		]
		random_weight = 1.0
		acc_skeleton = skel_m_vh_legs_wolf_vintage
		acc_ragdoll = rag_m_vh_legs_wolf_vintage
		acc_bones = [
			bone_acc_legs_01
			bone_acc_legs_02
			bone_acc_legs_03
	...
	{
		desc_id = m_metl_legs_jeanstight
		frontend_desc = qs(0xd593589f)
		mesh = 'models/CAR/Male/M_Metl_Legs_JeansTight.skin'
		materials = [
	...
	}
	{
		...
		mesh = 'models/CAR/Male/M_Metl_Legs_Zippertight.skin'
		materials = [
	...
	}
	{
		...
		frontend_desc = qs(0x285af878)
		mesh = 'models/CAR/Male/M_Metl_Legs_TooSkinny.skin'
		materials = [
	...
	}
	{
		...
		frontend_desc = qs(0x15024015)
		mesh = 'models/CAR/Male/M_Metl_Legs_Armor.skin'
		random_weight = 0.0
		genre = [
			`heavy metal`
		]
