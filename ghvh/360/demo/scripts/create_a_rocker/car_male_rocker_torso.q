cas_male_torso = [
	...
	{
		desc_id = m_vh_torso_eddie_vintage
		frontend_desc = qs(0x1d5df190)
		mesh = 'models/CAR/Male/M_VH_Torso_Eddie_Vintage.skin'
		materials = [
			m_vh_torso_eddie_vintage_primary
		]
		random_weight = 0.5
		genre = [
			rock
		...
		price = 250
		locked
		polaroid = gtr_rockinstripes
	}
	{
		desc_id = m_vh_torso_dlr_vintage
		frontend_desc = qs(0x5d873d51)
		mesh = 'models/CAR/Male/M_VH_Torso_DLR_Vintage.skin'
		random_weight = 0.5
		genre = [
			rock
		]
		price = 250
		locked
		polaroid = voc_ohsoshiny
	}
	{
		desc_id = m_vh_torso_wolf
		frontend_desc = qs(0xe31c2830)
		mesh = 'models/CAR/Male/M_VH_Torso_Wolf.skin'
		materials = [
			m_vh_torso_wolf_primary
			m_vh_torso_wolf_secondary
		]
		random_weight = 0.5
		genre = [
			rock
		...
		price = 250
		locked
		polaroid = bas_youngrocker
	}
	{
		desc_id = m_vh_torso_wolf_vintage
		frontend_desc = qs(0x324382c9)
		mesh = 'models/CAR/Male/M_VH_Torso_Wolf_Vintage.skin'
		materials = [
			m_vh_torso_wolf_vintage_primary
			m_vh_torso_wolf_vintage_secondary
		]
		random_weight = 0.5
		acc_skeleton = skel_m_vh_torso_wolf_vintage
		acc_ragdoll = rag_m_vh_torso_wolf_vintage
		acc_bones = [
			bone_acc_torso_01
			bone_acc_torso_02
		]
	...
	{
		desc_id = m_vh_torso_dlr
		frontend_desc = qs(0x0d187ae8)
		mesh = 'models/CAR/Male/M_VH_Torso_DLR.skin'
		materials = [
			m_vh_torso_dlr_primary
		]
		random_weight = 0.5
		acc_skeleton = skel_m_vh_torso_dlr
		acc_ragdoll = rag_m_vh_torso_dlr
		acc_bones = [
			bone_acc_torso_01
			bone_acc_torso_02
		]
		...
		price = 250
		locked
		polaroid = voc_diamonddave
	}
	{
		desc_id = m_vh_torso_alex
		frontend_desc = qs(0x2f1c07f4)
		mesh = 'models/CAR/Male/M_VH_Torso_Alex.skin'
		materials = [
			m_vh_torso_alex_primary
		]
		random_weight = 0.5
		genre = [
			rock
	...
	{
		desc_id = eddie_necklace
		frontend_desc = qs(0x79c03279)
		mesh = 'models/CAR/Male/Eddie_Necklace.skin'
		materials = [
			eddie_necklace_primary
		]
		random_weight = 1.0
		genre = [
			rock
		]
		acc_skeleton = skel_eddie_necklace
		acc_ragdoll = rag_eddie_necklace
		acc_bones = [
			bone_acc_torso_01
			bone_acc_torso_02
		]
