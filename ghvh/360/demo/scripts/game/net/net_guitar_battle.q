...
script net_battle_mine_explosion 
	printf \{qs(0x6109fb79)}
	if screenelementexists \{id = battlemode_container}
		battlemode_container :obj_spawnscript net_battle_mine_explosion_spawned params = {pos = <pos> mine_fx_id = <mine_fx_id> player_status = <player_status>}
	endif
endscript

script net_battle_mine_explosion_spawned 
