...
drum_kits = [
	...
	}
	{
		id = avh
		string_id = 'avh'
		name_text = qs(0xa63b75af)
		percussion_id = rockpercussion
		percussion_string_id = 'rockpercussion'
	}
	{
		id = avhsimmons
		string_id = 'avh_simmons'
		name_text = qs(0xa63b75af)
		percussion_id = rockpercussion
		percussion_string_id = 'rockpercussion'
	}
...
script avh_cymbal_startup 
	loadsound \{'Drums/AlexVanHalen/AVH_Crash1'}
endscript

script avh_floortom_startup 
	loadsound \{'Drums/AlexVanHalen/AVH_FlTom1'}
endscript

script avh_hihat_startup 
	loadsound \{'Drums/AlexVanHalen/AVH_HiHat1'}
endscript

script avh_hitom_startup 
	loadsound \{'Drums/AlexVanHalen/AVH_HiTom1'}
	loadsound \{'Drums/AlexVanHalen/AVH_HiTom2'}
endscript

script avh_kick_startup 
	loadsound \{'Drums/AlexVanHalen/AVH_Kick1'}
	loadsound \{'Drums/AlexVanHalen/AVH_Kick2'}
	loadsound \{'Drums/AlexVanHalen/AVH_Kick3'}
endscript

script avh_snare_startup 
	loadsound \{'Drums/AlexVanHalen/AVH_Snare1'}
	loadsound \{'Drums/AlexVanHalen/AVH_Snare2'}
	loadsound \{'Drums/AlexVanHalen/AVH_Snare3'}
	loadsound \{'Drums/AlexVanHalen/AVH_Snare4'}
endscript

script avh_simmons_cymbal_startup 
	loadsound \{'Drums/AlexVanHalenSimmons/AVH_simmons_Crash1'}
endscript

script avh_simmons_floortom_startup 
	loadsound \{'Drums/AlexVanHalenSimmons/AVH_simmons_FlTom1'}
endscript

script avh_simmons_hihat_startup 
	loadsound \{'Drums/AlexVanHalenSimmons/AVH_simmons_HiHat1'}
endscript

script avh_simmons_hitom_startup 
	loadsound \{'Drums/AlexVanHalenSimmons/AVH_simmons_HiTom1'}
endscript

script avh_simmons_kick_startup 
	loadsound \{'Drums/AlexVanHalenSimmons/AVH_simmons_Kick1'}
endscript

script avh_simmons_snare_startup 
	loadsound \{'Drums/AlexVanHalenSimmons/AVH_simmons_Snare1'}
	loadsound \{'Drums/AlexVanHalenSimmons/AVH_simmons_Snare2'}
	loadsound \{'Drums/AlexVanHalenSimmons/AVH_simmons_Snare3'}
	loadsound \{'Drums/AlexVanHalenSimmons/AVH_simmons_Snare4'}
endscript
