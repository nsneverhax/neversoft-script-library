...
script make_character_selection_menu {
	...
	character_selection :Obj_SpawnScriptNow \{spin_object
		params = {
			Name = alias_anim_tone_knob
		}}
endscript
...
script character_selection_focus 
	...
	if ScreenElementExists \{id = character_selection}
		...
		character_selection :se_setprops \{character_selection_name_rgba = [
				146
				7
				10
				255
			]}
		character_selection :se_setprops character_selection_name_font = ($test_menu_font)
		character_selection :se_setprops \{character_selection_name_material = 0x00000000}
		character_selection :se_setprops \{character_selection_bio_text = qs(0x00000000)}
		character_selection :se_setprops \{character_selection_bio_dims = (310.0, 470.0)}
...
script character_selection_animate_bio 
	...
	0xa6d122d3 = (470)
	if (<height> > <0xa6d122d3>)
		time = ((<height> - <0xa6d122d3>) * 0.05)
		offset = ((<0xa6d122d3> - <height>) * (0.0, 1.0))
		Wait \{5
			Seconds}
		begin
		if ScreenElementExists id = <id>
...
script character_purchase_focus 
	if ScreenElementExists \{id = character_purchase}
		if (<item> = yes)
			...
			character_purchase :se_setprops \{character_purchase_menu_yes_material = 0x00000000}
		else
			...
			character_purchase :se_setprops \{character_purchase_menu_no_material = 0x00000000}
		endif
	endif
endscript
