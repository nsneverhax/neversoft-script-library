...
script debug_trigger_star_power \{player_status = player1_status
		Player = 1
		player_text = 'p1'}
	begin
	...
	star_power_activate_and_drain player_status = <player_status> Player = <Player> player_text = <player_text>
endscript
