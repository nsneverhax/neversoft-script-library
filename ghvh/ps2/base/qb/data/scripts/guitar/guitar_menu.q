...
g_menu_colors = {
	...
	menu_backstage_focus = [
		146
		7
		10
		255
	]
	menu_backstage_unfocus = [
		0
		0
		0
		255
...
script set_focus_color rgba = (($g_menu_colors).menu_main_focus)
	Change menu_focus_color = <rgba>
endscript

script set_unfocus_color rgba = (($g_menu_colors).menu_main_unfocus)
...
user_control_text_font = fontgrid_text_a6
...
script clean_up_user_control_helpers 
	...
	Change \{pill_helper_max_width = 180}
...
script add_user_control_helper \{z = 10}
	...
	0x8e85a479 = 0
	<id> :se_setprops {
		dims = (((0.6, 0.0) * <helper_pill_menu_dims> [0]) + (40.0, 56.0) + (1.0, 0.0) * <0x8e85a479>)
	}
	user_control_container :se_getprops
	user_control_container :se_setprops {
		helper_pill_body_dims = (((0.85, 0.0) * <helper_pill_menu_dims> [0]) + (40.0, 56.0))
	}
	user_control_container :se_getprops
	user_control_container :se_setprops {
		helper_pill_end_dims = (((1.0, 0.0) * <helper_pill_end_dims>) + ((0.0, 1.0) * <helper_pill_menu_dims>))
	}
	if ((<helper_pill_menu_dims> [0] * 0.93499994) > ($action_safe_width_for_helpers))
		Scale = ((($action_safe_width_for_helpers) * 1.0) / (<helper_pill_menu_dims> [0] * 0.93499994))
		if (<Scale> < 0.9)
			Scale = ((1.0, 0.0) * <Scale> + (0.0, 0.9))
		endif
		user_control_container :se_setprops Scale = <Scale>
	endif
