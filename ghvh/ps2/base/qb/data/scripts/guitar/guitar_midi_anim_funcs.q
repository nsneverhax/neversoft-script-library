...
script band_setikchain \{chord_blend_time = 0
	...
	if (<Chain> = guitar)
		...
		band_enableautochords Name = <Name> blendtime = <chord_blend_time> allow_in_2player = <allow_in_2player>
	...
	elseif (<Chain> = slave)
		...
		band_disableautochords Name = <Name> blendtime = <chord_blend_time> allow_in_2player = <allow_in_2player>
...
script ae_disableautochords \{blendtime = $enable_chord_blend_time}
	...
	Obj_GetID
	band_disableautochords Name = <objID> blendtime = <blendtime> allow_in_2player = true
endscript

script ae_enableautochords \{blendtime = $enable_chord_blend_time}

	Obj_GetID
	band_enableautochords Name = <objID> blendtime = <blendtime> allow_in_2player = true
endscript
...
script band_playtransitionidles \{from_restart = FALSE}
	...
	if is_vanhalen_song
		if (<Band> = band_vanhalen_dlr_guitar)
...
script bandmanager_turnonarmanims 
	band_enableautostrums Name = <Name> allow_in_2player = true
	band_enableautofret Name = <Name> allow_in_2player = true
	band_enableautochords Name = <Name> allow_in_2player = true
endscript
