...
rock_meter_debug = 0
ps2_venues = 0
current_song = ainttalkinboutlove
current_difficulty_coop = easy
current_level = load_z_starwood
...
script get_heap_sizes 
	...
	switch <Platform>
		case PS2
		<heap_size_globalpak> = (20 * 16 * 1024 + 25 * 1024)
		<heap_size_globalpak_vram> = (0 * 1024)
		<heap_size_audio> = (0 * 1024)
		<heap_size_audio_vram> = (0 * 1024)
		<heap_size_musician> = (686 * 1024)
		<heap_size_musician_vram> = (0 * 1024)
		<heap_size_musician_anim> = ((31 * 128 + 68) * 1024)
		<heap_size_cas> = (2154 * 1024)
		<heap_size_cas_vram> = (0 * 1024 * 1024)
		<heap_size_song> = ((11 * 128 + 176) * 1024)
		<heap_size_zones> = ((1800) * 1024)
		<heap_size_zones_vram> = (0 * 1024)
		<heap_size_ui_pak_slot> = (1 * 1024 * 1024)
...
script guitar_startup 
	...
	MemInitHeap Name = 'heap_musician1' size = (<heap_size_musician> + (31 * 1024)) vram_size = <heap_size_musician_vram>
	MemInitHeap Name = 'heap_musician2' size = (<heap_size_musician> + (67 * 1024)) vram_size = <heap_size_musician_vram>
	...
	0x8dbdaee4 \{qs(0x713755f7)}
	0x8dbdaee4 \{bg_color = green
		qs(0xb112f94e)}
	0x8dbdaee4 \{bg_color = green
		qs(0x805f0e6f)}
	0x8dbdaee4 \{bg_color = green
