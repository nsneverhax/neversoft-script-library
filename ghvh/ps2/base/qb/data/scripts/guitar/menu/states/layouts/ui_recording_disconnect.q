...
script ui_recording_disconnect_update \{training = 0}
	...
	if (((<controller_type> != guitar) && (<controller_type> != drum)) || <is_active_controller> != 1)
		if (<training> = 1)
			0x74199ba6 0x0921d53f = ($0x4b8010e3)
		else
			0x74199ba6 0x0921d53f = ($0x874323c2)
		endif
	else
...
script 0x74199ba6 0x0921d53f = ($0x603b76f0)
	if ($primary_controller < 0)
		subtext = qs(0x00000000)
	elseif ($primary_controller < 2)
		formatText TextName = subtext ($0xe31ed55d) d = (($primary_controller) + 1)
	else
		subtext = ($0x80d5c02e)
	endif
