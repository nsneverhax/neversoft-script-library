...
script create_popup_warning_menu_option 
	...
	set_focus_color
	set_unfocus_color
	0x6a77b08a = (10.0, 50.0)
	0x1815b33b = `expand	dims`
	if StructureContains structure = <option> text
		StringLength string = (<option>.text)
		if (<str_len> > 24)
			0x6a77b08a = (540.0, 110.0)
			0x1815b33b = wrap
		endif
	endif
	CreateScreenElement {
