...
script ui_win_song_career_continue_spawned 
	...
	0x8dbdaee4 qs(0x13394d28) n = <array_Size>
	if NOT CD
		if ($is_in_debug = 1)
	...
	elseif progression_should_show_credits
		if progression_shown_credits_before
			generic_event_choose \{state = uistate_bonus_videos_credits
				data = {
					end_credits = 1
				}}
		else
			generic_event_choose \{state = uistate_endgame_unlock}
		endif
	else
