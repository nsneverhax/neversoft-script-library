...
script ui_create_song_extras_lyrics 
	...
	CreateScreenElement {
		...
		event_handlers = [
			...
			{pad_back song_lyrics_back params = {selected_index = <selected_index> from_backstage = <from_backstage> from = lyrics data = {double_kick_alpha = <double_kick_alpha> double_kick_pos = <double_kick_pos>}}}
		]
	}
