...
script 0x1860d142 
	...
	if GotParam \{0xb66264f5}
		...
		new_height = (225 / <array_Size>)
		if (<new_height> > 45)
			<new_height> = 45
		endif
		new_dims = ((200.0, 0.0) + ((0.0, 1.0) * <new_height>))
		CreateScreenElement {
			id = <element_id>
		...
		i = (<i> + 1)
		repeat <array_Size>
		0x8dbdaee4 channel = 0xa97167ab qs(0xd60345d0) s = <objID>
		0xe6b61ea6 channel = 0xa97167ab <objID>
...
script 0x7b3d6e40 
	...
	if GotParam \{Hide}
		...
		0x8dbdaee4 \{'SHOWING'}
		<objID> :se_setprops reposition_pos = (0.0, -30.0) time = 0.1 motion = ease_out
	endif
	<objID> :se_waitprops
endscript
...
script 0x79ac86f3 \{offset = (0.0, 34.0)
		start_pos = (0.0, -145.0)
		0xbbaeec67 = -1}
	Wait \{1
		gameframes}
	...
	if (<0xbbaeec67> = -1)
		...
		scale_width = (1.0, 0.0)
		scale_height = ((0.0, 1.3) * ((<height>) / 64.0))
		Scale = (<scale_width> + <scale_height>)
		GetScreenElementPosition id = <0x14b22443>
		screenelementpos = (<screenelementpos> + (<start_pos>))
...
script 0x2e06a6ea 
	...
	if (<name_text> != <0x734dbcdd>)
		...
		<current_desc> :se_setprops name_text = <0x734dbcdd> name_dims = (20.0, 40.0) namemenu_dims = (20.0, 40.0) name_alpha = 1.0
		<current_desc> :se_getprops
		X = ((248 - (<name_dims> [0])) / 2)
...
script 0x788dd207 
	...
	if GotParam \{unlocked}
		generic_event_choose state = uistate_play_song data = {selected_level = ($gh4_3_intro_tier.level)}
	else
