...
calibrate_lag_early_window = -200
calibrate_lag_late_window = 300
...
script menu_calibrate_lag_create_circles 
	...
	CreateScreenElement {
		...
		Pos = ($calibrate_lag_menu_line_pos + (48.0, 48.0))
	...
	CreateScreenElement {
		...
		parent = cl_container
		Pos = ($calibrate_lag_menu_line_pos + (52.0, 48.0))
		Scale = (1.0, 1.0)
		text = qs(0x03ac90f0)
	...
	getfps
	<seconds_between_circles> = (60.0 / <fps>)
