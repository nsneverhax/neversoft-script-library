...
script ui_band_name_logo_mode \{mode = main
	...
	switch (<mode>)
		...
		if IsGuitarController \{controller = $band_name_logo_controller}
			AddArrayElement array = <event_handlers> element = {pad_square ui_band_name_logo_random_name}
		elseif isdrumcontroller \{controller = $band_name_logo_controller}
			AddArrayElement array = <event_handlers> element = {pad_L1 ui_band_name_logo_random_name}
		else
			AddArrayElement array = <event_handlers> element = {pad_R2 ui_band_name_logo_random_name}
		endif
		event_handlers = <array>
		if NOT GotParam \{from_save}
			AddArrayElement array = <event_handlers> element = {pad_back generic_event_back}
			event_handlers = <array>
		endif
