...
script update_battle_alert_icon \{player_status = player1_status}
	<player_text> = ($0x57e22f28 [$<player_status>.Player])
	ExtendCrc battle_alert_container <player_text> out = battle_alert_container_id
		...
		if (<lefty>)
			if (<harder>)
				if (<double>)
					...
					change_battle_alert_back player_text = <player_text> bg = ba_icon_fill_hard_lefty Scale = (1.0, 1.0)
				...
				change_battle_alert_back player_text = <player_text> bg = ba_icon_fill_double_lefty Scale = (1.0, 1.0)
