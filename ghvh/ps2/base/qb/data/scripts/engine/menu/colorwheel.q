...
color_wheel_arrow_anim_speed = 0.7
...
script color_wheel_turn_on_slice_boarders 
	...
	begin
	formatText checksumName = inc_id 'color_section_%i_%j' i = <i> j = <j>
	SetScreenElementProps id = <inc_id> z_priority = (<z_priority> + 4)
	GetScreenElementChildren id = <inc_id>
	GetArraySize <children>
	k = 0
	begin
	SetScreenElementProps id = (<children> [<k>]) z_priority = (<z_priority> + 0)
...
script color_wheel_turn_off_slice_boarders 
	...
	begin
	formatText checksumName = inc_id 'color_section_%i_%j' i = <i> j = <j>
	SetScreenElementProps id = (<inc_id>) z_priority = (<z_priority> + 2)
	GetScreenElementChildren id = <inc_id>
	GetArraySize <children>
	k = 0
	begin
