...
script focus_button_widget 
	...
	<widget_id> :GetSingleTag 0x0e1d73cb
	if GotParam \{0x0e1d73cb}
	...
	if generic_menu :desc_resolvealias \{Name = alias_highlight}
		...
		Scale = (((1.0, 0.0) * (((<width> + 40.0) / 256.0))) + (0.0, 1.2))
		offset = ((1.0, 0.0) * (<width> / 2) + (5.0, 20.0))
