...
script create_ui_visualizer 
	visualizer = ui_visualizer_viewport_params
	viewport = ui_visualizer_viewport
	create_ui_visualizer_viewport visualizer = <visualizer> viewport = <viewport>
	spawnscriptnow create_ui_visualizer_fx params = {viewport = <viewport> visualizer = <visualizer>}
endscript
...
script create_ui_visualizer_fx \{preset = $default_ui_visualizer_preset}
...
script change_ui_visualizer_preset 
	if NOT gotparam \{preset}
		return
	endif
	visualizer = ui_visualizer_viewport_params
	viewport = ui_visualizer_viewport
	killspawnedscript \{name = create_ui_visualizer_fx}
	spawnscriptnow create_ui_visualizer_fx params = {viewport = <viewport> visualizer = <visualizer> preset = <preset>}
endscript
