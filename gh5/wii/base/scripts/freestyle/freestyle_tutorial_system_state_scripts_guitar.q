...
script freestyle_tutorial_guitar_play_interactive_init 
	freestyle_tutorial_spawn_goal_counter \{goal_total = 5}
endscript

script freestyle_tutorial_guitar_play_interactive_deinit 
	freestyle_tutorial_goal_counter_kill
	freestyle_tutorial_spawn_complete_notification
endscript

script freestyle_tutorial_guitar_play_interactive_strum_handler 
	if ((<pattern> = 65536) || (<pattern> = 4096) || (<pattern> = 256) || (<pattern> = 16) || (<pattern> = 1))
