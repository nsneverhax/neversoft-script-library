...
script freestyle_tutorial_init 
	...
	freestyle_tutorial_info_pane :desc_resolvealias \{Name = alias_skull_add_container}
	<resolved_id> :obj_spawnscript ui_shakey
	<resolved_id> :obj_spawnscript ui_frazzmatazz
	freestyle_tutorial_info_pane :desc_resolvealias \{Name = header_animatable}
