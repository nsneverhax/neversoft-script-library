...
script launch_toggle_animcache_state \{display_offset = (0.0, 0.0)}
	ScriptAssert \{'launch_toggle_animcache_state: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript
...
script launch_toggle_feeler_stats \{display_offset = (0.0, 0.0)}
	ScriptAssert \{'launch_toggle_feeler_stats: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript
