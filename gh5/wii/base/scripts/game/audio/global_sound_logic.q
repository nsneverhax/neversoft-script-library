...
script gh5_band_screen_ui_sound \{player_num = 2}
	...
	if GotParam \{up}
		...
		PlaySound lobbyscroll01 vol = -3 pitch = 1 buss = Front_End pan1x = <pan1x> pan1y = <pan1y> pan2x = <pan2x> pan2y = <pan2y>
	endif
	if GotParam \{down}
		printf \{channel = sfx
			qs(0x603e66a7)}
		stopsound \{lobbyscroll01}
		PlaySound lobbyscroll01 vol = -3 buss = Front_End pan1x = <pan1x> pan1y = <pan1y> pan2x = <pan2x> pan2y = <pan2y>
	endif
	if GotParam \{choose}
		printf \{channel = sfx
			qs(0x03d77756)}
		stopsound \{lobbyselecta}
		PlaySound lobbyselecta vol = 3 buss = Front_End pan1x = <pan1x> pan1y = <pan1y> pan2x = <pan2x> pan2y = <pan2y>
	endif
	if GotParam \{back}
		printf \{channel = sfx
			qs(0x3e573add)}
		stopsound \{lobbyback06}
		PlaySound lobbyback06 vol = -2 buss = Front_End pan1x = <pan1x> pan1y = <pan1y> pan2x = <pan2x> pan2y = <pan2y>
	endif
...
script Guitar_Wrong_Note_Sound_Logic \{vol = 0.0
	...
	PlaySound <soundasset> vol = (<vol> + 10) pitch = <pitch> buss = <newbuss> pan1x = <pan1x> pan1y = <pan1y> pan2x = <pan2x> pan2y = <pan2y> Priority = 90 panremovecenter = true controllers = {controller1 = (<controller>)}
