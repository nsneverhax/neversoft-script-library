...
script has_user_layers 
	ScriptAssert \{'has_user_layers: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript
...
script add_cap_array_to_part 
	ScriptAssert \{'add_cap_array_to_part: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript
...
script average_layer_translation 
	ScriptAssert \{'average_layer_translation: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript
...
script widget_accept_cap 
	...
	if GotParam \{part}
		...
		if GotParam \{only_rotate}
			menu_finish \{car_helper_text_back_rotate}
		else
			if GotParam \{no_rotate_zoom}
				menu_finish \{car_helper_text_back
					no_rotate_text
