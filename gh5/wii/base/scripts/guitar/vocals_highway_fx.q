...
script vocals_setup_paint_material \{Player = 1}
	...
	creatematerial {
		...
		MaterialProps = [
			...
			{Name = m_pscolors1 vectorproperty = [0.98999995 0.90999997 0.21000001 1.5]}
...
script vocals_paint_star_power_off \{Player = 1}
	...
	vocalshighway_getmaterial Player = <Player>
	setmaterialproperty mat = <vocals_highway_material_text> prop = 'm_psColors0' X = 0.98999995 y = 0.90999997 z = 0.21000001 w = 0.0
	setmaterialproperty mat = <vocals_highway_material_text> prop = 'm_psColors1' X = 0.98999995 y = 0.90999997 z = 0.21000001 w = 1.0
