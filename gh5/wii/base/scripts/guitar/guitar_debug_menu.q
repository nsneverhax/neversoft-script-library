...
script create_debugging_menu 
	...
	add_generic_menu_text_item {
		text = qs(0x5fe12b3e)
		pad_choose_script = create_unlocks_menu
		pad_choose_params = {from_gameplay = <from_gameplay>}
	}
...
endscript
spotlight_enabled = 0
toggle_spotlight_menuitem = 0

script toggle_spotlight 
	if ($spotlight_enabled = 0)
		Change \{spotlight_enabled = 1}
	else
		Change \{spotlight_enabled = 0}
	endif
	toggle_spotlight_setprop
endscript

script get_spotlight_state 
	ScriptAssert \{'get_spotlight_state: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript

script toggle_spotlight_setprop 
	if (($spotlight_enabled) = 0)
		($toggle_spotlight_menuitem) :SetProps generic_menu_smenu_textitem_text_text = qs(0xfcdb3f5a)
	else
		($toggle_spotlight_menuitem) :SetProps generic_menu_smenu_textitem_text_text = qs(0xa2e20e32)
	endif
endscript
...
script create_in_game_menu 
	...
	toggle_crowd_3d_setprop
	add_generic_menu_text_item \{text = qs(0x449c6d7c)
		pad_choose_script = toggle_spotlight}
	Change toggle_spotlight_menuitem = <item_container_id>
	toggle_spotlight_setprop
...
script create_unlocks_menu 
	...
	add_generic_menu_text_item \{text = qs(0xa864e822)
		pad_choose_script = unlock_everything_for_car}
...
script create_wii_menu 
	...
	add_generic_menu_text_item \{text = qs(0xbb8cf512)
		pad_choose_script = generic_event_choose
		pad_choose_params = {
			state = uistate_ds_service_menu
		}}
