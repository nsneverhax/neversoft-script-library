...
Bonus_videos = [
	...
	}
	{
		...
		movie = 'DJHero_Teaser'
		unlocked
		movienoesrb = 'DJHero_Teaser_NO_ESRB'
	}
	{
		text = qs(0xbd6ede51)
		id = band_hero_teaser
		movie = 'Band_Hero_Teaser'
		unlocked
		movienoesrb = 'Band_Hero_Teaser_NO_ESRB'
	}
	{
		text = qs(0x353e054f)
		id = career_intro
