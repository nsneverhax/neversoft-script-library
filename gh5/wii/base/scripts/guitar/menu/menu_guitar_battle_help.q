...
script create_battle_helper_menu \{device_num = 0
	...
	if ($game_mode = p2_pro_faceoff ||
		...
		getplayerinfo \{2
			device
			out = device2}
		SetArrayElement ArrayName = exclusive_mp_controllers index = 0 NewValue = <device1>
		SetArrayElement ArrayName = exclusive_mp_controllers index = 1 NewValue = <device2>
