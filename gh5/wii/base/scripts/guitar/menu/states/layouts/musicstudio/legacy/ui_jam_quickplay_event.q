...
script do_jam_quickplay_event 
	...
	jam_load_effect
	jam_recording_create_jamsession_arrays \{Heap = quota_samples}
	...
	jamsession_copyfinalscriptarrays arraylist = <arraylist> arraylist2 = <arraylist2> Heap = quota_samples
	getplayerinfo \{1
		part}
	getnumplayersingame
	<players> = <num_players>
