	...
	create_dialog_box {
		...
		options = [
			...
			}
			{
				...
				func_params = {data = {bypass_return_script = songlist_music_store_return_to_special_offers}}
			}
		]
	}
endscript
...
script ui_import_keycode_unlock 
	if (<Result> = success)
		...
		generic_event_choose state = uistate_import_keycode data = {Result = <Result> code = <code> display_name = <display_name> offeringid = <offering_id> is_popup}
	endif
endscript
