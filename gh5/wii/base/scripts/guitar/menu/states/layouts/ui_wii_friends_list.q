...
script get_localized_loading_text 
	ScriptAssert \{'get_localized_loading_text: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript

script spawn_no_friends_dialog 
	ScriptAssert \{'spawn_no_friends_dialog: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript
...
script choose_invite_icon 
	ScriptAssert \{'choose_invite_icon: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript
