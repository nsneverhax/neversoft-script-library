...
script registeruistates_boot 
	...
	RegisterState \{Name = uistate_boot_movie_vvisions
		task = {
			Name = task_menu
			params = {
				base_name = 'boot_movie_vvisions'
			}
		}}
...
script registeruistates_career 
	...
	RegisterState \{Name = uistate_party_mode
		task = {
			Name = task_menu
			params = {
				base_name = 'party_mode'
			}
		}}
	RegisterState \{Name = uistate_whiteboard_options
		task = {
			Name = task_menu
			params = {
				base_name = 'whiteboard_options'
			}
		}}
	RegisterState \{Name = uistate_whiteboard_win
		task = {
			Name = task_menu
			params = {
				base_name = 'whiteboard_win'
			}
		}}
	RegisterState \{Name = uistate_whiteboard_mode
		task = {
			Name = task_menu
			params = {
				base_name = 'whiteboard_mode'
			}
		}}
