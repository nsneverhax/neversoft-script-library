...
script menu_video_settings_select_calibrate_lag 
	ScriptAssert \{'menu_video_settings_select_calibrate_lag: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript
