...
script load_musicstudio_soundpak \{async = 1
		Heap = quota_samples}
	RequireParams \{[
			path
		]
...
script unload_musicstudio_sfx 
	unload_musicstudio_soundpak \{path = 'pak/sounds/modes/sfx_mode_studio.pak'
		async = 0}
