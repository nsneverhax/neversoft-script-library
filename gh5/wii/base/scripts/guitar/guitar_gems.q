...
button_models = [
	{
		green = {
			...
			gem_material_guitar_accent = mat_drum_accent_green
			star_material_guitar_accent = mat_drum_star_accent_green
			star_power_material_guitar_accent = mat_drum_accent_star
			star_power_star_material_guitar_accent = mat_drum_star_accent_star
			gem_deadnote_material = mat_gem_deadnote
			gem_deadnote_material_drum = mat_gem_deadnote_drum
			gem_deadnote_material_drum_accent = mat_gem_deadnote_drum_accent
			gem_deadnote_material_hammer_on = mat_gem_deadnote_hammer_on
			gem_deadnote_material_tapping = mat_gem_deadnote_tapping
			gem_deadnote_band_moment_material = mat_gem_deadnote
			gem_deadnote_band_moment_material_drum = mat_gem_deadnote_drum
			gem_deadnote_band_moment_material_drum_accent = mat_gem_deadnote_drum_accent
			gem_deadnote_band_moment_material_hammer_on = mat_gem_deadnote_hammer_on
			gem_deadnote_band_moment_material_tapping = mat_gem_deadnote_tapping
			gem_band_moment_material = mat_gem_green
			gem_band_moment_material_drum = mat_drum_green
			gem_band_moment_material_drum_accent = mat_drum_accent_green
			gem_band_moment_material_hammer_on = mat_gem_hammer_green
			gem_band_moment_material_tapping = mat_solo_gem_green
			gem_band_moment_whammy = mat_whammy_green
			star_power_material_band_moment = mat_gem_star
			star_power_material_band_moment_tapping = mat_solo_gem_star
			star_power_material_band_moment_hammer_on = mat_gem_hammer_star
			star_power_material_band_moment_drum = mat_drum_star
			star_power_material_band_moment_drum_accent = mat_drum_accent_star
			...
			gem_material_drum_beginner = mat_kid_gem
			star_material_drum_beginner = mat_kid_gem_star
			star_power_material_drum_beginner = mat_gem_drum_sp
			star_power_star_material_drum_beginner = mat_gem_drum_star_sp
			gem_deadnote_material_drum_beginner = mat_gem_drum_deadnote
			gem_band_moment_material_drum_beginner = mat_gem_drum_band_moment_green
			Name = button_g
		}
		red = {
			...
			star_power_material_drum_accent = mat_drum_accent_star
			star_power_star_material_drum_accent = mat_drum_star_accent_star
			gem_material_guitar_accent = mat_drum_accent_red
			star_material_guitar_accent = mat_drum_star_accent_red
			star_power_material_guitar_accent = mat_drum_accent_star
			star_power_star_material_guitar_accent = mat_drum_star_accent_star
			gem_deadnote_material = mat_gem_deadnote
			gem_deadnote_material_drum = mat_gem_deadnote_drum
			...
			gem_band_moment_material_drum = mat_drum_red
			gem_band_moment_material_drum_accent = mat_drum_accent_red
			gem_band_moment_material_hammer_on = mat_gem_hammer_red
			gem_band_moment_material_tapping = mat_solo_gem_red
			gem_band_moment_whammy = mat_whammy_red
			star_power_material_band_moment = mat_gem_star
			star_power_material_band_moment_tapping = mat_solo_gem_star
			star_power_material_band_moment_hammer_on = mat_gem_hammer_star
			star_power_material_band_moment_drum = mat_drum_star
			...
			star_material_beginner = mat_kid_gem_star
			star_power_material_beginner = mat_kid_gem_star_power
			gem_band_moment_material_beginner = mat_kid_gem
			gem_material_drum_beginner = mat_gem_drum_green
			star_material_drum_beginner = mat_gem_drum_star_green
			star_power_material_drum_beginner = mat_gem_drum_sp
			star_power_star_material_drum_beginner = mat_gem_drum_star_sp
			gem_deadnote_material_drum_beginner = mat_gem_drum_deadnote
			gem_band_moment_material_drum_beginner = mat_gem_drum_band_moment_green
		...
		yellow = {
			...
			star_power_star_material_drum_accent = mat_drum_star_accent_star
			gem_material_guitar_accent = mat_cym_accent_yellow
			star_material_guitar_accent = mat_drum_star_accent_yellow
			star_power_material_guitar_accent = mat_cym_accent_star
			star_power_star_material_guitar_accent = mat_drum_star_accent_star
			gem_deadnote_material = mat_gem_deadnote
			gem_deadnote_material_drum = mat_gem_deadnote_drum
			gem_deadnote_material_drum_accent = mat_gem_deadnote_drum_accent
			...
			gem_band_moment_material_drum = mat_cym_yellow
			gem_band_moment_material_drum_accent = mat_cym_accent_yellow
			gem_band_moment_material_hammer_on = mat_gem_hammer_yellow
			gem_band_moment_material_tapping = mat_solo_gem_yellow
			gem_band_moment_whammy = mat_whammy_yellow
			star_power_material_band_moment = mat_gem_star
			star_power_material_band_moment_tapping = mat_solo_gem_star
			star_power_material_band_moment_hammer_on = mat_gem_hammer_star
			star_power_material_band_moment_drum = mat_drum_star
		...
		blue = {
			...
			star_power_material_drum_accent = mat_drum_accent_star
			star_power_star_material_drum_accent = mat_drum_star_accent_star
			gem_material_guitar_accent = mat_drum_accent_blue
			star_material_guitar_accent = mat_drum_star_accent_blue
			star_power_material_guitar_accent = mat_drum_accent_star
			star_power_star_material_guitar_accent = mat_drum_star_accent_star
			gem_deadnote_material = mat_gem_deadnote
			gem_deadnote_material_drum = mat_gem_deadnote_drum
			...
			gem_band_moment_material_drum = mat_drum_blue
			gem_band_moment_material_drum_accent = mat_drum_accent_blue
			gem_band_moment_material_hammer_on = mat_gem_hammer_blue
			gem_band_moment_material_tapping = mat_solo_gem_blue
			gem_band_moment_whammy = mat_whammy_blue
			star_power_material_band_moment = mat_gem_star
			star_power_material_band_moment_tapping = mat_solo_gem_star
			star_power_material_band_moment_hammer_on = mat_gem_hammer_star
			star_power_material_band_moment_drum = mat_drum_star
			...
			star_power_star_material_drum_beginner = mat_gem_drum_star_sp
			gem_deadnote_material_drum_beginner = mat_gem_drum_deadnote
			gem_band_moment_material_drum_beginnerbeginner = mat_gem_drum_band_moment_green
			Name = button_b
		}
		orange = {
			...
			star_power_material_drum_accent = mat_cym_accent_star
			star_power_star_material_drum_accent = mat_drum_star_accent_star
			gem_material_guitar_accent = mat_cym_accent_orange
			star_material_guitar_accent = mat_drum_star_accent_orange
			star_power_material_guitar_accent = mat_cym_accent_star
			star_power_star_material_guitar_accent = mat_drum_star_accent_star
			gem_deadnote_material = mat_gem_deadnote
			gem_deadnote_material_drum = mat_gem_deadnote_drum
			...
			gem_band_moment_material_drum = mat_cym_orange
			gem_band_moment_material_drum_accent = mat_cym_accent_orange
			gem_band_moment_material_hammer_on = mat_gem_hammer_orange
			gem_band_moment_material_tapping = mat_solo_gem_orange
			gem_band_moment_whammy = mat_whammy_orange
			star_power_material_band_moment = mat_gem_star
			star_power_material_band_moment_tapping = mat_solo_gem_star
			star_power_material_band_moment_hammer_on = mat_gem_hammer_star
			star_power_material_band_moment_drum = mat_drum_star
		...
		white = {
			...
			gem_deadnote_band_moment_hammer_material = mat_gem_hammer_dead
			dead_whammy = mat_whammy_dead
			gem_band_moment_material = mat_open_note
			star_power_material_band_moment = mat_open_note_star_power
			gem_band_moment_material_hammer_on = mat_open_note_hammer
			star_power_material_band_moment_hammer_on = mat_open_note_star_power_star_hammer
			...
			gem_deadnote_material_drum = mat_drum_kickdrum_dead
			star_deadnote_material_drum = mat_drum_kickdrum_star_dead
			gem_deadnote_band_moment_material = mat_drum_kickdrum_dead
			gem_band_moment_material_drum = mat_drum_kickdrum
			star_power_material_band_moment_drum = mat_drum_kickdrum_star
			gem_band_moment_whammy = mat_placeholder
			gem_material_beginner = mat_kid_gem
			star_material_beginner = mat_kid_gem_star
			star_power_material_beginner = mat_kid_gem_star_power
			star_power_star_material_beginner = mat_kid_gem_star_power_star
			gem_band_moment_material_beginner = mat_kid_gem
			star_power_band_moment_material_beginner = mat_kid_gem_star_power
			gem_deadnote_material_beginner = mat_kid_gem_dead
			star_deadnote_material_beginner = mat_kid_gem_star_dead
			gem_band_moment_material_tapping = mat_placeholder
			gem_deadnote_material_tapping = mat_gem_tapping_dead
			gem_material_guitar_accent = mat_placeholder
			star_material_guitar_accent = mat_placeholder
			star_power_material_guitar_accent = mat_placeholder
			star_power_star_material_guitar_accent = mat_placeholder
...
script flag_extended_sustains 
	ScriptAssert \{'flag_extended_sustains: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript
...
script calc_health_invincible_time 
	...
	setplayerinfo <Player> health_invincible_time = 0.0
	getplayerinfo \{1
		difficulty
		out = difficulty1}
	getplayerinfo \{2
	...
	if ($game_mode = p1_quickplay ||
		...
		if ((<Player> = 1 && <difficulty1> = beginner) ||
				(<Player> = 2 && <difficulty2> = beginner))
			setplayerinfo <Player> health_invincible_time = (<total_end_time> * $health_invincible_time_percentage_beginner / 100.0)
		endif
		if ((<Player> = 1 && <difficulty1> = easy) ||
				(<Player> = 2 && <difficulty2> = easy))
			setplayerinfo <Player> health_invincible_time = (<total_end_time> * $health_invincible_time_percentage_easy / 100.0)
		endif
		if ((<Player> = 1 && <difficulty1> = medium) ||
				(<Player> = 2 && <difficulty2> = medium))
			setplayerinfo <Player> health_invincible_time = (<total_end_time> * $health_invincible_time_percentage_medium / 100.0)
		endif
	elseif ($game_mode = p2_coop ||
			$game_mode = gh4_p2_career ||
			$game_mode = p2_quickplay)
		if (<difficulty1> = beginner && <difficulty2> = beginner)
			setplayerinfo <Player> health_invincible_time = (<total_end_time> * $health_invincible_time_percentage_beginner / 100.0)
		elseif ((<difficulty1> = beginner && <difficulty2> = easy) ||
				(<difficulty1> = easy && <difficulty2> = beginner) ||
				(<difficulty1> = easy && <difficulty2> = easy))
			setplayerinfo <Player> health_invincible_time = (<total_end_time> * $health_invincible_time_percentage_easy / 100.0)
		elseif ((<difficulty1> = easy && <difficulty2> = medium) ||
				(<difficulty1> = beginner && <difficulty2> = medium) ||
				(<difficulty1> = medium && <difficulty2> = easy) ||
				(<difficulty1> = medium && <difficulty2> = beginner) ||
				(<difficulty1> = medium && <difficulty2> = medium))
			setplayerinfo <Player> health_invincible_time = (<total_end_time> * $health_invincible_time_percentage_medium / 100.0)
		endif
	endif
endscript
...
script gem_scroller \{Player = 1}
	...
	if (<do_bot> = 1)
		...
		SpawnScriptLater gem_iterator params = {iterator_text = 'fill_botresponsearray' song_name = <song_name> difficulty = <difficulty> part = <part> input_array = <botresponse_array>
			time_offset = (((<easy_scroll_time> - $destroy_time) * 1000.0) + <gem_offset> + 1000.0) strum_function = fill_input_array skipleadin = (<scroll_time> * 1000.0)
			Player = <Player>}
		SpawnScriptLater gem_iterator params = {iterator_text = 'adjust_botresponsearray' song_name = <song_name> difficulty = <difficulty> part = <part> use_input_array = 'botresponse_array'
			time_offset = ((((<easy_scroll_time> - $destroy_time) * 1000.0) + <gem_offset> + 1000.0) + 200) strum_function = adjust_input_array_for_note_miss skipleadin = (<scroll_time> * 1000.0)
			Player = <Player>}
		SpawnScriptLater gem_iterator params = {iterator_text = 'bot' song_name = <song_name> difficulty = <difficulty> part = <part> use_input_array = 'botresponse_array'
			time_offset = ((<check_time_early> * 1000.0) + <input_offset> - ($check_time_late * 1000.0)) strum_function = check_buttons_bot skipleadin = (<scroll_time> * 1000.0)
			Player = <Player>}
	...
	if (<roadie_battle_ai> = 1)
		updateroadiebattleai Player = <Player> $roadie_battle_ai_modifiers_global
		getplayerinfo <Player> difficulty
		switch (<difficulty>)
			case easy
			<per_difficulty_modifiers> = $roadie_battle_ai_modifiers_easy
			case medium
			<per_difficulty_modifiers> = $roadie_battle_ai_modifiers_medium
			case hard
			<per_difficulty_modifiers> = $roadie_battle_ai_modifiers_hard
			case expert
			<per_difficulty_modifiers> = $roadie_battle_ai_modifiers_expert
		endswitch
		updateroadiebattleai Player = <Player> <per_difficulty_modifiers>
	endif
endscript
failed_song = 0
...
script unload_gempaks \{Heap = quota_sprites}
	...
	if ($last_star_set != None)
		...
		formatText \{TextName = starpak
			...
			i = $last_star_set
			AddToStringLookup = true}
		UnLoadPak <starpak> Heap = <Heap> async = 0
		WaitUnloadPak <starpak> Block
	endif
endscript
...
script load_gempaks \{async = 0
	...
	printf qs(0x2bc627d8) i = <starpak>
	LoadPakAsync pak_name = <starpak> Heap = <Heap> no_vram async = <async>
...
script load_songqpak \{async = 0
	...
	if NOT (<song_name> = $current_song_qpak &&
		...
		if (<song_name> = jamsession)
			...
			if dlcmanagerfunc func = get_content_prefix content_name = <song_name>
				<song_prefix> = <content_prefix>
				formatText TextName = songqpak '%i%s_song.pak' i = <song_prefix> s = <song_perf_ext> AddToStringLookup = true
			else
				get_song_prefix song = <song_name>
				gman_songtool_getcurrentsongversion
				if (<current_song_version> = gh4)
			...
			if NOT load_song_pak song_prefix = <song_prefix> songqpak = <songqpak> async = <async> song_name = <song_name>
				return FALSE error_text = <error_text>
			endif
...
script get_random_song \{on_disc_only = true}
	getsonglistsize on_disc_only = <on_disc_only>
...
script start_gem_scroller \{starttime = 0
	...
	if NOT musicstudio_mainobj :musicstudio_isinmusicstudio
		...
		guitar_support_load_anims state = ingame song = <song>
	else
		guitar_support_init_players <...> Heap = quota_samples
	endif
	if ($end_credits = 2)
	...
	if NOT musicstudio_mainobj :musicstudio_isinmusicstudio
		guitar_support_init_band loading_transition = <loading_transition> song = <song>
	endif
	...
	wii_timer_start \{label = 'car_parts'}
	ps2_load_car_part_script
	wii_timer_stop \{label = 'car_parts'}
	...
	yield
	if ((($movie_on_first_freeplay) = 0) && ($freestyle_just_exited = FALSE))
		Change \{movie_on_first_freeplay = 1}
		destroy_loading_screen
		if CD
			StopRendering
			PlayMovieAndWait \{movie = 'intro_finalanimatic_0209'}
		endif
	endif
	...
	if (<num_players> > 0)
		...
		if (<player_on_screen> = 1)
			...
			SpawnScriptNow gem_scroller params = {<...> song_name = <song>}
		else
	...
	if ((<rb_mode> = true) || (<Type> = competitive))
		if ((<rb_mode> = true) || ($competitive_rules = faceoff) || ($competitive_rules = team_faceoff) || ($competitive_rules = elimination) || ($competitive_rules = team_elimination))
			setscorescaling
		endif
	endif
	printf qs(0x9e16a5e5) s = ($current_transition)
...
script begin_song_after_intro 
	printf qs(0xf324d971) a = <starttimeafterintro>
	begin
	GetSongTimeMs
...
script load_perm_ingame_anims 
	ScriptAssert \{'load_perm_ingame_anims: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript

script Load_Venue \{block_scripts = 0
		force_venue_reload = 0}
	wii_timer_start \{label = 'venue'}
	printf \{qs(0x7b48fd1c)}
	if ((($current_level) = load_z_tool) || (($current_level) = load_z_credits) || ($freestyle_in_flow = 1))
		disablevenueculling
	else
		enablevenueculling
	endif
	...
	if GotParam \{pak}
		...
		loadvenuevideo pn = (($LevelZones.$current_level).zone)
		printf qs(0xc222abaf) p = <pak>
		printf qs(0x7eef7787) p = (($LevelZones.$current_level).zone)
		...
		printf \{qs(0x5a063eb4)}
		ResetWaypoints
	endif
	ResetPulseEvents
	printf qs(0x81336fda) d = ($current_level)
	printf qs(0x4cf37625) d = (($LevelZones.$current_level).zone)
...
script restart_song \{practice_intro = 0
	...
	if (<loading_transition> = 1)
		...
		begin
		if load_songqpak song_name = <current_song> async = 1 resetzone = 1
			break
		endif
		SpawnScriptNow song_load_failed params = {error_text = <error_text>}
		gman_songfunc \{func = clear_play_list}
...
script load_full_guitarist_anims 
	ScriptAssert \{'Load_Full_Guitarist_Anims: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript

script unload_full_guitarist_anims 
	printf \{qs(0x3674fe7a)}
endscript

script load_frontend_guitarist_anims 
	ScriptAssert \{'Load_Frontend_Guitarist_Anims: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript

script unload_frontend_guitarist_anims \{async = 0}
	ScriptAssert \{'Unload_Frontend_Guitarist_Anims: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript

script destroy_crowd_delay 
	ScriptAssert \{'Destroy_Crowd_Delay: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript
