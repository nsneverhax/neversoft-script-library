...
script PrintVec 
	ScriptAssert \{'PrintVec: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript

script findreferencedscreenelementparams \{param = Pos}
	ScriptAssert \{'FindReferencedScreenElementParams: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript
