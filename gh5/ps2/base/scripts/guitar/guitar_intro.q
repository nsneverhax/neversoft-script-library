...
script intro_celeb_ui 
	...
	switch ($current_song)
		...
		<firstname> = qs(0xa2ef07ba)
		<lastname> = qs(0x57767c10)
		case pluginbaby
		<firstname> = qs(0xe7e349c9)
		<lastname> = qs(0x31cf0822)
		case smellsliketeenspirit
		case lithium
		<firstname> = qs(0x9ca05f1f)
		<lastname> = qs(0x9c5476be)
		case ringoffire
		<firstname> = qs(0xf93f5e1d)
		<lastname> = qs(0x89c93e1f)
		case noonetodependon
		<firstname> = qs(0x98bf5738)
		<lastname> = qs(0xf2712353)
		default
		<firstname> = qs(0x7dce335c)
		<lastname> = qs(0x2e691620)
	endswitch
