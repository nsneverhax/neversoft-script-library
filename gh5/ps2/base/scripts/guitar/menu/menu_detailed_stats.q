...
script create_detailed_stats_menu 
	...
	if NOT ($game_mode = gh4_p2_career || $game_mode = p2_coop || $game_mode = p2_quickplay)
	...
	if ($current_num_players = 1 || $game_mode = gh4_p2_career || $game_mode = p2_coop || $game_mode = p2_quickplay)
	...
	circle_pos = [(307.0, 349.0) , (910.0, 349.0)]
	best_pos = [(590.0, 348.0) , (685.0, 352.0)]
	rot_vals = [-3 , 3]
	if NOT ($game_mode = gh4_p2_career || $game_mode = p2_coop || $game_mode = p2_quickplay)
		if ($current_num_players = 2)
			tie = 0
...
script add_divider_graphic 
	...
	elseif ($current_num_players = 1 || $game_mode = gh4_p2_career || $game_mode = p2_coop || $game_mode = p2_quickplay)
