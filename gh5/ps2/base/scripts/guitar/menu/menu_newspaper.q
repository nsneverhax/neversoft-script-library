...
script create_newspaper_menu \{for_practice = 0}
	...
	switch <current_tier>
		...
		Change \{g_ss_mag_number = 0}
	endswitch
	if NOT ($game_mode = gh4_p1_career || $game_mode = gh4_p2_career || $game_mode = p2_coop || $game_mode = p1_quickplay || $game_mode = p2_quickplay || $game_mode = p3_quickplay || $game_mode = p4_quickplay || <for_practice> = 1)
	...
	elseif ($game_mode = gh4_p1_career || $game_mode = gh4_p2_career || $game_mode = p1_quickplay || $game_mode = p2_quickplay)
...
script np_create_options_menu \{Pos = (600.0, 300.0)
	...
	if (<for_practice> = 1)
		<menu_offset> = (0.0, -6.0)
	elseif NOT ($game_mode = gh4_p1_career || $game_mode = gh4_p2_career || $game_mode = p2_coop || $game_mode = p1_quickplay || $game_mode = p2_quickplay)
