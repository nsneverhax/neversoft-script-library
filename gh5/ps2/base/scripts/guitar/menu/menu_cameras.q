...
ui_customize_tat_torso_camera = {
	params = {
		LockTo = $cas_current_player_name
		Pos = (-0.09520801, 1.4958, 0.34899598)
...
ui_customize_tat_torso_l_camera = {
	params = {
		LockTo = $cas_current_player_name
		Pos = (-0.88467497, 1.478441, -0.35676602)
...
ui_customize_tat_torso_r_camera = {
	params = {
		LockTo = $cas_current_player_name
		Pos = (0.729732, 1.5040709, -0.26947302)
...
ui_customize_tat_torso_b_camera = {
	params = {
		LockTo = $cas_current_player_name
		Pos = (-0.056472998, 1.5246829, -1.2654159)
...
ui_cag_custom_head_camera = {
	params = {
		...
		LookAt = $cas_current_player_name
		LookAtBone = bone_guitar_body
		ScreenOffset = (0.38476002, 2.274726)
...
ui_cag_custom_head_l_camera = {
	params = {
		...
		LookAt = $cas_current_player_name
		LookAtBone = bone_guitar_body
		ScreenOffset = (0.38340303, 2.074431)
...
ui_cag_custom_head_r_camera = {
	params = {
		LockTo = $cas_current_player_name
		Pos = (0.455848, 1.888291, 0.129616)
		Quat = (-2.2E-05, -0.84537697, -0.006994)
		FOV = 72.0
		LookAt = $cas_current_player_name
		LookAtBone = bone_guitar_body
		ScreenOffset = (0.31866798, 2.1572108)
...
ui_cag_custom_head_b_camera = {
	params = {
		...
		LookAt = $cas_current_player_name
		LookAtBone = bone_guitar_body
		ScreenOffset = (0.37617102, 2.112818)
...
ui_cad_select_size_camera = {
	params = {
		LockTo = $cas_current_player_name
		Pos = (0.8585641, 1.92813, 3.6047618)
		Quat = (0.052186005, -0.946885, 0.20181)
		FOV = 72.0
	}
	time = 0.3
	transitiondof = $dof_car_sel_drums_tod_manager
