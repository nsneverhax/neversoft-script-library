...
script 0x6b650292 
	...
	<current_desc> :obj_spawnscript highlight_motion params = {menu_id = <current_desc>}
...
script 0x29b4ea99 
	...
	if GotParam \{disable}
		...
		<0x14b22443> :SetProps rgba = $0x667fdc5b
	endif
	return
endscript
...
script 0x931b6ce7 
	...
	current_desc = (<descs> [<menu_index>])
	<current_desc> :desc_resolvealias Name = alias_highlight
	<resolved_id> :Obj_KillSpawnedScript Name = 0x79ac86f3
	<resolved_id> :Obj_SpawnScriptNow 0x79ac86f3 params = {menu_index = <menu_index> 0xbbaeec67 = <0xbbaeec67>}
	return
endscript
