...
script ui_create_game_mode \{mode = career}
	...
	add_menu_frontend_item text = qs(0xd093953b) pad_choose_script = set_primary_controller pad_choose_params = {state = uistate_select_practice_mode} <demo_mode_disable>
	ui_return_game_mode
endscript
