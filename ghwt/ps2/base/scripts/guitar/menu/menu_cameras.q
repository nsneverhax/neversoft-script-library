...
ui_options_camera = {
	params = {
		Pos = (-27.071413, 0.27381703, 4.9675922)
...
ui_customize_left_arm_camera = {
	params = {
		LockTo = World
		Pos = (3.4590871, 1.417094, -1.9689779)
	...
	video_name = 0x8e7904da
}
ui_customize_left_arm_l_camera = {
	params = {
		LockTo = World
		Pos = (2.2253652, 1.351534, -2.22141)
...
ui_customize_left_arm_r_camera = {
	params = {
		LockTo = World
		Pos = (4.103169, 1.306352, -2.4859562)
...
ui_customize_left_arm_b_camera = {
	params = {
		LockTo = World
		Pos = (2.564075, 1.5895729, -3.0340881)
