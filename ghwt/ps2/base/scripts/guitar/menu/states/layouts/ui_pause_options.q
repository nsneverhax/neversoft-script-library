...
script ui_create_pause_options 
	...
	make_menu {
		parent = <parent>
		centered_offset = (-490.0, -250.0)
		exclusive_device = <player_device>
		extra_z = 600
		centered
		nobg
	}
	current_menu :se_setprops \{rot_angle = -6}
	...
	if NOT (<part> = vocals)
		...
		if French
			<0x2aec959e> = (55.0, 8.0)
		elseif German
			<0x2aec959e> = (135.0, 8.0)
		elseif Italian
			<0x2aec959e> = (125.0, 8.0)
		endif
		CreateScreenElement {
			Type = SpriteElement
	...
	if NOT ((<part> = vocals) || (<part> = drum))
		...
		<0x2aec959e> = (105.0, 8.0)
		if Spanish
			<0x2aec959e> = (195.0, 8.0)
		elseif French
			<0x2aec959e> = (125.0, 8.0)
		elseif German
			<0x2aec959e> = (185.0, 8.0)
		elseif Italian
			<0x2aec959e> = (195.0, 8.0)
		endif
		CreateScreenElement {
	...
	<0x2aec959e> = (105.0, 8.0)
	if Spanish
		<0x2aec959e> = (145.0, 8.0)
	elseif French
		<0x2aec959e> = (55.0, 8.0)
	elseif Italian
		<0x2aec959e> = (175.0, 8.0)
	endif
	CreateScreenElement {
		Type = SpriteElement
		parent = <item_container_id>
