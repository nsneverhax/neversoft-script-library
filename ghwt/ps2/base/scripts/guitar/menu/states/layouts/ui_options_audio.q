...
script ui_options_audio_focus_text_menu 
	...
	if NOT GotParam \{dolby_option}
		...
		audiointerface :se_setprops mixer_channel_lamp_pos = ((440.0, 0.0) + ((98.0, 0.0) * <index>))
...
script 0x90e7f6c5 
	...
	if (<ps2_stereo_sound> = 1)
		...
		audiointerface :se_setprops \{0x0853070f = $string_ps2_STEREO}
		audiointerface :se_setprops \{mixer_info_text = $0xffc807ec}
	else
		...
		audiointerface :se_setprops \{0x0853070f = $string_ps2_MONO}
		audiointerface :se_setprops \{mixer_info_text = $0x443b47fa}
	endif
