...
script song_breakdown_assign_player_data_faceoff 
	...
	if Spanish
		if (<player_index> = 1)
			<resolved_id> :0x8e6af868 child = multiplier_entry dims = (400.0, 29.0)
			<resolved_id> :0x8e6af868 child = player_info Pos = (-17.0, -8.0)
			<resolved_id> :0x8e6af868 child = song_complete_leather_shape dims = (520.0, 200.0) Pos = (-15.0, 0.0)
		else
			<resolved_id> :0x8e6af868 child = multiplier_entry dims = (400.0, 29.0)
			<resolved_id> :0x8e6af868 child = player_info Pos = (8.0, -8.0)
			<resolved_id> :0x8e6af868 child = song_complete_leather_shape dims = (520.0, 200.0) Pos = (10.0, 0.0)
		endif
	endif
...
script ui_create_song_breakdown_practice 
	...
	add_user_control_helper ($ui_song_breakdown_helper_params) text = qs(0xc18d5e76) button = green z = 100000 all_buttons
	Change menu_flow_locked = ($menu_flow_locked - 1)
endscript
