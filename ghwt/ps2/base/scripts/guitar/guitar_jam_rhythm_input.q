...
script jam_input_rhythm_play_note \{sustain = 0
	...
	0xba1fcb09 = 50
	if (($jam_rhythm_pan) > 0)
		0x4010f66a = ($jam_rhythm_pan * 5 + 50)
		0xba1fcb09 = (100 - <0x4010f66a>)
	elseif (($jam_rhythm_pan) < 0)
		0xba1fcb09 = ($jam_rhythm_pan * -5 + 50)
		0x4010f66a = (100 - <0xba1fcb09>)
	endif
	0xba1fcb09 = (<0xba1fcb09> * ($0xd0f42bdf / 100.0))
	0x4010f66a = (<0x4010f66a> * ($0xd0f42bdf / 100.0))
	switch <note_type>
		case 0
		PlaySound <final_note_sample> pitch = (<pitch_shift> + (($jam_current_tuning) / 10.0)) voll_percent = <0xba1fcb09> volr_percent = <0x4010f66a> buss = jammode_rhythmguitar slot = 4
		case 1
		PlaySound <final_note_sample> pitch = (<pitch_shift> + (($jam_current_tuning) / 10.0)) voll_percent = <0xba1fcb09> volr_percent = <0x4010f66a> buss = jammode_rhythmguitar slot = 4
		case 2
		PlaySound <final_note_sample> pitch = (<pitch_shift> + (($jam_current_tuning) / 10.0)) voll_percent = <0xba1fcb09> volr_percent = <0x4010f66a> buss = jammode_rhythmguitar slot = 4
		...
		PlaySound <final_note_sample> pitch = (<pitch_shift> + (($jam_current_tuning) / 10.0)) voll_percent = <0xba1fcb09> volr_percent = <0x4010f66a> buss = jammode_rhythmguitar slot = 4
	endswitch
	Change jam_input_current_chord = <final_note_sample>
