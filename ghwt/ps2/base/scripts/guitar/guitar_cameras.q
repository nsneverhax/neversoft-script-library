...
script profile_camera_gpu 
	...
	if StructureContains structure = ($<Camera_Array> [$debug_camera_array_count]) Name
		formatText TextName = title qs(0x4369ca90) n = (($<Camera_Array> [$debug_camera_array_count]).Name) DontAssertForChecksums
	else
		formatText TextName = title qs(0x4369ca90) n = (($<Camera_Array> [$debug_camera_array_count]).params.Name) DontAssertForChecksums
	endif
