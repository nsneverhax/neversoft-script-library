...
script setup_band_hud \{force_layout = 0}
	...
	if StructureContains \{structure = $g_hud_2d_struct_used
		...
		0x2454020a = ($g_hud_2d_struct_used.desc_interface)
		if (<0x2454020a> = 'hud_1g' || <0x2454020a> = 'hud_1v')
			<id> :0x8e6af868 child = streak_number Pos = (-28.0, 26.0)
			<id> :0x8e6af868 child = score Pos = (245.0, 160.0)
		elseif (<0x2454020a> = 'hud_1g1v' || <0x2454020a> = 'hud_2g' || <0x2454020a> = 'hud_2g1v' || <0x2454020a> = 'hud_3g1v')
			<id> :0x8e6af868 child = streak_number Pos = (-34.0, 28.0)
			<id> :0x8e6af868 child = score Pos = (262.0, 197.0)
		elseif (<0x2454020a> = 'hud_2v')
			<id> :0x8e6af868 child = streak_number Pos = (-28.0, 26.0)
		endif
		<id> :0x8e6af868 child = streak z_priority = 0.0
