...
script make_menu_frontend {
	...
	destroy_viewport_ui
	title_dims = (450.0, 125.0)
	title_rgba = (($g_menu_colors).alert_red)
	switch (<screen>)
		case drummer
		create_viewport_ui \{texture = 0x70f69968}
		desc = 'viewport_drummer'
		title_rgba = [220 200 200 255]
		title_dims = (550.0, 125.0)
		case GUITARIST
		create_viewport_ui \{texture = 0x88242237}
		desc = 'viewport_guitarist'
		case BASSIST
		create_viewport_ui \{texture = 0x18262d07}
...
script add_menu_frontend_item {
	...
	if ScreenElementExists \{id = current_menu}
		...
		<id> :se_getprops
		<id> :SetProps text_pos = (<text_pos> + (0.0, 10.0))
