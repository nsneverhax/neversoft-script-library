...
script add_character_selection_item \{focus_script = character_selection_focus
	...
	if ScreenElementExists id = <parent>
		...
		<id> :0x8e6af868 child = character_selection_item_bio Pos = (2.0, 144.0) dims = (232.0, 400.0)
		<id> :0x8e6af868 child = character_selection_item_name Pos = (0.0, 58.0) dims = (250.0, 50.0)
		<id> :0x8e6af868 child = character_selection_item_title Pos = (-30.0, -10.0) dims = (250.0, 50.0)
	else
...
script 0x15b0619d \{focus_script = character_selection_focus
	...
	<id> :0x8e6af868 child = character_selection_item_bio Pos = (2.0, 144.0) dims = (310.0, 400.0)
	<id> :0x8e6af868 child = character_selection_item_bio {Scale = (1.1, 1.1) rgba = [180 180 180 255]}
	<id> :0x8e6af868 child = character_selection_item_title Scale = (1.25, 1.25) Pos = (0.0, -15.0)
...
script character_selection_focus 
	...
	if <id> :desc_resolvealias Name = alias_character_selection_item_bio
		<resolved_id> :se_setprops dims = (255.0, 100.0)
	endif
