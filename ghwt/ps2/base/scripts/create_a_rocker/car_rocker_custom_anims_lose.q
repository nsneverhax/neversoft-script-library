...
cas_male_lose_anim = [
	...
	}
	{
		desc_id = g_ted_lose
		hidden
		guitarist_anim_name = g_ted_lose_01
		bassist_anim_name = g_ted_lose_01
		drummer_anim_name = bdgs_d_drummer_lose_01
		singer_anim_name = bdgs_s_singer_lose_01
	}
	{
		desc_id = g_zakk_lose
		hidden
		guitarist_anim_name = guit_zakk_losel_1
		bassist_anim_name = guit_zakk_losel_1
		drummer_anim_name = bdgs_d_drummer_lose_01
		singer_anim_name = bdgs_s_singer_lose_01
	}
	{
	...
	}
	{
		...
		bassist_anim_name = g_jimi_loss_01
		drummer_anim_name = bdgs_d_drummer_lose_01
	}
	{
		desc_id = g_sting_lose
		hidden
		guitarist_anim_name = s_sting_lose_01
		bassist_anim_name = s_sting_lose_01
		singer_anim_name = s_sting_lose_01
		drummer_anim_name = bdgs_d_drummer_lose_01
	}
]
