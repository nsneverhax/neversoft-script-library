...
script training_4_2_zoom_guitar 
	...
	if ScreenElementExists \{id = guitar_sprite}
		guitar_sprite :legacydomorph \{Scale = (8.0, 8.0)
			Pos = (1100.0, 400.0)
			time = 0.75}
	endif
