...
script create_fail_song_menu 
	...
	<song_name_pos> = (640.0, 307.0)
	<completion_text_pos> = (640.0, 370.0)
	completion = 0
	...
	GetScreenElementDims id = <id>
	if (<width> > 260)
		fit_text_in_rectangle id = <id> dims = ((260.0, 0.0) + <height> * (0.0, 1.0)) start_x_scale = (<text_scale>.(1.0, 0.0)) start_y_scale = (<text_scale>.(0.0, 1.0))
	endif
	...
	if (($game_mode = p1_career && $is_boss_song = 0))
		...
		displaySprite parent = fail_song_static_text_container tex = Dialog_BG Pos = (470.0, 427.0) dims = (340.0, 102.0) z = <z>
		displaySprite parent = fail_song_static_text_container tex = Dialog_BG flip_h Pos = (470.0, 529.0) dims = (340.0, 102.0) z = <z>
