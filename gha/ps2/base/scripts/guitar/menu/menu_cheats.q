...
script create_cheats_menu 
	...
	hilite_pos = (349.0, 217.0)
	hilite_offset = (0.0, 26.0)
	...
	CreateScreenElement {
		...
		id = 0xa0d1cdd5
		event_handlers = [
			{focus cheats_morph_hilite params = {Pos = (<hilite_pos> + (<hilite_offset> * 5)) id = 0xa0d1cdd5}}
			{pad_choose toggle_cheat params = {cheat = cheat_largegems id = 0xa0d1cdd5 index = 5}}
		]
	}
	CreateScreenElement {
		<text_params>
		...
		event_handlers = [
			{focus cheats_morph_hilite params = {Pos = (<hilite_pos> + (<hilite_offset> * 6) + (0.0, 9.0)) id = Cheat_EnterCheat_Text}}
...
script cheats_do_guitar_morphs 
	if ScreenElementExists \{id = guitar_sprite}
		guitar_sprite :DoMorph \{Scale = (4.0, 4.0)
			Pos = (140.0, 545.0)
			time = 0.75
			motion = ease_in}
