...
0x3515b713 = {
	...
	pak = {
		Name = 'career_cash_reward_movie_fs'
	}
	pak = {
	...
	pak = {
		Name = 'career_aerosmith_confirmation_fs'
	}
	pak = {
	...
	pak = {
		Name = 'coop_career_lefty_flip_warning'
	}
	pak = {
	...
	pak = {
		Name = 'coop_quickplay_audio_settings_fs'
	}
	pak = {
		Name = 'coop_quickplay_calibrate_lag_fs'
	}
	pak = {
		Name = 'coop_quickplay_calibrate_lag_warning'
	}
	pak = {
		Name = 'coop_quickplay_choose_part_fs'
	}
	pak = {
		Name = 'coop_quickplay_controller_settings_fs'
	}
	pak = {
		Name = 'coop_quickplay_detailed_stats_fs'
	}
	pak = {
		Name = 'coop_quickplay_fail_song_fs'
	}
	pak = {
		Name = 'coop_quickplay_lefty_flip_warning'
	}
	pak = {
		Name = 'coop_quickplay_pause_fs'
	}
	pak = {
		Name = 'coop_quickplay_pause_options_fs'
	}
	pak = {
		Name = 'coop_quickplay_practice_warning_fs'
	}
	pak = {
		Name = 'coop_quickplay_quit_warning_fs'
	}
	pak = {
		Name = 'coop_quickplay_restart_warning_fs'
	}
	pak = {
		Name = 'coop_quickplay_select_controllers_fs'
	}
	pak = {
		Name = 'coop_quickplay_select_difficulty_fs'
	}
	pak = {
		Name = 'coop_quickplay_setlist_fs'
	}
	pak = {
		Name = 'coop_quickplay_toprockers_fs'
	}
	pak = {
		Name = 'coop_quickplay_venue_fs'
	}
	pak = {
		Name = 'coop_quickplay_win_song_fs'
	}
	pak = {
		Name = 'debug_menu_fs'
	}
	...
	pak = {
		Name = 'options_top_rockers_select_mode_fs'
	}
	pak = {
...
script guitar_startup 
	...
	switch <Platform>
		...
		<heap_size_game> = ((64 * 1024) + (12 * 256 * 1024))
		<0x77ca7b84> = (0 * 1024)
		<heap_size_lightshow> = (256 * 1024)
		<0x3e2216c2> = (0 * 1024)
		default
		ScriptAssert \{'Unrecognized platform for heap setup'}
	endswitch
	PushMemProfile \{'Light Show Heap'}
	MemInitHeap Name = 'heap_lightshow' size = <heap_size_lightshow> vram_size = <0x3e2216c2>
	PopMemProfile
	...
	MemInitHeap Name = 'heap_musician4' size = <0xbdd213db> vram_size = <0x0e8a453b>
	...
	MemInitHeap Name = 'heap_musician2_anim' size = <0x7929c136> vram_size = <0xc57627f2>
	MemInitHeap Name = 'heap_musician3_anim' size = <heap_size_rhythm_anim> vram_size = <heap_size_rhythm_anim_vram>
	MemInitHeap Name = 'heap_musician4_anim' size = <heap_size_drummer_anim> vram_size = <heap_size_musician_vram>
	MemInitHeap Name = 'heap_musician5_anim' size = <heap_size_vocalist_anim> vram_size = <heap_size_musician_vram>
	...
	MemInitHeap Name = 'heap_game' size = <heap_size_game> vram_size = <0x77ca7b84>
	PopMemProfile
	...
	CreatePakManMap \{map = 0x261ffed7
...
script pre_movie_cleanup 
	...
	0x41688f4f \{heap_zones}
	heap_size_zones = <size>
	memdeleteheap \{Name = 'heap_zones'}

	UnLoadPak \{'pak/oogame/oogame.pak'}
	GetPakManCurrent \{map = 0x261ffed7}
	0x675f4d9d = <pak>
	shut_down_flow_manager
	SetPakManCurrentBlock \{map = 0x261ffed7
		pak = None
		block_scripts = 1}
	DestroyPakManMap \{map = 0x261ffed7}
	0x19e4a436 = 0
	if existspakmanmap \{map = 0xcf7e837c}
		GetPakManCurrent \{map = 0xcf7e837c}
		0x19e4a436 = <pak>
		SetPakManCurrentBlock \{map = 0xcf7e837c
			pak = None
			block_scripts = 1}
		DestroyPakManMap \{map = 0xcf7e837c}
	endif
	0x41688f4f \{0xf8899a28}
	heap_size_game = <size>
	memdeleteheap \{Name = 'heap_game'}
	return 0xd4935026 = {
		0x19e4a436 = <0x19e4a436>
		0x675f4d9d = <0x675f4d9d>
...
script post_movie_reset 
	...
	PushMemProfile \{'Game Heap'}
	MemInitHeap Name = 'heap_game' size = (<0xd4935026>.heap_size_game) vram_size = 0
	PopMemProfile
	if (<0xd4935026>.0x19e4a436 != 0)
		CreatePakManMap \{map = 0xcf7e837c
			folder = 'pak/guitar_hud/'
			links = 0x71cded0d
			uselinkslots
			Heap = 0xf8899a28}
		SetPakManCurrentBlock map = 0xcf7e837c pak = (<0xd4935026>.0x19e4a436) block_scripts = 1
	endif
	...
	CreatePakManMap \{map = 0x261ffed7
		...
		uselinkslots
		Heap = 0xf8899a28}
	if ((<0xd4935026>.ui_flow_manager_state = career_beat_game_fs) || (<0xd4935026>.ui_flow_manager_state = coop_career_beat_game_fs) || (<0xd4935026>.ui_flow_manager_state = coop_quickplay_venue_fs))
		SetPakManCurrentBlock map = 0x261ffed7 pak = (<0xd4935026>.0x675f4d9d) block_scripts = 1
	elseif ((<0xd4935026>.ui_flow_manager_state = bootup_sequence_fs) || (<0xd4935026>.ui_flow_manager_state = career_select_venue_fs) || (<0xd4935026>.ui_flow_manager_state = coop_career_select_venue_fs))
		SetPakManCurrentBlock map = 0x261ffed7 pak = (<0xd4935026>.0x675f4d9d) block_scripts = 1
	else
		start_flow_manager flow_state = (<0xd4935026>.ui_flow_manager_state)
	endif
	PushMemProfile \{'Characters'}

	MemInitHeap Name = 'heap_zones' size = (<0xd4935026>.heap_size_zones) vram_size = <heap_size_zones_vram>
	CreatePakManMap \{map = zones
		links = GH3Zones
		folder = 'zones/'
		uselinkslots
