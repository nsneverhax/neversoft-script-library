...
script get_string_wii \{message = unknown}
	...
	switch <message>
		...
		localized_string = 'There is not enough available space in Wii system memory to save WFC data.\\nCreate 1 block of free space either by moving data to an SD Card or deleting data in the Data Management screen.\\nIf you continue any WFC profiles you create will not be saved.'
