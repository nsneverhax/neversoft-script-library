...
script online_general_menu_focus 
	if ScreenElementExists id = <id>
		...
		online_bookend1 :SetProps Pos = ((($online_general_menu_hi_lite_ypos [<menu_item>]) * (0.0, 1.0)) + (468.0, 20.0)) flip_v
		online_bookend2 :SetProps Pos = ((($online_general_menu_hi_lite_ypos [<menu_item>]) * (0.0, 1.0)) + (796.0, 20.0))
	endif
endscript
