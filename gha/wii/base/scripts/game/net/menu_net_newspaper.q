...
script np_net_create_options_menu \{Pos = (600.0, 300.0)
	...
	displayText id = np_option_0 parent = newspaper_container text = 'CONTINUE' Pos = (($g_np_option_props [0].Pos) + <menu_offset> + (0.0, -2.0)) Scale = (0.85, 0.7) rot = ($g_np_option_props [0].rot) font = <menu_font> noshadow
