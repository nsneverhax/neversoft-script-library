...
script custom_create_select_done 
	Change match_type = ($FilterTypes.Ranked.checksum [($SearchMatchTypeValue)])
...
script net_custom_ui_change_focus 
	...
	if ScreenElementExists \{id = highlight_over}
		...
		highlight_over :DoMorph Pos = (<Pos> + (528.0, 0.0)) time = 0.1
	endif
	...
	if NOT (<current_focus> = <this_ID>)
		...
		if ScreenElementExists id = <this_ID>
			if (<this_ID> = submit_selection)
				displaySprite id = highlight_over parent = <this_ID> tex = hilite_bar_01 Pos = (-75.0, 10.0) dims = (528.0, 50.0) rgba = ($online_light_blue) just = [left top] z = 4
				displaySprite id = bookend1_over parent = <this_ID> tex = character_hub_hilite_bookend Pos = (-135.0, 35.0) dims = (60.0, 50.0) rgba = ($online_light_blue) just = [left center] z = 4 flip_v
				displaySprite id = bookend2_over parent = <this_ID> tex = character_hub_hilite_bookend Pos = (453.0, 35.0) dims = (60.0, 50.0) rgba = ($online_light_blue) just = [left center] z = 4
			else
				displaySprite id = 0xdab9e59a parent = <this_ID> tex = hilite_bar_01 Pos = (-75.0, 10.0) dims = (528.0, 50.0) rgba = ($online_light_purple) just = [left top] z = 3
				displaySprite id = 0xeb51ff07 parent = <this_ID> tex = hilite_bar_01 Pos = (453.0, 10.0) dims = (528.0, 50.0) rgba = ($online_light_purple) just = [left top] z = 3
				displaySprite id = bookend1_under parent = <this_ID> tex = character_hub_hilite_bookend Pos = (-135.0, 35.0) dims = (60.0, 50.0) rgba = ($online_light_purple) just = [left center] z = 3 flip_v
				displaySprite id = bookend2_under parent = <this_ID> tex = character_hub_hilite_bookend Pos = (981.0, 35.0) dims = (60.0, 50.0) rgba = ($online_light_purple) just = [left center] z = 3
				displaySprite id = highlight_over parent = <this_ID> tex = hilite_bar_01 Pos = (-75.0, 10.0) dims = (528.0, 50.0) rgba = ($online_light_blue) just = [left top] z = 4
				displaySprite id = bookend1_over parent = <this_ID> tex = character_hub_hilite_bookend Pos = (-135.0, 35.0) dims = (60.0, 50.0) rgba = ($online_light_blue) just = [left center] z = 4 flip_v
				displaySprite id = bookend2_over parent = <this_ID> tex = character_hub_hilite_bookend Pos = (981.0, 35.0) dims = (60.0, 50.0) rgba = ($online_light_blue) just = [left center] z = 4
				displaySprite id = arrow_down parent = <this_ID> tex = Online_Arrow Pos = (490.0, 47.0) dims = (32.0, 24.0) rgba = ($online_dark_purple) just = [center center] z = 5
				displaySprite id = arrow_up parent = <this_ID> tex = Online_Arrow Pos = (490.0, 18.0) dims = (32.0, 24.0) rgba = ($online_dark_purple) just = [center center] z = 5 flip_h
				bookend2_over :SetProps \{alpha = 0.0}
...
script destroy_prev_selection_highlight 
	...
	if ScreenElementExists \{id = 0xdab9e59a}
		DestroyScreenElement \{id = 0xdab9e59a}
	endif
	if ScreenElementExists \{id = 0xeb51ff07}
		DestroyScreenElement \{id = 0xeb51ff07}
	endif
	...
	if (<direction> = up)
		...
		if ScreenElementExists \{id = arrow_up}
			arrow_up :DoMorph \{Scale = (1.8, 1.5)
				time = 0.1}
			arrow_up :DoMorph \{Scale = (1.0, 0.75)
				time = 0.1}
		endif
	else
		...
		if ScreenElementExists \{id = arrow_down}
			arrow_down :DoMorph \{Scale = (1.8, 1.5)
				time = 0.1}
			arrow_down :DoMorph \{Scale = (1.0, 0.75)
				time = 0.1}
		endif
	endif
endscript
