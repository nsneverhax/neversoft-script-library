Musician_Profiles = [
	...
	}
	{
		...
		blurb = 'Darryl \'DMC\' McDaniels is a founding member of the pioneering hip hop group Run-D.M.C.  The group is credited with helping to bring hip hop music into the mainstream.  In 1986 Run-D.M.C. teamed up with Aerosmith to record a new version of \'Walk This Way\' that helped bridge the gap between rap music and rock music.'
	}
	{
		Name = 'JoeP'
		fullname = 'Joe Perry'
		...
		blurb = 'Joe Perry is known the world over as Aerosmith\'s lead guitarist.  Playing guitar since he was 14, Joe has a collection of more than 600 guitars, preferring his Gibsons.  Steven Tyler and Joe Perry have co-written the majority of Aerosmith\'s hits such as \'Walk This Way\', \'Love In An Elevator\' and \'Livin\' On The Edge.\'  Joe has released five solo CD\'s including 2006\'s self-titled release which garnered a Grammy nomination for the track \'Mercy.\''
		outfits = [
			{
				Name = 'Joe\'s Outfits'
				id = 'joep_01'
	...
	}
	{
		...
		Type = GUITARIST
		0x6a7a41d3 = 0x8acdac4d
		finger_anims = 0xadc3b740
		fret_anims = fret_anims_med
		strum_anims = 0xc815a3bc
		anim_set = 0x23f3c86b
		stance = Stance_A
		icon_off = char_select_joep_off
		icon_on = char_select_joep_on
	...
	}
	{
		...
		Type = GUITARIST
		0x6a7a41d3 = 0x8acdac4d
		finger_anims = 0x1a2f455f
		fret_anims = fret_anims_med
		strum_anims = 0x270a10a2
	...
	}
	{
		...
		blurb = 'Brad Whitford joined Aerosmith in 1971 after attending Berklee College of Music.  Brad left Aerosmith in 1981 to work on his own project.  Then he toured briefly with The Joe Perry Project, but rejoined Aerosmith in 1984.  Brad has made significant contributions to the band\'s songlist by writing hits such as \'Last Child\', \'Nobody\'s Fault\', and playing lead guitar on \'Back in the Saddle\'.'
	...
	}
	{
		...
		blurb = 'Tom Hamilton started playing guitar at age 12 when his brother Scott taught him his first chords.  Years later Tom moved to a small town in New Hampshire.  He set out looking to join a band.  The only good one had two guitarists but needed a bassist.  He agreed to try it out and it stuck.  The band, The Merciless Tangerine, with Tom\'s delinquent French teacher on keyboards, played their first gig at a frat party.  The following summer, Tom met a kid who played drums who knew another who played guitar named Joe Perry.  They formed a band called the Pipe Dream.  Every summer after that they rocked out.  Finally, Joe and Tom were out of high school.  They moved to Boston to try and make it big.  Within a short time they joined up with Steven, Joey, and Brad the following summer.  Tom co-wrote some big hits including \'Sweet Emotion,\' \'Uncle Salty,\' and \'Janie\'s got a Gun\' among others.'
		0x6a7a41d3 = 0xf49ae2ff
		outfits = [
			{
				Name = 'Tom\'s Outfits'
		...
		outfits = [
			{
				...
				id = 'Fowlvis'
				styles = [
					$string_ps2_fowlvis_outfit_style_7
					...
					$string_ps2_fowlvis_outfit_style_5
					$string_ps2_fowlvis_outfit_style_6
				]
				styleids = [
					'Fowlvis_01s7'
					'Fowlvis_01s1'
		...
		outfits = [
			{
				...
				styles = [
					...
					$string_ps2_robot_outfit_style_5
					$string_ps2_robot_outfit_style_6
				]
				styleids = [
					'Robot_01s7'
					'Robot_01s1'
		...
		outfits = [
			{
				...
				id = 'satan'
				styles = [
					$string_ps2_satan_outfit_style_2
					$string_ps2_satan_outfit_style_1
					$string_ps2_satan_outfit_style_3
					$string_ps2_satan_outfit_style_4
				]
				styleids = [
					'lou_01s2'
					'lou_01s1'
	...
	}
	{
		...
		icon_off = Char_Select_Axel_Off
		icon_on = Char_Select_Axel_On
		blurb = 'Brad Whitford joined Aerosmith in 1971 after attending Berklee College of Music.  Whitford left Aerosmith in 1981 to work on his own project.  Then Whitford toured briefly with The Joe Perry Project, but rejoined Aerosmith in 1984.  Brad has made significant contributions to the band\'s songlist by writing hits such as \'Last Child\', \'Nobody\'s Fault\' and playing lead guitar on \'Back in the Saddle\'.'
		character_select_ignore = 1
	}
	{
		Name = 'Bassist'
	...
	}
	{
		...
		anim_set = tomh_animations
		stance = Stance_A
		0x6a7a41d3 = 0x45bb2e5b
		blurb = 'Tom Hamilton started playing guitar at age 12 when his brother Scott taught him his first chords.  Years later Tom moved to a small town in New Hampshire.  He set out looking to join a band.  The only good one had two guitarists but needed a bassist.  He agreed to try it out and it stuck.  The band, The Merciless Tangerine, with Tom\'s French teacher on keyboards, played their first gig at a frat party.  The following summer, Tom met a kid who played drums who knew another who played guitar named Joe Perry.  They formed a band called the Pipe Dream.  Every summer after that they rocked out.  Finally, Joe and Tom were out of high school.  They moved to Boston to try and make it big.  Within a short time they joined up with Steven and Joey and Brad the following summer.  Tom co-wrote some big hits including \'Sweet Emotion\', \'Uncle Salty\' and \'Janie\'s got a Gun\' among others.'
	}
	{
		Name = 'Drummer'
		fullname = 'Drummer'
...
aerosmith_band_miracas = {
	...
	BASSIST = 'TomH_Bassist'
	rhythm = 'BradW_Rhythm'
	vocalist_male = 'Aero_Singer_Maracas'
	vocalist_female = 'singer_female'
	drummer = 'JoeyK'
}
0xb75404ad = {
