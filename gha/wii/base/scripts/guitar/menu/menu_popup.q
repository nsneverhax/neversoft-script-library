...
script create_popup_warning_menu player_device = ($primary_controller)
	...
	if GotParam \{options}
		CreateScreenElement {
			...
			id = options_bg_id
			Pos = (<menu_pos> + <menu_bg_offset> + (0.0, -30.0))
			just = [center top]
			internal_just = [center center]
		}
		displaySprite parent = options_bg_id tex = Dialog_BG z = <z> dims = (500.0, 60.0)
		displaySprite parent = options_bg_id tex = Dialog_BG flip_h z = <z> dims = (500.0, 60.0)
	endif
