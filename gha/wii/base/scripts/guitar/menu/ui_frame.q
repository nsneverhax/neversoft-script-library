...
script create_ui_frame \{frame_dims = (300.0, 500.0)
	...
	if ((<frame_dims>.(1.0, 0.0)) > (<min_width>))
		...
		<frame_corner_tr_fill> :DoMorph Pos = ((<width_tops> * (1.0, 0.0)) - (0.0, -0.5))
		<frame_corner_bl_fill> :DoMorph Pos = ((<width_tops> * (-1.0, 0.0)) - (-0.5, 0.5))
		<frame_corner_br_fill> :DoMorph Pos = ((<width_tops> * (1.0, 0.0)) - (0.0, 0.5))
		CreateScreenElement {
			Type = SpriteElement
			parent = <cont_id>
	...
	if ((<frame_dims>.(0.0, 1.0)) > (<min_height>))
		...
		<frame_corner_tr_fill> :DoMorph Pos = ((<height_side> * (0.0, -1.0) + (<x_tr> * (1.0, 0.0))) - (0.0, -0.5))
		<frame_corner_bl_fill> :DoMorph Pos = ((<height_side> * (0.0, 1.0) + (<x_bl> * (1.0, 0.0))) - (-0.5, 0.5))
		<frame_corner_br_fill> :DoMorph Pos = ((<height_side> * (0.0, 1.0) + (<x_br> * (1.0, 0.0))) - (0.0, 0.5))
		CreateScreenElement {
			Type = SpriteElement
			parent = <cont_id>
	...
	elseif (((<frame_dims>.(0.0, 1.0)) <= (<min_height>)) && ((<frame_dims>.(1.0, 0.0)) > (<min_width>)))
		...
		<frame_corner_tr_fill> :DoMorph Pos = ((<x_tr> * (1.0, 0.0)) - (0.0, -0.5))
		<frame_corner_bl_fill> :DoMorph Pos = ((<x_bl> * (1.0, 0.0)) - (-0.5, 0.5))
		<frame_corner_br_fill> :DoMorph Pos = ((<x_br> * (1.0, 0.0)) - (0.0, 0.5))
	endif
	if (<need_swap>)
		Wait \{2
			Seconds}
