g_mm_base_menu_pos = (900.0, 370.0)
...
script create_main_menu 
	...
	<ber_pos> = ((((<hlbar_dims>.(1.0, 0.0)) / 2) * (1.0, 0.0)) + (25.0, 0.0))
	...
	DoScreenElementMorph \{id = main_menu_training_hl
		Scale = (1.0, 0.01)
		relative_scale}
	if ($enable_saving = 0 || $0xc6f5b687 != 0 || $disable_wifi = 1)
		0xb4a875fc = {rgba = [128 128 128 255] not_focusable}
	else
		0xb4a875fc = {}
	endif
	CreateScreenElement {
...
script main_menu_select_xbox_live 
	if isngc
		...
		KillSpawnedScript \{Name = 0x30c5c0ea}
	endif
