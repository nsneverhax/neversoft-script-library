...
script 0x289fb4ff 
	create_menu_backdrop \{texture = 0x37e243fa
		dims = (1280.0, 720.0)}
	CreateScreenElement \{Type = ContainerElement
		parent = root_window
		id = pab_container
		Pos = (0.0, 0.0)}
	SpawnScriptNow \{0xadc0511c}
endscript

script 0x67ec0c09 
	destroy_menu \{menu_id = pab_container}
	destroy_menu_backdrop
	KillSpawnedScript \{Name = 0xadc0511c}
endscript
...
script check_for_attract_mode_input 
	...
	WaitOneGameFrame
	Change 0x2b953604 = ($0x2b953604 + 1)
	repeat
...
script check_for_any_input \{button1 = {
	...
	if isngc
		if NOT ($invite_controller = -1)
			0xa6d72e79 device_num = ($invite_controller)
			break
		endif
		if NOT (<0x82fb776e> = 0)
			0xa6d72e79 device_num = <device_num>
			break
		endif
	else
		if NOT ($invite_controller = -1)
