			...
			if (<dont_show_options> = 0)
				CreateScreenElement {
					...
					event_handlers = [
						...
						{pad_choose ui_flow_manager_respond_to_action params = {action = select_options create_params = {device_num = <player_device>}}}
					]
				}
				CreateScreenElement {
					Type = TextElement
...
script create_pause_menu_frame \{x_scale = 1
	...
	scale_1 = ((0.75, 0.0) * <x_scale> + (0.0, 0.7) * <y_scale>)
	scale_2 = ((0.7, 0.0) * <x_scale> + (0.0, 0.7) * <y_scale>)
	scale_3 = ((1.4, 0.0) * <x_scale> + (0.0, 1.25) * <y_scale>)
	scale_4 = ((0.7875, 0.0) * <x_scale> + (0.0, 0.75) * <y_scale>)
	scale_5 = ((0.75, 0.0) * <x_scale> + (0.0, 0.7) * <y_scale>)
	CreateScreenElement {
		Type = SpriteElement
		parent = <container_id>
