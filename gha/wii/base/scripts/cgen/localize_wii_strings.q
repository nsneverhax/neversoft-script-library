...
0x067350ba = 'Disconnected from network during data transmission.'
...
0x02e0da61 = 'Message of the Day'
0x9be98bdb = 'Message Of The Day'
0xeceebb4d = 'Online Main Menu'
0x728a2eee = 'A living dead instrument fit only for the master of evil himself. \\n\\nBig Red Lou\'s favorite axe sings like a thing possessed. \\n\\nBecause it is.'
...
script get_string_wii \{message = unknown}
	...
	switch <message>
		...
		if 0x7dabca53
			localized_string = 'There is not enough available space in the Wii System Memory.\\nCreate 3 blocks of free space by either moving data to an SD Card or deleting data in the Data Management Screen.\\nYou will not be able to access Nintendo WFC data until you do this.'
		else
		...
		if 0x7dabca53
			localized_string = 'There is not enough available space in the Wii System Memory to save \\nNintendo WFC data. Create 1 block of free space by either moving data to an SD Card\\n or deleting data in the Data Management Screen. Any existing data can be loaded and overwritten.\\nYou will not be able to access Nintendo WFC until you do this.'
		else
		...
		case corrupt_boot
		if 0x7dabca53
			localized_string = 'This data is corrupted and cannot be used.\\n'
		else
