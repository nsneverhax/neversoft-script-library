...
script get_string_ps2 \{message = unknown}
	...
	switch <message>
		...
		format_string = qs(0xff3234d8)
		case check_memcard
		format_string = qs(0x6c51be44)
		case no_memcard_boot
		format_string = qs(0xf11e2539)
		case no_memcard
		format_string = qs(0xf9539a91)
		case no_save_boot
		format_string = qs(0x066746d2)
		case no_save_ingame
		format_string = qs(0x5de0d43d)
		case save_failed
	...
	0x979e36a1 = <memcard>
	0x4ac9edd5 = qs(0xbd6ede51)
	0x80d82aa7 \{progress}
	formatText TextName = 0x08b6f45c qs(0x13866852) d = <SpaceRequired>
	formatText TextName = localized_string <format_string> 0xc309dd07 = <0xc309dd07> memcard = <memcard> 0x979e36a1 = <0x979e36a1> 0xdd082360 = <0xdd082360> 0x08b6f45c = <0x08b6f45c> 0x4ac9edd5 = <0x4ac9edd5>
