...
script add_user_control_helper \{z = 10}
	...
	<id> :se_getprops
	<id> :se_setprops {
		helper_pill_body_dims = (((0.65000004, 0.0) * <helper_pill_menu_dims> [0]) + ((0.0, 1.0) * <helper_pill_body_dims> [1]))
		dims = (((0.65000004, 0.0) * <helper_pill_menu_dims> [0]) + (64.0, 32.0))
	}
...
script 0x0c6ece4e \{0x63754f30 = 0.0
		0xfa7c1e8a = 1.0
		ya = 0.0
		yb = 1.0
		0xca6a32f7 = 0.2
	...
	y = <random_float>
	getrandomfloat a = <0xca6a32f7> b = <0x5363634d>
	time = <random_float>
	Pos = {((<X> * (1.0, 0.0)) + (<y> * (0.0, 1.0))) proportional}
	Wait <time> Seconds
	spawnscript 0x92a1564d params = {parent = <parent> Pos = <Pos>}
	repeat
endscript

script 0x92a1564d \{Pos = (0.0, 0.0)
		dims = (32.0, 32.0)
		0x53924c09 = (72.0, 72.0)
		end_dims = (40.0, 40.0)
		z_priority = 12
		time = 0.5}
	...
	0x288feb3e new Pos = <Pos> dims = <dims> z_priority = <z_priority> parent = <parent>
	if NOT (<sparkle_id> = 0)
		OnExitRun 0xdac61041 params = {id = <sparkle_id> dims = <dims>}
		<sparkle_id> :se_setprops rot_angle = 90.0 dims = <0x53924c09> alpha = 1.0 time = (<time> / 2) parent = <parent>
		<sparkle_id> :se_waitprops
		<sparkle_id> :se_setprops rot_angle = 180.0 dims = <end_dims> alpha = 0.0 time = (<time> / 2) parent = <parent>
		<sparkle_id> :se_waitprops
	endif
endscript

script 0xdac61041 \{dims = (32.0, 32.0)}
	if GotParam \{id}
		if ScreenElementExists id = <id>
			<id> :se_setprops rot_angle = 0.0 dims = <dims> alpha = 0.0
		endif
	endif
endscript
...
script 0x288feb3e 
	...
	0x9b4c33f9 = [0xf84b4ab7 0x8f4c7a21 0x16452b9b 0x61421b0d 0xff268eae 0x8821be38 0x1128ef82 0x662fdf14 0xf690c285 0x8197f213]
	GetArraySize <0x9b4c33f9>
	if GotParam \{new}
		i = 0
		begin
		sparkle_id = (<0x9b4c33f9> [(<i>)])
		if NOT ScreenElementExists id = <sparkle_id>
			CreateScreenElement {
				id = <sparkle_id>
				Type = SpriteElement
				parent = <parent>
			...
			return sparkle_id = <sparkle_id>
		elseif NOT <sparkle_id> :se_ismorphing
			<sparkle_id> :se_setprops Pos = <Pos> dims = <dims> rgba = <rgba> alpha = 0.0
			return sparkle_id = <sparkle_id>
		endif
		i = (<i> + 1)
		repeat (<array_Size>)
		return \{sparkle_id = 0}
	elseif GotParam \{0x7db1771b}
		i = 0
		begin
		sparkle_id = (<0x9b4c33f9> [(<i>)])
		if ScreenElementExists id = <sparkle_id>
			<sparkle_id> :Die
		endif
		i = (<i> + 1)
		repeat (<array_Size>)
...
script 0x78b6ea53 
	KillSpawnedScript \{Name = 0x0c6ece4e}
	KillSpawnedScript \{Name = 0x92a1564d}
	KillSpawnedScript \{Name = 0xdd7e2aec}
	KillSpawnedScript \{Name = 0x288feb3e}
endscript
