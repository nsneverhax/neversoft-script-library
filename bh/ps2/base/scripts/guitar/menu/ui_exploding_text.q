...
g_ui_exploding_text_top_pos = (640.0, 280.0)
...
script create_exploding_text \{parent = 'you_rock_physics'
	...
	if ((<placement> = top) || (<placement> = ps2_tut_top))
	...
	split_text_into_physics_array_elements {
		...
		text_pos = (0.0, 0.0)
		cont_pos = <cont_pos>
		space_between = ((1.0, 0.0) * (40 * <Scale>))
		fit_dims = (((1.0, 0.0) * (640 * <Scale>)) + ((0.0, 1.0) * (120 * <Scale>)))
		just = <just>
		placement = <placement>
		flags = {
			Scale = 1.0
	...
	($0x27baedc6) :se_setprops alpha = 0 time = 0.05
	($0x27baedc6) :se_waitprops
