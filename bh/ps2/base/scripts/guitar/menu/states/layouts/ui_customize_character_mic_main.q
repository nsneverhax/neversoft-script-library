...
script 0x8ef023ae 
	LaunchEvent \{Type = unfocus
		target = create_customize_character_mic_vmenu}
	cas_queue_wait
	ui_event_block event = menu_change data = {state = <choose_state> <choose_state_data> container_id = <id>}
endscript
