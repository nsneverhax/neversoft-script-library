		...
		if ($allow_controller_for_all_instruments = 0)
			if NOT (<p1_type> = <p2_type>)
				LaunchEvent \{Type = unfocus
					target = current_menu}
				player_device = [0 0]
				SetArrayElement ArrayName = player_device index = 0 NewValue = <p1>
				SetArrayElement ArrayName = player_device index = 1 NewValue = <p2>
				create_dialog_box {
					0x36a084ed = qs(0x3817b618)
