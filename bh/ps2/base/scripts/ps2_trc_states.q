...
0x30a8c721 = {
	...
	create_params = {
		header = $string_ps2_MEMORY_CARD_ERROR
		message = $0xe674201a
		option1_text = qs(0x9e92cce5)
		0x9c953112 = disable_autosave
		option2_text = qs(0xb2ae3a96)
		0x121a36f1 = load
	}
	actions = [
		{
