...
script create_top_rockers_menu for_options = 0 write_scores = 0 toprockerssong = ($last_song_played)
	...
	if <id> :desc_resolvealias name = 0x58efbb85
		<resolved_id> :obj_spawnscript 0x3bb230a1
	endif
	if <id> :desc_resolvealias name = 0x8856cf6f
		<resolved_id> :obj_spawnscript 0x69816eb6
	endif
	if <id> :desc_resolvealias name = 0x0b4063c4
		<resolved_id> :obj_spawnscript 0x69816eb6
	endif
	...
	if <id> :desc_resolvealias name = 0x4ad34825
		<resolved_id> :obj_spawnscript 0xa323fa10 params = {0x971c66e7 = 0.5 0x3af134dc = 10 start_dims = (30.0, 30.0)}
	endif
	if <id> :desc_resolvealias name = 0x4ad34825
		<resolved_id> :obj_spawnscript 0xa323fa10 params = {0x971c66e7 = 1.0 0x3af134dc = 10 start_dims = (30.0, 30.0) color = [200 80 255 150]}
	endif
	new_score = -1
	if (<write_scores> = 1)
...
script menu_top_rockers_get_top_rocker_data \{for_options = 0}
	...
	if 0x83f4a9b9 name = <toprockerssong>
		return {
			<...>
...
script menu_tr_change_character_up 
	...
	setarrayelement arrayname = new_band_name globalarray index = $new_band_index newvalue = ($0x46732c8d [($default_band_indexes [$new_band_index])])
	menu_tr_refresh_band_name score_index = <score_index>
endscript
