...
script calibrate_create_menu 
	...
	if (<show_save> = 1)
		add_generic_barrel_menu_text_item pad_choose_params = {idx = 5} text = <confirm_text> <params>
	else
		add_generic_barrel_menu_text_item pad_choose_params = {idx = 5 nosave = 1} text = <confirm_text> <params>
	endif
