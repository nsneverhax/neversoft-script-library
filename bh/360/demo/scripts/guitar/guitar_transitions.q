...
script transition_play \{type = intro}
	...
	0xbde94219 \{viewport = bg_viewport}
	change \{0xfdf40f77 = 0}
	if (<type> = encore)
...
script transitions_resetzone 
	...
	if checksumequals a = <nodename> b = 0xa57aaa9c
		resetvalid = false
	endif
	if checksumequals a = <nodename> b = 0x84c8fd89
		resetvalid = false
	endif
	if checksumequals a = <nodename> b = 0xb5cdceb6
		resetvalid = false
	endif
	if (<resetvalid> = true)
