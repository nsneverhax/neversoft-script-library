...
script 0x94053bd6 
	...
	formattext checksumname = 0x63c36099 'zones/%s/%s.tex' s = <pakname> addtostringlookup = true
	formattext checksumname = 0xa6b9fcfc 'zones/%s/%s_luts.tex' s = <pakname> addtostringlookup = true
	formattext checksumname = context '%s' s = <pakname> addtostringlookup = true
	0x834901f6 {
		active = true
		0x63c36099 = <0x63c36099>
		0xa6b9fcfc = <0xa6b9fcfc>
		0x35160d35 = `pak/luts/global_color_luts.tex`
		asset_context = <context>
	}
endscript

script 0xb0b6deb1 
	0x834901f6 \{active = false}
endscript
...
script lightshow_blackout_enter 
	...
	switch <pak>
		...
		case z_awardshow
		0xf26908c1 \{0x491b3375 = blackout}
	endswitch
...
script 0xab890e53 \{viewport = bg_viewport}
...
script 0x0e931859 
	if 0x358cf44f
		0x989c3b27 name = <0x11b91737>
	else
		0xbde94219
	endif
endscript

script 0x989c3b27 \{viewport = bg_viewport}
	if ($0xfdf40f77 = 0)
		return
	endif
	if ($0xbf109068 = 0)
	...
	0x0803bffd name = <name>
endscript

script 0xbde94219 \{viewport = bg_viewport}
	if ($0x0063e6d8 = 1)
		printf \{qs(0xf2ca6b5a)}
	endif
	0x0803bffd \{name = `default`}
	if NOT viewportexists id = <viewport>
		return
	endif
	venue_screenfx
