cas_female_acc_left = [
	...
	{
		desc_id = f_pop_acc_lglove_midori04
		frontend_desc = qs(0xed02c279)
		mesh = 0x7d898834
		material_groups = [
			{
				materials = [
...
cas_female_acc_right = [
	...
	{
		desc_id = f_pop_acc_rglove_midori04
		frontend_desc = qs(0x2d22ba1e)
		mesh = 0xd4980f0e
		materials = [
