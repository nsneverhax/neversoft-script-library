...
script ui_create_song_summary_details \{for_transition = 0}
	...
	if stats_summary_id :Desc_ResolveAlias \{name = alias_diamondBling
		...
		<diamondBling_id> :Obj_SpawnScript anim_bling_horizontal params = {minwidth = 100 maxwidth = 500 maxtime = 0.5}
	else
		ScriptAssert \{'UI_art'}
	endif
	if stats_summary_id :Desc_ResolveAlias \{name = alias_diamondBling2
			param = diamondbling_id2}
		<diamondbling_id2> :Obj_SpawnScript anim_bling_horizontal params = {minwidth = 100 maxwidth = 500 maxtime = 0.5}
	else
		ScriptAssert \{'UI_art'}
	endif
