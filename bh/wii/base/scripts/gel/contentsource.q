...
script create_marketplace_error_dialogue \{body_text = qs(0x1ba51040)}
	...
	create_dialog_box {
		...
		options = [
			{
				func = <error_func>
				func_params = {error_code = <error_code>}
				text = qs(0x0e41fe46)
			}
		]
		dlg_z_priority = 1001
...
script callback_marketplace_songlist_vram_pak_request_fail 
	...
	create_marketplace_error_dialogue body_text = qs(0xb3497ac5) dev_text = qs(0x63227e51) <...> error_code = 4
endscript
...
script callback_marketplace_songlist_vram_pak_download_fail 
	...
	create_marketplace_error_dialogue body_text = qs(0xd79fcec2) dev_text = qs(0x7315831f) <...> error_code = 5
endscript

script callback_marketplace_songlist_pak_request_fail 
	printf \{'MarketPlaceContentSource: failed to request the songlist pak.'}
	create_marketplace_error_dialogue body_text = qs(0xb3497ac5) dev_text = qs(0x4df46e28) <...> error_code = 6
endscript
...
script callback_marketplace_market_state_fail 
	...
	create_marketplace_error_dialogue body_text = qs(0xec9b1e61) dev_text = qs(0x58bdb77e) <...> error_code = 10
endscript
...
script callback_marketplace_market_begin_enum_fail 
	...
	create_marketplace_error_dialogue body_text = qs(0xec9b1e61) dev_text = qs(0x89fad2ea) <...> error_code = 11
endscript
