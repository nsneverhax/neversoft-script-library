...
script freestyle_game_load 
	...
	LoadPak \{'pak/freestyle/freestyle_highway.pak'
		Heap = quota_sprites}
	printf \{'Loading freestyle_band_anims pak'}
...
script freestyle_game_unload 
	...
	printf \{'Unloading freestyle_band_anims pak'}
	unload_pak_and_wait \{pak = 'Pak\\anims\\freestyle\\freestyle_band_anims.pak'}
	printf 'Unloading music style animation pak: %a' a = ($freestyle_current_style_settings.anim_style_pak)
...
script freestyle_home_menu_pause 
	if ((0x1469760b) && ($freestyle_home_menu_paused = 0))
...
script freestyle_home_menu_unpause 
	if ((0x1469760b) && ($freestyle_home_menu_paused = 1))
		if freestylegameisstarted
