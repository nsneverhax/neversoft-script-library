...
script play_intro 
	...
	elseif (audience_party_available)
		if ($audience_party_started = 0)
			SpawnScriptNow \{audience_party_start_game}
		endif
		audience_party_send_time_elapsed \{resume}
	endif
...
script intro_celeb_ui 
	...
	if celeb_intro_ui :desc_resolvealias \{Name = 0x58efbb85}
	...
	frame_anim :se_setprops \{Pos = (0.0, 80.0)
		time = 0.2
		motion = ease_in}
	frame_anim :se_setprops \{Pos = (-10.0, 0.0)
		time = 0.01
		motion = ease_in}
