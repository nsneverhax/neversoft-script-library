...
default_visualizer_bank = {
	pak = 'pak/visualizer/Default_Visualizer_Bank.pak'
	Intro = [
...
dance_visualizer_bank = {
	pak = 'pak/visualizer/Dance_Visualizer_Bank.pak'
	Intro = [
...
disco_visualizer_bank = {
	pak = 'pak/visualizer/Disco_Visualizer_Bank.pak'
	Intro = [
		$og_element_sparkler
	]
	blackout = [
...
metal_visualizer_bank = {
	pak = 'pak/visualizer/Metal_Visualizer_Bank.pak'
	Intro = [
		$og_element_spirograph
	]
	blackout = [
...
pop_visualizer_bank = {
	pak = 'pak/visualizer/Pop_Visualizer_Bank.pak'
	Intro = [
...
donut_visualizer_bank = {
	pak = 'pak/visualizer/Donut_Visualizer_Bank.pak'
	Intro = [
		$og_enerdonut
	]
	blackout = [
