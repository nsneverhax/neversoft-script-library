		...
		[
			{
				...
				color1 = [119 , 102 , 60 , 255]
				color2 = [105 , 105 , 105 , 255]
			}
			{
...
script hud_attach_widget_sidebar_rockmeter 
	RequireParams \{[
		...
		all}
	getplayerinfo <Player> hud_id
	pos_range = [(17.0, -6.0) (17.666, -88.32) (18.333, -152.314) (19.0, -202.0)]
...
script hud_attach_widget_band_versus_meter 
	...
	if playerinfoequals <Player> Band = 1
		...
		if is_roadie_battle_mode
			<team1_value> = band1_score
			<team2_value> = band2_score
		else
...
script hud_attach_widget_player_star_power 
	ScriptAssert \{'HUD_attach_widget_player_star_power: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript
...
script create_rock_meter 
	ScriptAssert \{'create_rock_meter: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript
...
script get_dongle_rotation_given_health 
	ScriptAssert \{'get_dongle_rotation_given_health: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript
...
script set_player_dongle_rotation 
	ScriptAssert \{'set_player_dongle_rotation: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript
...
script rock_meter_manage_icon_colors 
	ScriptAssert \{'rock_meter_manage_icon_colors: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript
...
script player_icon_blink \{Player = 1
	...
	ScriptAssert \{'player_icon_blink: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript
...
script dump_rock_meter_data 
	ScriptAssert \{'dump_rock_meter_data: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript
