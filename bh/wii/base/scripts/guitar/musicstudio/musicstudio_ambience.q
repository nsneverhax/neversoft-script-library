...
script musicstudio_set_ambience 
	printf \{'F(): musicstudio_set_ambience'
		channel = visualizer}
	...
	0xeb8003f5 preset = <visualizer_name>
	visualizer_get_primitives preset = <visualizer_name>
	musicstudio_mainobj :musicstudio_destroyvisualizer
	musicstudio_mainobj :musicstudio_createvisualizer primitives = <primitives> viewport = bg_viewport
endscript
