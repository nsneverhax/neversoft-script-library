...
script jamsession_addscriptarrayitem 
	addscriptarrayitem Name = <arraylist> checksum = <song_checksum> Heap = <Heap>
endscript
...
script jamsession_copyfinalscriptarrays 
	...
	printf \{'jamsession_copyfinalscriptarrays'}
	ExtendCrc <arraylist> '_size' out = arraylistsize
	count = 0
	begin
	copyfinalscriptarray sourcename = ($<arraylist> [<count>]) destname = ($<arraylist2> [<count>]) Heap = <Heap>
	count = (<count> + 1)
