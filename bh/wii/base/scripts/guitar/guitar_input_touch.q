...
guitar_touch_patterns_gh5 = [
	...
	}
	{
		touch_value = -97
		touch_pattern = 69905
		pattern_string = 'GRYBO'
	}
	{
		touch_value = -101
		touch_pattern = 69649
		pattern_string = 'GR-BO'
	}
	{
		touch_value = -105
		touch_pattern = 65809
		pattern_string = 'G-YBO'
	}
	{
		touch_value = -109
		touch_pattern = 65553
...
script guitar_touch_update_hilite \{Player = 1
	...
	begin
	if NOT ((<lefthanded_gems> = 1) || (<roadie_battle_guitar_attack> > 0))
