...
script reset_all_preset_characters 
	...
	i = 0
	begin
	characterprofilegetstruct Name = ($0x6db04597 [<i>].Name)
	characterprofilesetstruct savegame = <savegame> Name = ($0x6db04597 [<i>].Name) profile_struct = <profile_struct>
	i = (<i> + 1)
	repeat <array_Size>
...
script 0x31012458 
	printf \{qs(0xa936c4f2)}
	0x0f424c6f = ($default_career_linking_tags.0x0f424c6f)
	i = 0
	begin
	if 0xcdf25064 index = <i>
		addintegerarrayelement array = <0x0f424c6f> element = 0
	else
		addintegerarrayelement array = <0x0f424c6f> element = -1
	endif
	0x0f424c6f = <array>
	i = (<i> + 1)
	repeat ($0x00d685db)
	printstruct <...>
	SetGlobalTags career_linking_progression params = {0x0f424c6f = <0x0f424c6f> num_songs_played = 0} Progression = true
endscript
