			...
			if (<array_Size> > 0)
				...
				if (<unlocked> = 1)
					...
					if (<has_been_played> = 1)
						...
						0x61d0c184 gig_info_struct = <gig_info_struct> venue_index = <venue_index>
						gig_icon_alpha = <0x5a6a3bb4>
						gig_sub_icon_alpha = 0
						gig_icon_texture = icon_unlocked
...
script ui_career_gig_select_focus_gig 
	...
	obj_spawnscript 0x0542334f params = {id = <extendedchecksum> Pos = (900.0, -10.0) z = 0}
	if (<unlocked> = 1)
