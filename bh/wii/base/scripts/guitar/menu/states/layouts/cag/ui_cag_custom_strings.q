...
script ui_destroy_cag_custom_strings 
	...
	SpawnScriptLater \{hack_block_ui_back_for_a_bit_reverse}
endscript
...
script hack_block_ui_back_for_a_bit_reverse 
	Change \{hack_block_ui_back_for_a_bit = 1}
	Wait \{1
		Second}
	Change \{hack_block_ui_back_for_a_bit = 0}
endscript
