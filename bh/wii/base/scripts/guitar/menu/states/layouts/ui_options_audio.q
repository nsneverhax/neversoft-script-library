...
script ui_create_options_audio 
	...
	SetArrayElement ArrayName = Volume index = 6 NewValue = (<volumes>.guitar.Crowd.vol)
	initial_volume = [7 7 7 7 7 7 7]
...
script wii_audio_options_menu_music_on 
	begin
...
script ui_destroy_options_audio 
	...
	if GameIsPaused
		...
		SpawnScriptNow \{wii_audio_options_menu_music_on}
	endif
...
script ui_options_audio_set_values \{time = 0.0}
	...
	updatevolumestag part = guitar Name = Crowd params = {vol = (<Volume> [6])}
...
script ui_options_audio_focus_text_menu 
	...
	if ScreenElementExists \{id = audiointerface}
		initial_highlight_pos = (-85.0, -143.0)
		GetTags
		Obj_GetID
		...
		switch <text_idx>
			case 0
			audiointerface :se_setprops \{mixer_menu_highlight_dims = (127.0, 40.0)}
			spacing = (115.0, 0.0)
			case 1
			audiointerface :se_setprops \{mixer_menu_highlight_dims = (135.0, 40.0)}
			spacing = (125.0, 0.0)
			case 2
			audiointerface :se_setprops \{mixer_menu_highlight_dims = (131.0, 40.0)}
			spacing = (129.0, 0.0)
			case 3
			audiointerface :se_setprops \{mixer_menu_highlight_dims = (131.0, 40.0)}
			spacing = (129.0, 0.0)
			case 4
			audiointerface :se_setprops \{mixer_menu_highlight_dims = (133.0, 40.0)}
			spacing = (129.0, 0.0)
			case 5
			audiointerface :se_setprops \{mixer_menu_highlight_dims = (128.5, 40.0)}
			spacing = (129.5, 0.0)
			case 6
			audiointerface :se_setprops \{mixer_menu_highlight_dims = (128.0, 40.0)}
			spacing = (129.5, 0.0)
			default
