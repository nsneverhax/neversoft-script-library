...
script ui_create_cap_artist_layer_options \{back_steps = 2
	...
	if ScreenElementExists \{id = color_wheel_menu_item}
		setup_cas_menu_handlers \{vmenu_id = color_wheel_menu_item}
	endif
endscript
...
script exit_artist_layer_options 
	ScriptAssert \{'exit_artist_layer_options: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript

script exit_artist_layer_options_discard 
	ScriptAssert \{'exit_artist_layer_options_discard: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript
