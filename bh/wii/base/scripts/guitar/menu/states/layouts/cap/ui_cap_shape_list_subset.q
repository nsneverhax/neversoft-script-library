...
script ui_create_cap_shape_list_subset 
	...
	add_shape_list_subset_to_menu part = <part> section_index = <section_index> camera_list = <camera_list> zoom_camera = <zoom_camera>
...
script add_shape_list_subset_to_menu 
	...
	if NOT GotParam \{is_locked}
		add_list_item {
			...
			pad_choose_params = {part = <part> section_index = <section_index> mask_index = <i> camera_list = <camera_list> zoom_camera = <zoom_camera>}
...
script shape_list_accept 
	...
	generic_event_replace state = uistate_cap_shape_edit data = {part = <part> mask = <mask> layer_index = <layer_index> cap_index = <cap_index> part = <part> sections = <sections> section_index = <section_index> mask_index = <mask_index> camera_list = <camera_list> zoom_camera = <zoom_camera>}
endscript
