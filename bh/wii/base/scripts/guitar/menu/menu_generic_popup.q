...
script assign_alias_for_generic_popup 
	ScriptAssert \{'assign_alias_for_generic_popup: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript
...
script create_generic_popup \{text_font = fontgrid_text_a1
...
script create_generic_popup_frames 
	ScriptAssert \{'create_generic_popup_frames: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript
...
script generic_popup_test 
	ScriptAssert \{'generic_popup_test: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript
