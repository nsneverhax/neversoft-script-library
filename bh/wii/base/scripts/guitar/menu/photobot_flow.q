...
script photobot_start_song 
	...
	setplayerinfo instrument_id = (<info_struct>.desc_id)
	get_LevelZoneArray_checksum index = ($photobot_venue_index)
	Change current_level = <level_checksum>
	getsonglistchecksum index = ($photobot_song_index)
...
script photobot_show_song_and_venue 
	CreateScreenElement \{Type = ContainerElement
		...
		z_priority = 1000000
		alpha = 1}
	formatText TextName = photobot_text qs(0x73307931) s = ($photobot_song_index)
	CreateScreenElement {
