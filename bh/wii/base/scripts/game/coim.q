...
ClassicMode_ReservedCOIMBlocksForPermObjects = 62
...
Generic_COIM_Params = {
	...
	COIM_Initial_Num_Perm_Objects = 25
...
script COIM_PreAllocate 
	ScriptAssert \{'COIM_PreAllocate: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript
