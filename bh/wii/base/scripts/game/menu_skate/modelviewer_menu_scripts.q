...
script simple_focus 
	ScriptAssert \{'simple_focus: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript

script simple_unfocus 
	ScriptAssert \{'simple_unfocus: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript
...
script setreferencechecksum 
	ScriptAssert \{'SetReferenceChecksum: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript
...
script view_model 
	...
	MemPopContext
	if NOT CompositeObjectExists \{musician1}
		create_band_member \{instrument = guitar}
	endif
	if (IsTrue $useplayerposforviewerobjpos)
		musician1 :Obj_GetPosition
		<viewerobjpos> = <Pos>
		musician1 :Hide
	else
