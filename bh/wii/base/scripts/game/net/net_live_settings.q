...
demonware_server_list = [
	{
		lobby_id = Default
		dw_ngc_title_id_us = 5250
		cert_lsg_us = 'gh51-wii-dev.lsg.mmp3.demonware.net'
		dev_lsg_us = 'gh51-wii-dev.lsg.mmp3.demonware.net'
		live_lsg_us = 'gh51-wii-live.lsg.mmp3.demonware.net'
		auth_address_us = 'gh51-wii-auth-live.mmp3.demonware.net'
		dw_ngc_title_id_eu = 5266
		cert_lsg_eu = 'gh51-eu-wii-dev.lsg.mmp3.demonware.net'
		dev_lsg_eu = 'gh51-eu-wii-dev.lsg.mmp3.demonware.net'
		live_lsg_eu = 'gh51-eu-wii-live.lsg.mmp3.demonware.net'
		auth_address_eu = 'gh51-eu-wii-auth-live.mmp3.demonware.net'
	...
	}
	{
		...
		cert_lsg_us = 'ghtunes-wii-dev-lobby.demonware.net'
		...
		cert_lsg_eu = 'ghtunes-wii-dev-lobby.demonware.net'
	...
	}
	{
		...
		cert_lsg_us = 'gh-shared-wii-cert.lsg.mmp3.demonware.net'
		...
		cert_lsg_eu = 'gh-shared-wii-cert.lsg.mmp3.demonware.net'
