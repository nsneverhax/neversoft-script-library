...
script SpawnHiResScreenshot 
	ScriptAssert \{'SpawnHiResScreenshot: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript
...
script SpawnCubeMapScreenshots 
	ScriptAssert \{'SpawnCubeMapScreenshots: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript

script lock_cam_top_down 
	ScriptAssert \{'lock_cam_top_down: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript
