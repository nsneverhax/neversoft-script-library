...
script show_poly_count 
	ScriptAssert \{'show_poly_count: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript
...
script show_render_metrics_toggle 
	ScriptAssert \{'show_render_metrics_toggle: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript
...
script NodelistManMonitor_ConsoleOnly 
	ScriptAssert \{'NodelistManMonitor_ConsoleOnly: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript

script NodelistManMonitor 
	ScriptAssert \{'NodelistManMonitor: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript
