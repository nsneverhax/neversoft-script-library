...
script color_slice_add_drop_shadow 
	ScriptAssert \{'color_slice_add_drop_shadow: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript
...
script color_slice_raise_ring 
	ScriptAssert \{'color_slice_raise_ring: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript
...
script print_color_results 
	ScriptAssert \{'print_color_results: Removed by remove_scripts.pl.  If you hit this assert, tell someone.'}
endscript
