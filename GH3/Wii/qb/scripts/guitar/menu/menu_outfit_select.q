...
script create_select_outfit_menu \{player = 1}
	...
	if ($current_num_players = 1)
		...
		displaytext {
			...
			pos = (($gs_element_offsets [2]) + (-2.0, -14.0))
			scale = 1.3
			font = fontgrid_title_gh3
			just = [center center]
			rgba = [160 80 30 255]
		...
		if (<width> > 260)
			setscreenelementprops \{id = os_outfit_name_id_p1
				scale = 0.9}
			fit_text_in_rectangle id = os_outfit_name_id_p1 dims = ((255.0, 0.0) + (<height> * (0.0, 1.0))) pos = (($gs_element_offsets [2]) + (-2.0, -14.0))
		endif
		...
		if (<width> > 310)
			setscreenelementprops \{id = os_outfit_style_id_p1
				scale = 1}
			fit_text_in_rectangle id = os_outfit_style_id_p1 dims = ((305.0, 0.0) + (<height> * (0.0, 1.0))) pos = ($gs_element_offsets [3])
		endif
		...
		if (<player> = 1)
			...
			if (<width> > 250)
				setscreenelementprops \{id = os_outfit_name_id_p1
					scale = 1.1}
				fit_text_in_rectangle id = os_outfit_name_id_p1 dims = ((250.0, 0.0) + (<height> * (0.0, 1.25))) pos = (0.0, 35.0)
			endif
			getuppercasestring <curr_style>
			displaytext {
				id = os_outfit_style_id_p1
			...
			getscreenelementdims \{id = os_outfit_style_id_p1}
			if (<width> > 256)
				fit_text_in_rectangle id = os_outfit_style_id_p1 dims = ((220.0, 0.0) + (<height> * (0.0, 1.0))) pos = (0.0, 90.0)
			endif
			get_character_name \{player = 1}
			formattext checksumname = outfit_2_checksum 'Guitarist_%n_Outfit2_Style1' n = <character_name>
			getglobaltags <outfit_2_checksum>
			...
			if (<width> > 250)
				setscreenelementprops \{id = os_outfit_name_id_p2
					scale = 1.1}
				fit_text_in_rectangle id = os_outfit_name_id_p2 dims = ((250.0, 0.0) + (<height> * (0.0, 1.0))) pos = (0.0, 27.0)
			endif
			getuppercasestring <curr_style>
			displaytext {
			...
			if (<width> > 256)
				fit_text_in_rectangle id = os_outfit_style_id_p2 dims = ((255.0, 0.0) + (<height> * (0.0, 1.0))) pos = (0.0, 90.0)
			endif
...
script select_outfit_create_style_menu \{player = 1}
	...
	if ($current_num_players = 1)
		...
		setscreenelementprops id = os_outfit_name_id_p1 rgba = [250 250 200 255] scale = 1 pos = (($gs_element_offsets [2]) + (-2.0, -10.0))
		getscreenelementdims \{id = os_outfit_name_id_p1}
		if (<width> > 260)
			setscreenelementprops \{id = os_outfit_name_id_p1
				scale = 1}
			fit_text_in_rectangle id = os_outfit_name_id_p1 dims = ((255.0, 0.0) + (<height> * (0.0, 1.0))) pos = (($gs_element_offsets [2]) + (-2.0, -10.0))
		endif
		...
		if (<add_style>)
			...
			if (<width> > 210)
				fit_text_in_rectangle id = <id> dims = ((160.0, 0.0) + (<height> * (0.0, 0.7))) pos = (<p1_menu_pos> + <menu_offset>)
			endif
		else
			createscreenelement {
				type = textelement
...
script destroy_select_style_menu \{player = 1}
	...
	if ($current_num_players = 1)
		...
		getuppercasestring <curr_style>
		setscreenelementprops id = os_outfit_style_id_p1 text = <uppercasestring>
		setscreenelementprops id = os_outfit_name_id_p1 scale = 1.3 pos = (($gs_element_offsets [2]) + (-2.0, -14.0))
		getscreenelementdims \{id = os_outfit_name_id_p1}
		if (<width> > 260)
			setscreenelementprops \{id = os_outfit_name_id_p1
				scale = 0.9}
		...
		if (<player> = 1)
			...
			if (<width> > 260)
				setscreenelementprops \{id = os_outfit_name_id_p1
					scale = 1}
				fit_text_in_rectangle id = os_outfit_name_id_p1 dims = ((255.0, 0.0) + ((<height>) * (0.0, 1.0))) pos = (0.0, 27.0)
			endif
			getuppercasestring <curr_style>
			setscreenelementprops {
				id = os_outfit_style_id_p1
			...
			if (<width> > 260)
				setscreenelementprops \{id = os_outfit_style_id_p1
					scale = 1}
				fit_text_in_rectangle id = os_outfit_style_id_p1 dims = ((255.0, 0.0) + ((<height>) * (0.0, 1.0))) pos = (0.0, 86.0)
			endif
			get_character_name \{player = 1}
			formattext checksumname = outfit_2_checksum 'Guitarist_%n_Outfit2_Style1' n = <character_name>
			getglobaltags <outfit_2_checksum>
...
script select_outfit_style_highlight \{player = 1
	...
	if ($current_num_players = 1)
		...
		if (<width> > 310)
			setscreenelementprops \{id = os_outfit_style_id_p1
				scale = 1}
			fit_text_in_rectangle id = os_outfit_style_id_p1 dims = ((305.0, 0.0) + ((<height>) * (0.0, 1.0))) ($gs_element_offsets [3])
		endif
		<offset> = (<index> * (0.0, 38.0))
		<l_pos> = ((-49.0, 3.0) + <offset>)
		<r_pos> = ((253.0, 3.0) + <offset>)
		<hl_pos> = ((-32.0, 0.0) + <offset>)
