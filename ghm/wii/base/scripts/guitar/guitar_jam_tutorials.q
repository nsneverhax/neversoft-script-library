...
script jam_tutorial_ghtunes 
	Wait \{1
		Second}
	training_show_title \{title = qs(0x7b7b2ca2)}
	Wait \{1
		Second}
	...
	LaunchEvent \{Type = unfocus
		target = current_menu}
	jam_tutorial_add_arrow \{Pos = (581.0, 212.0)
		life = 2
		rot = 90}
	Wait \{3
		Seconds}
	jam_tutorial_add_arrow \{Pos = (591.0, 242.0)
		life = 2
		rot = 90}
	...
	Wait \{4
		Seconds}
	jam_tutorial_add_arrow \{Pos = (500.0, 350.0)
		life = 2
		rot = 90}
	Wait \{2
		Seconds}
	jam_tutorial_add_arrow \{Pos = (600.0, 422.0)
		life = 2
		rot = 90}
