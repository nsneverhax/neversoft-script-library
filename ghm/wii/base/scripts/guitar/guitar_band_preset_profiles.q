...
preset_musician_profiles_modifiable = [
	{
		...
		appearance = {
			...
			cas_guitar_finish = {
				desc_id = gtr62_esp_alexi_ld_11
				chosen_materials = {
					material1 = yellow_1guitar
				}
			}
			cas_guitar_body_detail = {
				desc_id = gtr62b_esp_jack_dtl_04
				chosen_materials = {
					material1 = red_1
				}
			}
			...
			cas_bass_finish = {
				desc_id = bass9_esp_ax_ld_16
			}
			cas_bass_body_detail = {
				desc_id = bass9_esp_ax_dtl_04
				chosen_materials = {
					material1 = black_1guitar
				}
			}
			...
			cas_bass_neck_finish = {
				desc_id = bass_fretboard_24_inlay_03
			}
			cas_bass_head = {
	...
	}
	{
		...
		appearance = {
			...
			cas_guitar_head = {
				desc_id = gtr33_nekhed_02
			}
			cas_guitar_head_finish = {
				desc_id = gtr4_neckhead_d_07
			}
			cas_guitar_pickguards = {
				desc_id = None
			}
			...
			cas_bass_neck_finish = {
				desc_id = bass_fretboard_24_inlay_04
			}
			cas_bass_head = {
	...
	}
	{
		...
		appearance = {
			...
			cas_drum_finish = {
				desc_id = drumshell_ds_38
			}
			cas_drum_detail = {
				desc_id = bass_skin_ds_63
				chosen_materials = {
					material1 = green_1guitar
				}
			}
	...
	}
	{
		...
		appearance = {
			...
			cas_guitar_finish = {
				desc_id = gtr4_esp_eclipse_ld_03
			}
			cas_guitar_neck = {
				desc_id = gtr_22fret_fretboard_01
			}
	...
	}
	{
		...
		appearance = {
			...
			cas_guitar_finish = {
				desc_id = gtr36_superv_color
				chosen_materials = {
					material1 = black_1guitar
				}
			}
			cas_guitar_body_detail = {
				desc_id = gtr36_superv_stripe
				chosen_materials = {
					material1 = purple_blue_1
				}
			}
	...
	}
	{
		...
		appearance = {
			...
			cas_guitar_finish = {
				desc_id = gtr31_esp_viper01_d_color
				chosen_materials = {
					material1 = grey_4guitar
				}
			}
			...
			cas_bass_finish = {
				desc_id = bass64_f405_ld_06_color
				chosen_materials = {
					material1 = grey_4guitar
				}
			}
	...
	}
	{
		...
		appearance = {
			...
			cas_guitar_finish = {
				desc_id = gtr63f_esp_ex_ld_08_color
				chosen_materials = {
					material1 = black_1guitar
				}
			}
			cas_guitar_body_detail = {
				desc_id = gtr63f_esp_ex_dtl_13
				chosen_materials = {
					material1 = grey_5guitar
				}
			}
