...
script dlc_handle_error 
	if NOT GotParam \{0x2831844c}
		if GotParam \{0x940022bd}
			formatText TextName = error_text qs(0xd6d8029e) t = <error_text> s = <0x940022bd>
		endif
...
script dlc_set_sort_mode_text 
	...
	endswitch
	formatText TextName = sort_text qs(0x4dd8ab86) s = (qs(0x9d30a9c9)) m = <sort_text>
...
script 0x01bd06eb 
	...
	if (($dlc_current_secondary_menu) < 2)
		...
		formatText TextName = song_info qs(0x5e815e3c) y = <song_year> p = <song_price> b = <0x5e2e18c1>
	else
		...
		endswitch
		formatText TextName = song_info qs(0xb5b6e53f) y = <song_year> s = <0x3da7f018> b = <0x5e2e18c1>
	endif
	<0x385d9e9e> = 1
	if (<0x34c949da> = FALSE)
		<0x385d9e9e> = 0
	...
	if StructureContains \{structure = 0x201722de
		...
		if (($dlc_current_secondary_menu) < 2)
			if ((<0x201722de>.song_right) = 0)
				...
				formatText TextName = 0xa6578e96 qs(0x0204c31d) t = (<0x201722de>.song_right)
			endif
		else
			formatText TextName = 0xa6578e96 qs(0x0204c31d) t = (<0x201722de>.song_right)
		endif
...
script 0x17d4c456 
	...
	switch <0x82848b69>
		case corrupt
		formatText TextName = text qs(0x69bb6554) s = <0x8f160727> m = qs(0x12bd9112)
		options = [
			{
				func = 0xa6fb44e6
		...
		case present
		formatText TextName = text qs(0x69bb6554) s = <0x8f160727> m = qs(0x7561f01b)
		options = [
			{
				func = 0xa6fb44e6
				func_params = <0x764ae086>
		...
		case owned
		formatText TextName = text qs(0x69bb6554) s = <0x8f160727> m = qs(0x755ff34e)
		options = [
			{
				func = 0xbadf9968
		...
		case archived
		formatText TextName = text qs(0x69bb6554) s = <0x8f160727> m = qs(0xc74f0434)
		options = [
			{
				func = 0xcce13e1d
				func_params = {}
		...
		case 0x9cf5e95a
		formatText TextName = text qs(0x69bb6554) s = <0x8f160727> m = qs(0xcb25e33a)
		options = [
			{
				func = 0xbadf9968
...
script 0x4690501e 
	...
	<Scale> = (1.0, 1.0)
	<rgba> = [255 126 0 255]
	formatText TextName = 0x03901a90 qs(0x66680619) p = <wii_points>
...
script 0x480d2529 
	...
	formatText TextName = blocks_text qs(0x1e9c76ca) b = <0x88333d3f>
...
script 0xddaa9b47 
	...
	enablereset
	if GotParam \{error}
		formatText TextName = errortext qs(0x69ff815a) a = <error> b = qs(0xf1082659)
