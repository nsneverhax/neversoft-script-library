...
cas_male_hair = [
	...
	}
	{
		...
		acc_skeleton = skel_m_metl_hair_james_alt
	...
	}
	{
		...
		mesh = 'models/CAR/Male/M_Metl_Hair_Lars.skin'
		deform_mesh = 'models/CAR/Male/M_Metl_Hair_Lars_def.skin'
		$cas_male_hair_common_settings
	...
	{
		desc_id = m_metl_hair_younglars
		frontend_desc = qs(0x24487500)
		mesh = 'models/CAR/Male/M_Metl_Hair_YoungLars.skin'
		deform_mesh = 'models/CAR/Male/M_Metl_Hair_YoungLars_def.skin'
		material_groups = [
			{
				materials = [
					m_metl_hair_younglars_primary
				]
				shader = $cas_shader_hair
			}
			{
				materials = [
					m_metl_hair_younglars_secondary
				]
				shader = $cas_shader_skin
			}
		]
		hat_hair = m_metl_hathair_younglars
		acc_skeleton = skel_m_metl_hair_younglars
		acc_ragdoll = rag_m_metl_hair_younglars
		acc_bones = [
			bone_acc_head_01
			bone_acc_head_02
			bone_acc_head_03
	...
	}
	{
		...
		mesh = 'models/CAR/Male/M_Metl_Hair_Curlio.skin'
		deform_mesh = 'models/CAR/Male/M_Metl_Hair_Curlio_def.skin'
		$cas_male_hair_common_settings
		hat_hair = m_metl_hathair_curlio
		acc_skeleton = skel_m_metl_hair_curlio
		acc_ragdoll = rag_m_metl_hair_curlio
		acc_bones = [
			bone_acc_head_01
			bone_acc_head_02
			bone_acc_head_03
	...
	{
		desc_id = m_metl_hair_zach
		frontend_desc = qs(0x8fc76733)
		mesh = 'models/CAR/Male/M_Metl_Hair_Zach.skin'
		$cas_male_hair_common_settings
		acc_skeleton = skel_m_metl_hair_zach
		acc_ragdoll = rag_m_metl_hair_zach
		acc_bones = [
			bone_acc_head_01
			bone_acc_head_02
			bone_acc_head_03
	...
	{
		desc_id = m_metl_hair_james1
		frontend_desc = qs(0xc6831076)
		mesh = 'models/CAR/Male/M_Metl_Hair_James1.skin'
		deform_mesh = 'models/CAR/Male/M_Metl_Hair_James1_def.skin'
		$cas_male_hair_common_settings
		hat_hair = m_metl_hathair_james1
		acc_skeleton = skel_m_metl_hair_james1
		acc_ragdoll = rag_m_metl_hair_james1
		acc_bones = [
			bone_acc_head_01
			bone_acc_head_02
			bone_acc_head_03
	...
	{
		desc_id = m_metl_hair_james_alt
		frontend_desc = qs(0xc1904353)
		mesh = 'models/CAR/Male/M_Metl_Hair_James_alt.skin'
		deform_mesh = 'models/CAR/Male/M_Metl_Hair_James_Alt_def.skin'
		$cas_male_hair_common_settings
		hat_hair = m_metl_hathair_james_alt
		acc_skeleton = skel_m_metl_hair_james_alt
		acc_ragdoll = rag_m_metl_hair_james_alt
		acc_bones = [
			bone_acc_head_01
			bone_acc_head_02
			bone_acc_head_03
	...
	}
	{
		...
		mesh = 'models/CAR/Male/M_Rock_Hair_Braids.skin'
		deform_mesh = 'models/CAR/Male/M_Rock_Hair_Braids_def.skin'
		$cas_male_hair_common_settings
		hat_hair = m_rock_hathair_braids
		acc_skeleton = skel_m_rock_hair_braids
		acc_ragdoll = rag_m_rock_hair_braids
		acc_bones = [
			bone_acc_head_01
			bone_acc_head_02
			bone_acc_head_03
...
cas_male_hat_hair = [
	...
	}
	{
		...
		mesh = 'models/CAR/Male/M_Metl_HatHair_Lars.skin'
		deform_mesh = 'models/CAR/Male/M_Metl_HatHair_Lars_def.skin'
		$cas_male_hat_hair_common_settings
	}
	{
		desc_id = m_metl_hathair_younglars
		mesh = 'models/CAR/Male/M_Metl_HatHair_YoungLars.skin'
		deform_mesh = 'models/CAR/Male/M_Metl_HatHair_YoungLars_def.skin'
		material_groups = [
			{
				materials = [
					m_metl_hair_younglars_primary
	...
	}
	{
		...
		mesh = 'models/CAR/Male/M_Metl_HatHair_Curlio.skin'
		deform_mesh = 'models/CAR/Male/M_Metl_HatHair_Curlio_def.skin'
		$cas_male_hair_common_settings
		acc_skeleton = skel_m_metl_hair_curlio
		acc_ragdoll = rag_m_metl_hair_curlio
		acc_bones = [
	...
	{
		desc_id = m_metl_hathair_james1
		mesh = 'models/CAR/Male/M_Metl_HatHair_James1.skin'
		deform_mesh = 'models/CAR/Male/M_Metl_HatHair_James1_def.skin'
		$cas_male_hair_common_settings
		acc_skeleton = skel_m_metl_hair_james1
		acc_ragdoll = rag_m_metl_hair_james1
		acc_bones = [
	...
	{
		desc_id = m_metl_hathair_james_alt
		mesh = 'models/CAR/Male/M_Metl_HatHair_James_Alt.skin'
		deform_mesh = 'models/CAR/Male/M_Metl_HatHair_James_Alt_def.skin'
		$cas_male_hair_common_settings
		acc_skeleton = skel_m_metl_hair_james_alt
		acc_ragdoll = rag_m_metl_hair_james_alt
		acc_bones = [
	...
	}
	{
		...
		mesh = 'models/CAR/Male/M_Rock_HatHair_Braids.skin'
		deform_mesh = 'models/CAR/Male/M_Rock_HatHair_Braids_Def.skin'
		acc_skeleton = skel_m_rock_hair_braids
		acc_ragdoll = rag_m_rock_hair_braids
		acc_bones = [
			bone_acc_head_01
...
cas_male_hat = [
	...
	{
		desc_id = m_rock_hat_mcap
		frontend_desc = qs(0x0d2c66f8)
		mesh = 'models/CAR/Male/M_Rock_Hat_MCap.skin'
		deform_mesh = 'models/CAR/Male/M_Rock_Hat_MCap_def.skin'
		genre = [
			rock
		]
		price = 250
	...
	{
		desc_id = m_rock_hat_mcapbk
		frontend_desc = qs(0xf921d3c4)
		mesh = 'models/CAR/Male/M_Rock_Hat_MCapBK.skin'
		deform_mesh = 'models/CAR/Male/M_Rock_Hat_MCapBK_def.skin'
		genre = [
			rock
		]
		price = 250
	...
	{
		desc_id = m_bmtl_hat_kdhat
		frontend_desc = qs(0xf130b71a)
		mesh = 'models/CAR/Male/M_Bmtl_Hat_KDHat.skin'
		deform_mesh = 'models/CAR/Male/M_Bmtl_Hat_KDHat_def.skin'
		materials = [
