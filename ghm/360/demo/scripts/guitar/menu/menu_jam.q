...
script create_jam_menu 
	...
	<item_container_id> :se_setprops not_focusable generic_menu_smenu_textitem_text_rgba = [110 100 90 175]
...
script studio_skull_anim 
	generic_menu :se_setprops \{skull_eye_anim_alpha = 0}
	generic_menu :se_setprops \{studio_skull_anim_alpha = 1}
	se_getprops \{studio_skull_anim}
	<org_pos> = <studio_skull_anim>
	wait \{5
		gameframes}
	begin
	generic_menu :se_setprops \{skull_eye_anim_alpha = 0}
	generic_menu :se_setprops \{studio_skull_anim_alpha = 1}
	generic_menu :se_setprops \{studio_left_arm_pos = (-413.69022, -145.2674)}
	generic_menu :se_setprops \{studio_right_arm_pos = (-588.66907, 138.9052)}
	generic_menu :se_setprops \{studio_skull_anim_pos = (102.0247, 97.3169)}
	generic_menu :se_waitprops
	generic_menu :se_setprops \{studio_left_arm_pos = (-416.69022, -145.2674)
		time = 0.01}
	generic_menu :se_setprops \{studio_right_arm_pos = (-588.66907, 131.9052)
		time = 0.02}
	generic_menu :se_setprops \{studio_skull_anim_pos = (100.0247, 100.3169)
		time = 0.02}
	generic_menu :se_waitprops
	generic_menu :se_setprops \{studio_left_arm_pos = (-414.69022, -147.2674)
		time = 0.01}
	generic_menu :se_setprops \{studio_right_arm_pos = (-592.66907, 129.9052)
		time = 0.02}
	generic_menu :se_setprops \{studio_skull_anim_pos = (104.0247, 98.3169)
		time = 0.02}
	generic_menu :se_waitprops
	generic_menu :se_setprops \{studio_left_arm_pos = (-413.69022, -145.2674)}
	generic_menu :se_setprops \{studio_right_arm_pos = (-588.66907, 138.9052)}
