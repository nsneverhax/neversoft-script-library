cas_female_acc_left = [
	...
	}
	{
		...
		mesh = 'models/CAR/Female/F_Metl_Acc_LJewlGnlt.skin'
		genre = [
			goth
		]
		price = 150
	...
	{
		desc_id = f_metl_acc_lmtllogo
		frontend_desc = qs(0xbe129a80)
		mesh = 'models/CAR/Female/F_Mtl_Acc_LMtlLogo.skin'
		genre = [
			`heavy	metal`
		]
	}
...
cas_female_acc_right = [
	...
	}
	{
		...
		frontend_desc = qs(0x5b10a641)
		mesh = 'models/CAR/Female/F_Metl_Acc_RJewlGnlt.skin'
		genre = [
			goth
		]
		price = 150
...
cas_female_acc_face = [
	...
	}
	{
		...
		mesh = 'models/CAR/Female/F_Metl_Glasses_Nathan.skin'
		materials = [
