		...
		cap = [
			{
				...
				layers = [
					...
					{
						texture = `tex/models/characters/skater_male/decals/cag_primitiveshape_047.img`
						Color = grey_5guitar
						y_trans = -29
						x_scale = 96
						y_scale = 21
					...
					{
						texture = `tex/models/characters/skater_male/decals/cag_graphics090.img`
						Color = black_1guitar
						x_trans = -26
						y_scale = 2
						rot = 270
					...
					{
						texture = `tex/models/characters/skater_male/decals/cag_icon019.img`
						Color = black_1guitar
						y_trans = -29
						y_scale = 9
						rot = 5503
					...
					{
						texture = `tex/models/characters/skater_male/decals/cag_primitiveshape_015.img`
						Color = black_1guitar
						y_trans = -29
						x_skew = -75
						y_scale = 5
		...
		cap = [
			{
				...
				layers = [
					...
					{
						texture = `tex/models/characters/skater_male/decals/cag_primitiveshape_042.img`
						x_trans = 0
						y_trans = 21
						x_skew = -3
						x_scale = 110
		...
		cap = [
			{
				...
				layers = [
					...
					{
						texture = `tex/models/characters/skater_male/decals/cag_primitiveshape_038.img`
						Color = black_1guitar
						x_trans = -2
						y_trans = -17
						y_scale = 21
		...
		cap = [
			{
				...
				layers = [
					...
					{
						texture = `tex/models/characters/skater_male/decals/cag_graphics080.img`
						x_trans = 25
						x_scale = 62
						y_scale = 51
						flags = 3
					...
					{
						texture = `tex/models/characters/skater_male/decals/cag_graphics081.img`
						Color = grey_5guitar
						x_trans = -21
						x_scale = 66
						y_scale = 51
		...
		cap = [
			{
				...
				layers = [
					{
						texture = `tex/models/characters/skater_male/decals/cag_graphics052.img`
						x_scale = 98
						y_scale = 86
						flags = 3
						y_trans = 8
