cas_female_shoes = [
	...
	}
	{
		...
		mesh = 'models/CAR/Female/F_Punk_Shoe_ThickBoots.skin'
		materials = [
	...
	{
		desc_id = f_rock_shoe_longbiker
		frontend_desc = qs(0x1b393c4c)
		mesh = 'models/CAR/Female/F_Rock_Shoe_LongBiker.skin'
		materials = [
	...
	}
	{
		...
		mesh = 'models/CAR/Female/F_Metl_Shoe_PlatSndl.skin'
		materials = [
	...
	{
		desc_id = f_metl_shoes_mocboot
		frontend_desc = qs(0xcf2066e1)
		mesh = 'models/CAR/Female/F_Metl_Shoes_MocBoot.skin'
		materials = [
	...
	{
		desc_id = f_mtl_shoes_flame
		frontend_desc = qs(0xf7bcd4e0)
		mesh = 'models/CAR/Female/F_Mtl_Shoes_Flames.skin'
		diff_anim = 'female_heels_high_d'
		random_weight = 1.0
		price = 200
		genre = [
	...
	}
	{
		...
		frontend_desc = qs(0x88ce22a5)
		mesh = 'models/CAR/Female/F_Mtl_Shoes_FlamesB.skin'
		diff_anim = 'female_heels_high_d'
		materials = [
	...
	{
		desc_id = f_metl_shoes_bucklestrap
		frontend_desc = qs(0xf358715e)
		mesh = 'models/CAR/Female/F_Metl_Shoes_BuckleStrap.skin'
		materials = [
