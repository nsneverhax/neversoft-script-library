...
cas_male_lose_anim = [
	...
	}
	{
		desc_id = b_rob_lose
		hidden
		guitarist_anim_name = b_rob_lose_lose01
		bassist_anim_name = b_rob_lose_lose01
		drummer_anim_name = b_rob_lose_lose01
		singer_anim_name = b_rob_lose_lose01
	}
	{
		desc_id = d_lars_lose
		hidden
		guitarist_anim_name = d_lars_lose_lose01
		bassist_anim_name = d_lars_lose_lose01
		drummer_anim_name = d_lars_lose_lose01
		singer_anim_name = d_lars_lose_lose01
	}
	{
		desc_id = g_kirk_lose
		hidden
		guitarist_anim_name = g_kirk_lose_lose01
		bassist_anim_name = g_kirk_lose_lose01
		drummer_anim_name = g_kirk_lose_lose01
		singer_anim_name = g_kirk_lose_lose01
	}
	{
