cas_male_legs = [
	...
	}
	{
		...
		frontend_desc = qs(0x687c480f)
		mesh = 'models/CAR/Male/M_Rock_Legs_WorkShorts.skin'
		materials = [
	...
	}
	{
		...
		frontend_desc = qs(0xd36f55d8)
		mesh = 'models/CAR/Male/M_Bmtl_Legs_KDPants.skin'
		materials = [
	...
	}
	{
		...
		locked
		polaroid = car_grieves_pants
	}
	{
		desc_id = m_metl_legs_james
		frontend_desc = qs(0x656cd649)
		mesh = 'models/CAR/Male/M_Metl_Legs_James.skin'
		materials = [
	...
	}
	{
		...
		frontend_desc = qs(0x8cde89de)
		mesh = 'models/CAR/Male/M_Metl_Legs_JamesAlt.skin'
		random_weight = 1.0
		genre = [
			`heavy	metal`
		]
