...
script delete_layer \{cap_index = !i1768515945
		layer_index = !i1768515945
		part = !q1768515945}
	if NOT getcasappearancepart part = <part>
		ScriptAssert '%s not found' s = <part> donotresolve
	endif
...
script remove_layers_struct_from_cap \{part = !q1768515945
		cap = !a1768515945
		cap_index = !i1768515945}
...
script updatecasmodelcap 
	...
	updatecurrentcasmodel buildscript = modelbuilder_build_model flush_assets = <flush_assets> buildscriptparams = {part = <part>}
endscript
...
script widget_accept_cap 
	...
	if GotParam \{part}
		if checksumequals a = <part> b = cas_band_logo
			menu_finish car_helper_text_back no_rotate_zoom_text controller = <state_device>
		else
