...
script get_savegame_constants 
	...
	num_achievement_date_tags = ($g_total_num_achievements)
	...
	setuppackedstructtypes {
		...
		[
			...
			}
			{
				...
				buffer_size = (458 * <packed_compression>)
			}
			{
				Name = basses
				pool_size = (<num_savegames> * ($max_num_instrument_saves))
			...
			}
			{
				Name = drums
				pool_size = (<num_savegames> * ($max_num_instrument_saves))
				buffer_size = (234 * <packed_compression>)
			}
			{
				Name = vocals
				pool_size = (<num_savegames> * ($max_num_instrument_saves))
			...
			{
				Name = achievement_date_tags
				pool_size = <num_achievement_date_tags>
				fields =
				[
					{
						Name = day
