...
script finalbattle_intro01_rockdust 
	...
	SafeKill \{nodeName = z_finalbattle_sg_intropillar}
	SafeCreate \{nodeName = z_finalbattle_sg_intropillar_broken}
endscript
g_finalbattleintro2 = {
	time = 133
	ScriptTable = [
...
script gh6intro_fx_dg_attackkick 
	...
	CreateParticleSystem groupID = fxgid_dgattackkick Name = <uniqueID> objID = GUITARIST bone = Bone_Ankle_R ApplyPositionOffset Pos = (0.0, 0.0, -2.0) params_Script = $gp_fx_sd_dg_attacka_glow01
	SafeGetUniqueCompositeObjectID \{preferredID = fxid_sdattackkick02}
	CreateParticleSystem groupID = fxgid_dgattackkick Name = <uniqueID> objID = GUITARIST bone = Bone_Ankle_R ApplyPositionOffset Pos = (0.0, 0.0, -2.0) params_Script = $gp_fx_sd_dg_attacka_sparks01
...
script gh6intro_fx_dg_attackpunch 
	SoundEvent \{event = z_finalbattle_hita}
	SafeGetUniqueCompositeObjectID \{preferredID = fxid_sdattackkick01}
	CreateParticleSystem Name = <uniqueID> objID = GUITARIST bone = Bone_Hand_Index_Mid_R params_Script = $gp_fx_sd_dg_attacka_glow01
	SafeGetUniqueCompositeObjectID \{preferredID = fxid_sdattackkick02}
	CreateParticleSystem Name = <uniqueID> objID = GUITARIST bone = Bone_Hand_Index_Mid_R params_Script = $gp_fx_sd_dg_attacka_sparks01
	SafeGetUniqueCompositeObjectID \{preferredID = fxid_sdattackkick03}
