...
script loaddrumkitall \{standard = 1
	...
	if (<standard> = 1)
		...
		loaddrumpadgroup percussion = 0 drum_kit_index = <drum_kit_index> async = <async> song = <song> Heap = quota_drums
	endif
	if (<practice_percussion> = 1)
		loaddrumpadgroup percussion = 1 kit_string = ($g_practice_percussion_kit) async = <async> song = <song> Heap = quota_misc
	elseif (<percussion> = 1)
		...
		loaddrumpadgroup percussion = 1 drum_kit_index = <percussion_kit_index> async = <async> song = <song> Heap = quota_percussion
	endif
endscript
