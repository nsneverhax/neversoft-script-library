...
musicstudio_live_record_state = {
	...
	up = {
		choose_script = whammy_set_fast_forward
	}
	down = {
		choose_script = whammy_set_rewind
	}
	back = {
	}
	start = {
...
musicstudio_drum_kit_state = {
	...
	green = {
		...
		musicstudio_scrolling_state = musicstudio_scrolling_sound_select_drumkit_state
...
musicstudio_scrolling_sound_select_state = {
	...
	focus_script = musicstudio_preview_sound
...
musicstudio_scrolling_sound_select_drumkit_state = {
...
musicstudio_scrolling_sound_select_percussionkit_state = {
	...
	focus_script = musicstudio_percussion_preview_sound
	deinit_script = musicstudio_change_drum_kit_go_back
	init_script = musicstudio_enter_drum_sub_menu
	no_scrolling_sound
	yellow = {
...
script musicstudio_effect_exit_effect_select 
	...
	musicstudio_audible_scale_preview_shutdown
endscript
...
ghmix_warning_set_star_power_fail = qs(0xa242847a)
