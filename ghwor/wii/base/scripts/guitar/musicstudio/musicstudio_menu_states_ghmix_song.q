...
ghmix_song_save_pattern_state = {
	...
	init_script = musicstudio_whammy_disable
	deinit_script = musicstudio_whammy_enable
	green = {
	...
	blue = {
		...
		choose_script = save_pattern_check
		musicstudio_state = ghmix_song_transport_state
	}
	orange = {
		name_text = qs(0x77bb1534)
...
musicstudio_scrolling_manage_patterns = {
	...
	yellow = {
		...
		choose_script = ghmix_song_check_delete_pattern
	}
}
