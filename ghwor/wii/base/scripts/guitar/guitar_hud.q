...
script rp_newfemale_lv2_fx 
	...
	Destroy2DParticleSystem id = <fx1> kill_when_empty
	if ScreenElementExists id = <right_sp_id>
		<right_sp_id> :se_setprops rp_tesla_spark_fx_alpha = 0 time = 0.1
		<right_sp_id> :se_setprops rp_tesla_fx_lv2_alpha = 0 time = 0.1
		<right_sp_id> :se_setprops rp_tesla_spark_alpha = 0
...
script starearn01 
	...
	<rp_fx02> = <id>
	<rp_star01> :se_setprops Pos = {(0.0, 20.0) relative} Scale = (0.5, 0.5) alpha = 0 rot_angle = 0
	Wait \{1
		Frame}
	<rp_star01> :se_setprops Pos = {(0.0, -20.0) relative} Scale = (0.75, 0.75) alpha = 1 rot_angle = 0 time = 0.25
	Wait \{0.25
		Seconds}
	Wait \{0.5
		Seconds}
