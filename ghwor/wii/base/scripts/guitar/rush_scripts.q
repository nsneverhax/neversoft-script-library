...
g_rushintro0 = {
	...
	ScriptTable = [
		...
		{
			time = 35117
			Scr = z_modular_intro_snapshot_change
			params
		}
	]
...
g_rushoutro6 = {
	...
	endwithscript = rush_forceframerate_off
}
g_rushoutro7 = {
	time = 29500
	ScriptTable = [
...
script rush_forceframerate_on 
	Change \{g_frame_rate_lock_value = 60}
endscript

script rush_forceframerate_off 
	Change \{g_frame_rate_lock_value = 0}
endscript
