...
script create_exploding_text \{parent = 'you_rock_physics'
	...
	fx_id = <id>
	SpawnScriptNow you_rock_text_glow params = {parent = <fx_id>}
	...
	fx_id = <id>
	SpawnScriptNow urok_fx_xplosion01 params = {parent = <fx_id>}
endscript
...
script create_exploding_particles 
	...
	formatText checksumName = particle2_id 'particle2_%i' i = <i>
...
script split_text_into_physics_array_elements \{text = qs(0x6f6d143d)
	...
	if GotParam \{fit_dims}
		...
		if ($is_network_game = 1)
			<adjust> = (1.0, 1.0)
		elseif is_roadie_battle_competitive
			<adjust> = (1.0, 1.0)
		endif
		CreateScreenElement {
			Type = TextElement
