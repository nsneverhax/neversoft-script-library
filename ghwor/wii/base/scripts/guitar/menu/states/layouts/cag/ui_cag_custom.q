...
script ui_create_cag_custom \{cag_preset_index = !i1768515945}
	title = qs(0x8694014b)
	...
	make_generic_car_menu {
		...
		pad_back_params = {cag_preset_index = <cag_preset_index>}
	}
	...
	adjust_fov_for_guitar_head_camera
	add_car_menu_text_item {
		icon = icon_cag_head
		text = qs(0x69a146e9)
...
script ui_return_cag_custom 
	ui_destroy_cag_custom <...>
	ui_create_cag_custom <...>
endscript

script ui_cag_custom_back \{cag_preset_index = !i1768515945}
	generic_event_back_block
endscript

script ui_cab_custom_back \{cag_preset_index = !i1768515945}
	generic_event_back_block
endscript

script adjust_fov_for_guitar_head_camera 
	ngc_getwide
	if (<widescreen> = true)
		printf \{'==============Using wide screen mode================='}
		updatestructelement struct = ($ui_cag_custom_head_camera.params) element = FOV value = 65.0
		Change ui_cag_custom_head_camera = (($ui_cag_custom_head_camera) + {params = <newstruct>})
	else
		printf \{'==============Using standard screen mode================='}
		updatestructelement struct = ($ui_cag_custom_head_camera.params) element = FOV value = 52.0
		Change ui_cag_custom_head_camera = (($ui_cag_custom_head_camera) + {params = <newstruct>})
	endif
endscript
