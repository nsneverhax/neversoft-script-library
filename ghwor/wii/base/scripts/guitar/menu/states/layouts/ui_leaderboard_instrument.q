...
script ui_create_leaderboard_instrument 
	...
	current_menu :SetTags \{pointer_grabbable = true}
	current_menu :se_setprops \{event_handlers = [
			{
				pad_option2
				leaderboards_create_achievements_ui
			}
		]}
	...
	add_user_control_helper \{text = qs(0xaf4d5dd2)
		...
		z = 100000
		all_buttons}
	add_user_control_helper \{text = qs(0x2be0ec23)
		button = yellow
		z = 100000}
...
script ui_leaderboard_instrument_select 
	...
	if netstatus_checkforerrors \{context = stats_lobby}
		show_last_connection_error \{context = stats_lobby}
	else
