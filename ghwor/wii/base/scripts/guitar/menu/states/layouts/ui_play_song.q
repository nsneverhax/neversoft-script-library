...
script get_jam_filename \{Type = current
	...
	if (<example_song> = 1)
		...
		<actual_filename> = ($jam_curr_directory_listing [<jam_index>].actual_file_name)
	endif
	return true FileName = <FileName> actual_filename = <actual_filename> example_song = <example_song> jam_display_name = <jam_display_name>
endscript
