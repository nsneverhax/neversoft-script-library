...
ui_character_selection_camera = {
	...
	params = {
		...
		Pos = (-0.054568, 1.2011342, 1.481803)
		Quat = (0.005235, -0.9903699, 0.040436998)
		FOV = 72.0
	}
	time = 0
	transitiondof = $dof_b02_l_tod_manager
	DOF = $dof_b02_l_tod_manager
	Bloom = $default_tod_manager_bl_c05
	blend_transition_dof = 1
}
ui_character_selection_camera_old = {
	controlscript = CameraCuts_HandCam
	params = {
		LockTo = $cas_current_player_name
...
ui_customize_character_body_camera = $ui_character_selection_camera_old
...
ui_customize_character_b_camera = {
	...
	params = {
		LockTo = $cas_current_player_name
		Pos = (0.003994, 1.5648679, -3.09448)
		Quat = (0.088557005, 0.100176, -0.008853)
		FOV = 95.0
	}
	time = 0.4
	transitiondof = $dof_b02_l_tod_manager
...
ui_cag_main_camera = {
	params = {
		...
		ScreenOffset = (0.513834, 0.43024102)
		distfromlookat = 1.5313231
	}
	time = 0.4
	transitiondof = $dof_b01_l_tod_manager
	DOF = $dof_b01_l_tod_manager
	Bloom = $default_tod_manager_bl_c05
	blend_transition_dof = 1
}
ui_cag_main_l_camera = {
	params = {
		...
		LookAt = $cas_current_player_name
		LookAtBone = bone_guitar_body
		ScreenOffset = (0.518401, 0.40749303)
		distfromlookat = 1.595028
	}
	time = 0.4
	transitiondof = $dof_b01_l_tod_manager
	DOF = $dof_b01_l_tod_manager
...
ui_cag_main_r_camera = {
	params = {
		...
		LookAt = $cas_current_player_name
		LookAtBone = bone_guitar_body
		ScreenOffset = (0.49309, 0.42905203)
		distfromlookat = 1.585851
	}
	time = 0.4
	transitiondof = $dof_b01_l_tod_manager
	DOF = $dof_b01_l_tod_manager
...
ui_cag_main_b_camera = {
	params = {
		...
		LookAt = $cas_current_player_name
		LookAtBone = bone_guitar_body
		ScreenOffset = (0.419462, 0.48311102)
		distfromlookat = 1.655082
	}
	time = 0.4
	transitiondof = $dof_b01_l_tod_manager
	DOF = $dof_b01_l_tod_manager
...
ui_cag_custom_body_camera = {
	params = {
		...
		LookAt = $cas_current_player_name
		LookAtBone = bone_guitar_body
		ScreenOffset = (0.452383, 0.13920501)
		distfromlookat = 0.533932
	}
	time = 0.3
	transitiondof = $dof_b02_l_tod_manager
	DOF = $dof_b01_l_tod_manager
	Bloom = $default_tod_manager_bl_c03
	blend_transition_dof = 1
}
ui_cag_custom_body_l_camera = {
	params = {
		...
		LookAt = $cas_current_player_name
		LookAtBone = bone_guitar_body
		ScreenOffset = (0.58603597, 0.134967)
		distfromlookat = 0.558946
	}
	time = 0.3
	transitiondof = $dof_b02_l_tod_manager
	DOF = $dof_b01_l_tod_manager
...
ui_cag_custom_body_r_camera = {
	params = {
		...
		LookAt = $cas_current_player_name
		LookAtBone = bone_guitar_body
		ScreenOffset = (0.453587, 0.06442199)
		distfromlookat = 0.534465
	}
	time = 0.3
	transitiondof = $dof_b02_l_tod_manager
	DOF = $dof_b01_l_tod_manager
...
ui_cag_custom_body_b_camera = {
	params = {
		...
		LookAt = $cas_current_player_name
		LookAtBone = bone_guitar_body
		ScreenOffset = (0.47451, 0.23726602)
		distfromlookat = 0.83642
	}
	time = 0.3
	transitiondof = $dof_b02_l_tod_manager
	DOF = $dof_b01_l_tod_manager
...
ui_cag_custom_head_camera = {
	params = {
		...
		LookAt = $cas_current_player_name
		LookAtBone = bone_guitar_body
		ScreenOffset = (0.48476002, 3.4329693)
		distfromlookat = 0.874187
	}
	time = 0.3
	transitiondof = $dof_b02_l_tod_manager
	DOF = $dof_b01_l_tod_manager
...
ui_cag_custom_head_l_camera = {
	params = {
		...
		LookAt = $cas_current_player_name
		LookAtBone = bone_guitar_body
		ScreenOffset = (0.503403, 3.2359083)
		distfromlookat = 0.87022996
	}
	time = 0.3
	transitiondof = $dof_b02_l_tod_manager
	DOF = $dof_b01_l_tod_manager
...
ui_cag_custom_head_r_camera = {
	params = {
		...
		LookAt = $cas_current_player_name
		LookAtBone = bone_guitar_body
		ScreenOffset = (0.40866798, 3.236282)
		distfromlookat = 0.871445
	}
	time = 0.3
	transitiondof = $dof_b02_l_tod_manager
	DOF = $dof_b01_l_tod_manager
...
ui_cag_custom_head_b_camera = {
	params = {
		...
		LookAt = $cas_current_player_name
		LookAtBone = bone_guitar_body
		ScreenOffset = (0.43617103, 3.2170908)
		distfromlookat = 0.87975603
	}
	time = 0.3
	transitiondof = $dof_b02_l_tod_manager
	DOF = $dof_b01_l_tod_manager
...
ui_cag_select_fretboard_camera = {
	params = {
		...
		LookAt = $cas_current_player_name
		LookAtBone = bone_guitar_body
		ScreenOffset = (0.47859797, 1.1815541)
		distfromlookat = 0.84749305
	}
	time = 0.3
	transitiondof = $dof_b01_l_tod_manager
	DOF = $dof_b01_l_tod_manager
...
ui_cag_select_fretboard_l_camera = {
	params = {
		...
		LookAt = $cas_current_player_name
		LookAtBone = bone_guitar_body
		ScreenOffset = (0.49163502, 1.2462242)
		distfromlookat = 0.85082805
	}
	time = 0.3
	transitiondof = $dof_b01_l_tod_manager
	DOF = $dof_b01_l_tod_manager
...
ui_cag_select_fretboard_r_camera = {
	params = {
		...
		LookAt = $cas_current_player_name
		LookAtBone = bone_guitar_body
		ScreenOffset = (0.45679504, 1.2681509)
		distfromlookat = 0.852791
	}
	time = 0.3
	transitiondof = $dof_b01_l_tod_manager
	DOF = $dof_b01_l_tod_manager
...
ui_cag_select_fretboard_b_camera = {
	params = {
		...
		LookAt = $cas_current_player_name
		LookAtBone = bone_guitar_body
		ScreenOffset = (0.46249703, 1.493261)
...
ui_cad_select_skin_camera = {
	params = {
		LockTo = $cas_current_player_name
		Pos = (-0.39780903, 0.58718103, 2.201982)
...
ui_cadrm_skin_l_camera = {
	params = {
		LockTo = $cas_current_player_name
		Pos = (-1.30182, 0.52667594, 1.3957729)
...
ui_cadrm_skin_r_camera = {
	params = {
		LockTo = $cas_current_player_name
		Pos = (0.812152, 0.608537, 1.7807381)
