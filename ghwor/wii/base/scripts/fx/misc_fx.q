...
script lars_snort 
	...
	CreateParticleSystem Name = <uniqueID> objID = <objID> bone = bone_head params_Script = {$gp_fx_festival_encore_snortl01 Color = -2139062095 LightGroup = Band}
	SafeGetUniqueCompositeObjectID preferredID = fxid_snortr01 objID = <objID>
	CreateParticleSystem Name = <uniqueID> objID = <objID> bone = bone_head params_Script = {$gp_fx_festival_encore_snortr01 Color = -2139062095 LightGroup = Band}
	Wait RandomFloat (2.0, 10.0) Seconds
	repeat
endscript
