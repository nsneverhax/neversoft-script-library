cas_male_legs = [
	...
	}
	{
		...
		cloth = `models/car/male/m_punk_legs_cuff`
		cloth_coll_skeleton = cloth_coll_data_male
		cloth_coll_bones = [
			bone_pelvis
			bone_thigh_r
	...
	}
	{
		...
		cloth = `models/car/male/m_punk_legs_johnny1`
		cloth_coll_skeleton = cloth_coll_data_male
		cloth_coll_bones = [
			bone_pelvis
			bone_thigh_r
	...
	}
	{
		...
		cloth = `models/car/male/m_punk_legs_johnny1_02`
		cloth_coll_skeleton = cloth_coll_data_male
		cloth_coll_bones = [
			bone_pelvis
			bone_thigh_r
		...
		swatch_for = m_punk_legs_johnny1
	...
	}
	{
		...
		cloth = `models/car/male/m_punk_legs_johnny1_03`
		cloth_coll_skeleton = cloth_coll_data_male
		cloth_coll_bones = [
			bone_pelvis
			bone_thigh_r
	...
	}
	{
		...
		cloth = `models/car/male/m_punk_legs_johnny1_04`
		cloth_coll_skeleton = cloth_coll_data_male
		cloth_coll_bones = [
			bone_pelvis
			bone_thigh_r
	...
	}
	{
		...
		cloth = `models/car/male/m_punk_legs_jny_2`
		cloth_coll_skeleton = cloth_coll_data_male
		cloth_coll_bones = [
			bone_pelvis
			bone_thigh_r
	...
	}
	{
		...
		frontend_desc = qs(0x81e04dd0)
		mesh = `models/car/male/m_pandoraband_legs`
		random_weight = 0.1
		genre = [
			goth
		]
