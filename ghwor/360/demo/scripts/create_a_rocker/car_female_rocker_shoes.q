cas_female_shoes = [
	...
	{
		desc_id = f_spnr_shoe_gh6converse1
		frontend_desc = qs(0xef5b14ea)
		mesh = `models/car/female/f_spnr_shoe_gh6converse1`
		random_weight = 1.0
		genre = [
			rock
		]
	...
	{
		desc_id = f_spnr_shoe_gh6converse2
		frontend_desc = qs(0xdfb01660)
		mesh = `models/car/female/f_spnr_shoe_gh6converse2`
		random_weight = 1.0
		genre = [
			rock
		]
		material_groups = [
			{
				materials = [
					f_spnr_shoe_gh6converse2_shoe
				]
				shader = $cas_shader_skin_masked1
			}
			{
				materials = [
					f_spnr_shoe_gh6converse2_sole
				]
				shader = $cas_shader_skin
			}
			{
				materials = [
					f_spnr_shoe_gh6converse2_laces
				]
				shader = $cas_shader_skin
			}
		]
	...
	{
		desc_id = f_spnr_shoe_gh6converse3
		frontend_desc = qs(0x95db92c3)
		mesh = `models/car/female/f_spnr_shoe_gh6converse3`
		random_weight = 1.0
		genre = [
			rock
		]
		material_groups = [
			{
				materials = [
					f_spnr_shoe_gh6converse3_shoe
				]
				shader = $cas_shader_skin_masked1
			}
			{
				materials = [
					f_spnr_shoe_gh6converse3_sole
				]
				shader = $cas_shader_skin
			}
			{
				materials = [
					f_spnr_shoe_gh6converse3_laces
				]
				shader = $cas_shader_skin
			}
		]
	...
	{
		desc_id = f_spnr_shoe_gh6converse4
		frontend_desc = qs(0x9edd39c7)
		mesh = `models/car/female/f_spnr_shoe_gh6converse4`
		random_weight = 1.0
		genre = [
			rock
		]
	...
	{
		desc_id = f_spnr_shoe_gh6converse5
		frontend_desc = qs(0x9edd39c7)
		mesh = `models/car/female/f_spnr_shoe_gh6converse5`
		random_weight = 1.0
		genre = [
			rock
		]
		swatch_for = f_spnr_shoe_gh6converse4
		swatch_texture = `tex/models/characters/car/sponsor/swach_gh6converse5`
	}
	{
		desc_id = f_spnr_shoe_gh6converse6
		frontend_desc = qs(0x9edd39c7)
		mesh = `models/car/female/f_spnr_shoe_gh6converse6`
		random_weight = 1.0
		genre = [
			rock
		]
	...
	{
		desc_id = f_spnr_shoe_gh6converse7
		frontend_desc = qs(0x9edd39c7)
		mesh = `models/car/female/f_spnr_shoe_gh6converse7`
		random_weight = 1.0
		genre = [
			rock
		]
	...
	{
		desc_id = f_spnr_shoe_gh6converse8
		frontend_desc = qs(0xa63d4eaa)
		mesh = `models/car/female/f_spnr_shoe_gh6converse8`
		random_weight = 1.0
		genre = [
			rock
		]
		material_groups = [
			{
				materials = [
					f_spnr_shoe_gh6converse8_shoe
				]
				shader = $cas_shader_skin_masked1
			}
			{
				materials = [
					f_spnr_shoe_gh6converse8_sole
				]
				shader = $cas_shader_skin
			}
			{
				materials = [
					f_spnr_shoe_gh6converse8_laces
				]
				shader = $cas_shader_skin
			}
		]
	...
	{
		desc_id = f_spnr_shoe_drm_tectuff01
		frontend_desc = qs(0xe908df2f)
		mesh = `models/car/female/f_spnr_shoe_drm_tectuff01`
		random_weight = 1.0
		genre = [
			rock
		]
		...
		swatch_texture = `tex/models/characters/car/sponsor/swach_f_drm_tectuff01`
	}
	{
		desc_id = f_spnr_shoe_drm_tectuff02
		frontend_desc = qs(0xa04a4d07)
		mesh = `models/car/female/f_spnr_shoe_drm_tectuff02`
		random_weight = 1.0
		genre = [
			rock
		]
		swatch_for = f_spnr_shoe_drm_tectuff01
		swatch_texture = `tex/models/characters/car/sponsor/swach_f_drm_tectuff02`
	}
	{
		desc_id = f_spnr_shoe_drm_tectuff03
		frontend_desc = qs(0x042e519d)
		mesh = `models/car/female/f_spnr_shoe_drm_tectuff03`
		random_weight = 1.0
		genre = [
			rock
		]
		swatch_for = f_spnr_shoe_drm_tectuff01
		swatch_texture = `tex/models/characters/car/sponsor/swach_f_drm_tectuff03`
	}
	{
		desc_id = f_spnr_shoe_drm_tectuff04
		frontend_desc = qs(0x783028c3)
		mesh = `models/car/female/f_spnr_shoe_drm_tectuff04`
		random_weight = 1.0
		genre = [
			rock
		]
		swatch_for = f_spnr_shoe_drm_tectuff01
		swatch_texture = `tex/models/characters/car/sponsor/swach_f_drm_tectuff04`
	}
	{
		desc_id = f_spnr_shoe_vansl_scribhart
		frontend_desc = qs(0x3f02dde9)
		mesh = `models/car/female/f_spnr_shoe_vansl_scribhart`
		random_weight = 0.0
		genre = [
			rock
		]
		material_groups = [
			{
				materials = [
					f_spnr_shoe_vansl_scribhart_01
				]
				shader = $cas_shader_skin_masked1
			}
		]
	...
	{
		desc_id = f_spnr_shoe_vansl_multibitrswt
		frontend_desc = qs(0xb4b92882)
		mesh = `models/car/female/f_spnr_shoe_vansl_multibitrswt`
		random_weight = 0.0
		genre = [
			rock
		]
		material_groups = [
			{
				materials = [
					f_spnr_shoe_vansl_multibitrswt_01
				]
				shader = $cas_shader_skin_masked1
			}
		]
	...
	}
	{
		...
		frontend_desc = qs(0x1c3ba5d1)
		mesh = `models/car/female/f_fun_shoe_etesla2`
		random_weight = 1.0
		genre = [
			rock
		]
	...
	}
	{
		...
		frontend_desc = qs(0x8b46b02f)
		mesh = `models/car/female/f_pandband01_shoes`
		genre = [
			goth
		]
	...
	}
	{
		...
		frontend_desc = qs(0x4a9fc25f)
		mesh = `models/car/female/f_pandband02_shoes`
