...
script ui_create_cap_artist_layer_options \{back_steps = 2
	...
	setup_cas_menu_handlers vmenu_id = create_cap_artist_layer_options_vmenu camera_list = <camera_list> zoom_camera = <zoom_camera> no_rotate = <no_rotate> no_zoom = <no_zoom> controller = <state_device>
	...
	if screenelementexists \{id = color_wheel_menu_item}
		...
		setup_cas_menu_handlers vmenu_id = color_wheel_menu_item camera_list = <camera_list> zoom_camera = <zoom_camera> no_rotate = <no_rotate> no_zoom = <no_zoom> controller = <state_device>
	endif
endscript
