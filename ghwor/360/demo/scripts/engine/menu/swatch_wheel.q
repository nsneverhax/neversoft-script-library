...
script create_swatch_wheel \{focus_script = swatch_wheel_focus
	...
	createscreenelement {
		...
		event_handlers = [{focus <focus_script> <focus_params>}
			...
			{pad_choose swatch_wheel_choose params = {camera_list = <camera_list> zoom_camera = <zoom_camera>}}
		]
		<not_focusable>
...
script swatch_wheel_choose 
	...
	launchevent \{type = focus
		target = swatch_wheel}
	setup_cas_menu_handlers vmenu_id = swatch_wheel camera_list = <camera_list> zoom_camera = <zoom_camera>
