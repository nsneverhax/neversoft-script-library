...
script temp_goal_counter_create \{label = qs(0xc5a34f17)
	...
	formatText TextName = count_text qs(0x39f26b60) c = <count>
	...
	formatText TextName = total_text qs(0x3c71eff6) t = <target>
...
script temp_goal_counter_update \{new_count = 0}
	...
	formatText TextName = count_text qs(0x39f26b60) c = <new_count>
