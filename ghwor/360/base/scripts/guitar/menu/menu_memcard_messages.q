...
script create_jam_out_of_space_menu \{message_type = Default}
	memcard_sequence_show_dialog
	GetPlatform
	switch <Platform>
		case PS3
		ScriptAssert \{'PS3 should not use this memcard check'}
		MC_SpaceForNewFolder \{desc = GuitarContent}
		formatText TextName = message qs(0xe2a38082) s = $memcard_default_title d = <SpaceRequired>
		create_dialog_box {
			body_text = <message>
