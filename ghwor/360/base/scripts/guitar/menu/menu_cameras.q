...
ui_cag_custom_body_camera = {
	params = {
		...
		Quat = (0.004199, -0.99810696, 0.018097999)
		FOV = 72.0
		LookAt = $cas_current_player_name
		LookAtBone = bone_guitar_body
		ScreenOffset = (0.45717102, 0.156831)
		distfromlookat = 0.91711503
	}
	time = 0.3
	transitiondof = $dof_car_sel_guitar_tod_manager
	DOF = $dof_car_sel_guitar_tod_manager
...
ui_cag_custom_body_l_camera = {
	params = {
		LockTo = $cas_current_player_name
		Pos = (-0.87955207, 1.0914271, 0.18406901)
		Quat = (0.025649002, 0.91696894, -0.017852)
		FOV = 72.0
		LookAt = $cas_current_player_name
		LookAtBone = bone_guitar_body
		ScreenOffset = (0.524736, 0.12423601)
		distfromlookat = 0.871305
	}
	time = 0.3
	transitiondof = $dof_car_sel_guitar_tod_manager
	DOF = $dof_car_sel_guitar_tod_manager
...
ui_cag_custom_body_r_camera = {
	params = {
		LockTo = $cas_current_player_name
		Pos = (0.479507, 1.0768721, 0.63446903)
		Quat = (0.026923997, -0.903329, 0.019813001)
		FOV = 72.0
		LookAt = $cas_current_player_name
		LookAtBone = bone_guitar_body
		ScreenOffset = (0.42523602, 0.08248799)
		distfromlookat = 0.989859
	}
	time = 0.3
	transitiondof = $dof_car_sel_guitar_tod_manager
	DOF = $dof_car_sel_guitar_tod_manager
...
ui_cag_select_fretboard_b_camera = {
	params = {
		LockTo = $cas_current_player_name
		Pos = (0.437262, 1.5904, -0.891456)
		Quat = (0.07238799, -0.181713, 0.028391998)
		FOV = 72.0
		LookAt = $cas_current_player_name
		LookAtBone = bone_guitar_body
		ScreenOffset = (0.37422502, 1.2147759)
		distfromlookat = 1.0693929
	}
	time = 0.3
	transitiondof = $dof_car_sel_guitar_tod_manager
	DOF = $dof_car_sel_guitar_tod_manager
...
ui_cad_select_skin_camera = {
	params = {
		LockTo = $cas_current_player_name
		Pos = (-0.289208, 0.59046996, 1.521386)
		Quat = (0.007951001, -0.9906699, 0.118788995)
		FOV = 72.0
	}
	time = 0.3
	transitiondof = $dof_car_sel_drums_tod_manager
...
ui_customize_microphone_camera = {
	params = {
		LockTo = $cas_current_player_name
		Pos = (-0.000419, 1.4576939, 0.534863)
		Quat = (0.000444, -0.98687494, 0.017558)
		FOV = 72.0
		LookAt = $cas_current_player_name
		LookAtBone = bone_mic_microphone
		ScreenOffset = (0.46924502, 0.023591999)
		distfromlookat = 0.64820004
	}
	time = 0.3
...
ui_customize_microphone_l_camera = {
	params = {
		LockTo = $cas_current_player_name
		Pos = (-0.46691802, 1.448, 0.170244)
		Quat = (0.006869, 0.93601495, -0.013371)
		FOV = 72.0
		LookAt = $cas_current_player_name
		LookAtBone = bone_mic_microphone
		ScreenOffset = (0.45489803, 0.0050589996)
		distfromlookat = 0.52933896
	}
	time = 0.3
	transitiondof = $dof_car_sel_microphone_tod_manager
	DOF = $dof_car_sel_microphone_tod_manager
...
ui_customize_microphone_r_camera = {
	params = {
		LockTo = $cas_current_player_name
		Pos = (0.50216, 1.450887, 0.09105901)
		Quat = (0.007939001, -0.75090694, 0.011088)
		FOV = 72.0
		LookAt = $cas_current_player_name
		LookAtBone = bone_mic_microphone
		ScreenOffset = (0.39819, 0.023131)
		distfromlookat = 0.56134295
	}
	time = 0.3
	transitiondof = $dof_car_sel_microphone_tod_manager
	DOF = $dof_car_sel_microphone_tod_manager
