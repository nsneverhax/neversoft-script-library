...
award_point_progression = [
	...
	{
		award_points = 20
		Name = neversoft_gallery
		frontend_desc = qs(0x2e66cc26)
		desc_additional_text = unlockable_video_short_text
		vague_frontend_desc = unlockable_video_text
		unlock_icon = unlockable_art
		rewards = [
			{
				reward_type = art_gallery
				gallery_name = neversoft_gallery
			}
		]
	}
	{
	...
	{
		award_points = 1400
		Name = bh_lightshow_gallery
		frontend_desc = qs(0x7afd671d)
		desc_additional_text = unlockable_video_short_text
		vague_frontend_desc = unlockable_video_text
		unlock_icon = unlockable_art
		rewards = [
			{
				reward_type = art_gallery
				gallery_name = bh_lightshow_gallery
			}
		]
	}
	{
	...
	{
		award_points = 1520
		Name = gh5_lightshow_gallery
		frontend_desc = qs(0xd655074a)
		desc_additional_text = unlockable_video_short_text
		vague_frontend_desc = unlockable_video_text
		unlock_icon = unlockable_art
		rewards = [
			{
				reward_type = art_gallery
				gallery_name = gh5_lightshow_gallery
			}
		]
	}
	{
	...
	{
		award_points = 1680
		Name = gh6_lightshow_gallery
		frontend_desc = qs(0x88e6fd39)
		desc_additional_text = unlockable_video_short_text
		vague_frontend_desc = unlockable_video_text
		unlock_icon = unlockable_art
		rewards = [
			{
				reward_type = art_gallery
				gallery_name = gh6_lightshow_gallery
			}
		]
	}
	{
