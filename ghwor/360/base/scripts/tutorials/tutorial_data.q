			...
			}
			{
				...
				pages = [
					...
					}
					{
						...
						time_shown = 1
						text = qs(0xe3f0f6f6)
						audio_stream = 'Tut_Gnr1_L02_17'
						images = [
							{
								image = tutorial_general_song_progress
								time_shown = 1
							}
						]
					}
			...
			}
			{
				...
				pages = [
					...
					}
					{
						...
						images = [
							{
								image = tutorial_general_challenge_icons
								time_shown = 1
							}
						]
					}
					...
					}
					{
						...
						images = [
							{
								image = tutorial_general_ambient_icon
								time_shown = 1
							}
						]
					}
			...
			}
			{
				...
				pages = [
					...
					}
					{
						...
						time_shown = 1
						text = qs(0x3f2043f0)
						audio_stream = 'Tut_Gnr1_L04_02'
						images = [
							{
								image = tutorial_general_targeted_challenge
								time_shown = 1
								Scale = 1
							}
						]
					...
					}
					{
						...
						time_shown = 1
						text = qs(0x1938f5b2)
						audio_stream = 'Tut_Gnr1_L04_08'
						images = [
							{
								image = tutorial_general_challenge_section
								time_shown = 1
							}
						]
					}
					...
					}
					{
						...
						time_shown = 1
						text = qs(0x54c88c80)
						audio_stream = 'Tut_Gnr1_L04_11'
						images = [
							{
								image = tutorial_general_challenge_tracker
								time_shown = 1
							}
						]
					}
					...
					}
					{
						...
						time_shown = 1
						text = qs(0x5c51dd11)
						audio_stream = 'Tut_Gnr1_L04_13'
						images = [
							{
								image = tutorial_general_targeted_score
								time_shown = 1
							}
						]
					}
					{
						...
						time_shown = 1
						text = qs(0xfe21d41b)
						audio_stream = 'Tut_Gnr1_L04_14'
						images = [
							{
								image = tutorial_general_beat_targeted_score
								time_shown = 1
							}
						]
					}
		...
		lessons = [
			{
				...
				pages = [
					...
					}
					{
						...
						Type = 'text_with_images'
						text = qs(0x5510756c)
						audio_stream = 'Tut_Bss1_L01_08a'
						images = [
							{
								image = tutorial_guitar_highway_open_sustain
								time_shown = 1
							}
						]
					}
			...
			}
			{
				...
				pages = [
					...
					}
					{
						...
						time_shown = 1
						text = qs(0xff2075bb)
						audio_stream = 'Tut_Drm3_L03_03a'
						images = [
							{
								image = tutorial_drums_highway_ghost
								time_shown = 1
							}
						]
					}
			...
			}
			{
				...
				pages = [
					...
					}
					{
						...
						time_shown = 6
						text = qs(0xa31dfac6)
						audio_stream = 'Tut_Vcl1_L05_07a'
						images = [
							{
								image = tutorial_vocals_double_tap_1
								time_shown = 1
								Scale = 1.0
							}
							{
								image = tutorial_vocals_double_tap_2
								time_shown = 0.2
								Scale = 1.0
							}
							{
