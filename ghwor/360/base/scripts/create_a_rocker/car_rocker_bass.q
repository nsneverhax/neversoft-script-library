cas_bass_body = [
		...
		cap_textures = [
			{
				...
				material = bass1_nvsft_elephant_body_primary
				preset_layers = [
					{
						$preset_layer_finishes
						mask = $cab_esp_ax_finishes
	...
	}
	{
		...
		sponsor_id = schecter
		mesh = `models\car_instruments\bass\schecter\bass276_sch_riot`
		pak_num = 0
		cap_textures = [
			{
				base_tex = `tex\models\car_instruments\bass\schecter\bass276_sch_riot_d`
				material = bass276_sch_riot_primary
				preset_layers = [
					{
						$preset_layer_finishes
						mask = $cab_sch_riot_finishes
					}
					{
						$preset_layer_fades
						mask = $cab_sch_riot_fades
					}
					{
						$preset_layer_details
						mask = $cab_sch_riot_details
					}
				]
...
cas_bass_neck = [
				...
				preset_layers = [
					{
						...
						$car_rocker_bass_factoredglobal_20
					}
				]
			}
		]
	...
	{
		desc_id = bass_fretboard_ibanez
		frontend_desc = qs(0xc0a291ea)
		mesh = `models/car_instruments/bass/ibanez/bass_fretboard_ibanez`
		cap_textures = [
			{
				base_tex = `tex/models/car_instruments/bass/esp/bass_fretboard_24_d`
				material = bass_fretboard_ibanez_primary
				preset_layers = [
					{
						$preset_layer_finishes
						mask = $cab_ibz_fboard_inlays_24fret
	...
	{
		desc_id = bass_fretboard_ibanezb
		frontend_desc = qs(0xa81d6c13)
		mesh = `models/car_instruments/bass/ibanez/bass_fretboard_ibanezb`
		cap_textures = [
			{
				base_tex = `tex/models/car_instruments/bass/esp/bass_fretboard_24_d_02`
				material = bass_fretboard_ibanezb_primary
				preset_layers = [
					{
						$preset_layer_finishes
						mask = $cab_ibz_fboard_inlays_24fret
	...
	{
		desc_id = bass_fretboard_ibanezc
		frontend_desc = qs(0x21ad5ed2)
		mesh = `models/car_instruments/bass/ibanez/bass_fretboard_ibanezc`
		cap_textures = [
			{
				base_tex = `tex/models/car_instruments/bass/esp/bass_fretboard_24_d_03`
				material = bass_fretboard_ibanezc_primary
				preset_layers = [
					{
						$preset_layer_finishes
						mask = $cab_ibz_fboard_inlays_24fret
	...
	}
	{
		...
		frontend_desc = qs(0x8bbb0e9c)
		mesh = `models/car_instruments/bass/ibanez/bass_fretboard_ibanezd`
		cap_textures = [
			{
				base_tex = `tex/models/car_instruments/bass/esp/bass_fretboard_24_d_04`
				material = bass_fretboard_ibanezd_primary
				preset_layers = [
					{
						$preset_layer_finishes
						mask = $cab_ibz_fboard_inlays_24fret
		...
		cap_textures = [
			{
				...
				material = bass_schect_030pga_primary
				preset_layers = [
					{
						$preset_layer_finishes
						mask = $bass_schect_030pga
					}
				]
			}
		]
		...
		cap_textures = [
			{
				...
				material = bass_mm_bng_pgard_primary
				preset_layers = [
					{
						$preset_layer_finishes
						mask = $bass_mm_bng_pgard
					}
				]
			}
		]
...
cas_bass_pickups = [
	{
		...
		$car_rocker_bass_factoredglobal_23
	}
	{
...
cas_bass_bridges = [
			...
			placements = [
				{
					...
					meshes = [
						{
							mesh = `models/car_instruments/bass/gh5/bridges/bas_brdg_ibz01`
							attach_indices = [
								1
							]
						}
	...
	}
	{
		...
		frontend_desc = qs(0x1d1bf7de)
		bass_string_start = bass_bridge_monoii_str_start_properties
		bass_string_end = default_bass_string_end_properties
		materials = [
			...
			placements = [
				{
					...
					meshes = [
						{
							mesh = `models/car_instruments/bass/gh5/bridges/bass_bridge_monoii`
							attach_indices = [
								1
							]
						}
	...
	}
	{
		...
		frontend_desc = qs(0xd5066052)
		bass_string_start = bs141_nsftbridge_str_start_properties
		bass_string_end = default_bass_string_end_properties
		materials = [
	...
	}
	{
		...
		bass_string_start = bass1e_brdg_4str_start_properties
		node_meshes = {
			$bass_bridges_nodes
			placements = [
				{
	...
	}
	{
		...
		bass_string_start = bas143_bridge_4str_start_properties
		node_meshes = {
			$bass_bridges_nodes
			placements = [
				{
...
cas_bass_head = [
		...
		cap_textures = [
			{
				...
				preset_layers = [
					{
						$preset_layer_finishes
						mask = $bass_mm_neckhead_sr1_finishes
					}
					{
						$preset_layer_fades
						mask = $bass_mm_neckhead_sr1_fades
					}
					{
						$preset_layer_details
						mask = $bass_mm_neckhead_sr1_details
					}
				]
				user_layer_settings = {
					diffuse
		...
		cap_textures = [
			{
				...
				$car_rocker_bass_factoredglobal_91
			}
		]
	}
	{
		...
		cap_textures = [
			{
				...
				$car_rocker_bass_factoredglobal_92
			}
		]
	}
	{
		...
		cap_textures = [
			{
				...
				$car_rocker_bass_factoredglobal_93
			}
		]
	}
	{
		...
		cap_textures = [
			{
				...
				$car_rocker_bass_factoredglobal_94
			}
		]
	}
	{
		...
		cap_textures = [
			{
				...
				$car_rocker_bass_factoredglobal_95
			}
		]
	}
	{
	...
	}
	{
		...
		sponsor_id = schecter
		mesh = `models/car_instruments/bass/schecter/bas276_nkhd_sch_riot`
		materials = [
		...
		cap_textures = [
			{
				...
				material = bas276_nkhd_sch_riot_primary
				preset_layers = [
					{
						$preset_layer_finishes
						mask = $cab_sch_nkhd_riot_finishes
					}
					{
						$preset_layer_details
						mask = $cab_sch_nkhd_riot_details
					}
					{
						$preset_layer_fades
						mask = $cab_sch_nkhd_riot_fades
					}
				]
				user_layer_settings = {
					diffuse
	...
	{
		desc_id = bas276_nkhd_sch_t_01
		frontend_desc = qs(0x0d5ce85d)
		sponsor_id = schecter
		mesh = `models/car_instruments/bass/schecter/bas276_nkhd_sch_t_01`
		materials = [
	...
	{
		desc_id = bas276_nkhd_sch_t_02
		frontend_desc = qs(0x4cd98283)
		sponsor_id = schecter
		mesh = `models/car_instruments/bass/schecter/bas276_nkhd_sch_t_02`
		materials = [
	...
	{
		desc_id = bas276_nkhd_sch_t_03
		frontend_desc = qs(0xe8141a8f)
		sponsor_id = schecter
		mesh = `models/car_instruments/bass/schecter/bas276_nkhd_sch_t_03`
		materials = [
