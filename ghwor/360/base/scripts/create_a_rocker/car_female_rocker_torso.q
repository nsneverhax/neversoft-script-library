cas_female_torso = [
	...
	}
	{
		...
		frontend_desc = qs(0xd8e6b51e)
		mesh = `models/car/female/f_punk_torso_judywing`
		materials = [
	...
	}
	{
		...
		mesh = `models/car/female/f_fun_torso_band`
		materials = [
	...
	}
	{
		...
		frontend_desc = qs(0xe3c3a838)
		mesh = `models/car/female/f_pandband01_torso`
		genre = [
			goth
		]
		random_weight = 1.0
	...
	}
	{
		...
		frontend_desc = qs(0x5c08a2a6)
		mesh = `models/car/female/f_pandband02_torso`
		genre = [
			goth
		]
		random_weight = 1.0
