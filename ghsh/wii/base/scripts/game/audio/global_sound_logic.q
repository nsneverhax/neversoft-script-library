...
0x518674cc = [
	{
		Stream = 'OTHER\\MENMUSIC\\MENUMUSIC_BARKATTHEMOON'
	}
	{
		Stream = 'OTHER\\MENMUSIC\\MENUMUSIC_ILOVEROCKANDROLL'
	}
	{
		Stream = 'OTHER\\MENMUSIC\\MENUMUSIC_MONKEYWRENCH'
	}
	{
		Stream = 'OTHER\\MENMUSIC\\MENUMUSIC_SHOUTATTHEDEVIL'
	}
	{
		Stream = 'OTHER\\MENMUSIC\\MENUMUSIC_SMOKEONTHEWATER'
	}
	{
		Stream = 'OTHER\\MENMUSIC\\MENUMUSIC_THEMBONES'
	}
	{
		Stream = 'OTHER\\MENMUSIC\\MENUMUSIC_TRIPPINONAHOLE'
	}
	{
		Stream = 'OTHER\\MENMUSIC\\MENUMUSIC_WOMAN'
	}
]
...
script menu_music_on_spawned 
	...
	printf \{qs(0x159912af)}
	Menu_music_Checking
	printf \{qs(0x75898c39)}
...
script 0xe68e695e 
	if NOT ($0x03113174 = None)
		stopsound unique_id = ($0x03113174)
		Change \{0x03113174 = None}
	endif
	GetPakManCurrent \{map = zones}
	switch <pak>
		case z_canyon
		<0x8ff92870> = 'Other\\Intro\\canyon_intro'
		case z_greatwall
		<0x8ff92870> = 'Other\\Intro\\greatwall_intro'
		case z_london
		<0x8ff92870> = 'Other\\Intro\\london_intro'
		case z_atlantis
		<0x8ff92870> = 'Other\\Intro\\atlantis_intro'
		case z_icecap
		<0x8ff92870> = 'Other\\Intro\\icecap_intro'
		case z_quebec
		<0x8ff92870> = 'Other\\Intro\\quebec_intro'
		case z_sphinx
		<0x8ff92870> = 'Other\\Intro\\Sphinx_Intro'
		case z_amazon
		<0x8ff92870> = 'Other\\Intro\\Amazon_Intro'
		default
		return
	endswitch
	0x810401fe FileName = <0x8ff92870>
	Change 0x03113174 = <unique_id>
	begin
	printf \{qs(0xcc6fdf4f)}
...
script GH_SFX_Intro_WarmUp 
	...
	switch <pak>
		...
		default
		printf \{qs(0x1dd15dfc)}
		SpawnScriptNow \{metalfest_intro}
		SoundEvent \{event = z_harbor_intro}
	endswitch
	if NOT ($0x03113174 = None)
		StartPreLoadedStream \{$0x03113174
			buss = Encore_Events
			vol = -5}
		Change \{0x03113174 = None}
	endif
...
script Guitar_Wrong_Note_Sound_Logic \{vol = 0.0
	...
	PlaySound <soundasset> vol = <vol> pitch = <pitch> buss = <newbuss> pan1x = <pan1x> pan1y = <pan1y> pan2x = <pan2x> pan2y = <pan2y> Priority = 90 panremovecenter = true controllers = {controller1 = ($<player_status>.controller)}
...
menu_music_songs = [
	{
		Stream = menumusic_barkatthemoon
		array = barkatthemoon_menumusic_fretbars
		delay = 10
		vol = -50
		offset = 0
	}
	{
		Stream = menumusic_monkeywrench
		array = monkeywrench_menumusic_fretbars
		delay = 10
		vol = -50
		offset = 0
	}
	{
		Stream = menumusic_thembones
		array = thembones_menumusic_fretbars
		delay = 10
		vol = -50
		offset = 0
	}
	{
		Stream = menumusic_trippinonahole
		array = trippinonahole_menumusic_fretbars
		delay = 10
		vol = -50
		offset = 0
	}
	{
		Stream = menumusic_shoutatthedevil
		array = shoutatthedevil_menumusic_fretbars
		delay = 10
		vol = -50
		offset = 0
	}
	...
	{
		Stream = menumusic_smokeonthewater
		array = smokeonthewater_menumusic_fretbars
		delay = 10
		vol = -50
		offset = 0
	}
	{
		Stream = menumusic_iloverockandroll
		array = iloverockandroll_menumusic_fretbars
		delay = 10
		vol = -50
		offset = 0
	}
...
script ghtunes_ui_scroll_pan 
	...
	PlaySound ghtunes_menu_scroll pitch = 4 vol = 0 pan1x = ((<sfx_pan>) / 10.0)
endscript
...
script 0xa5c86b1c 
	0xc3f98ff7 \{Sound = UI_Sound_05}
	0xc3f98ff7 \{Sound = UI_Sound_09}
	0xc3f98ff7 \{Sound = song_affirmation_01}
	0xc3f98ff7 \{Sound = song_affirmation_02}
	0xc3f98ff7 \{Sound = song_affirmation_03}
	0xc3f98ff7 \{Sound = song_affirmation_04}
	0xc3f98ff7 \{Sound = song_affirmation_05}
	0xc3f98ff7 \{Sound = song_affirmation_06}
endscript

script 0x28cda512 
	printf \{qs(0x3efe67ef)}
	0xa5c86b1c
	StopAllSounds
endscript
