...
script isacceptablestring 
	0x35098e65 string = <string>
	Block \{Type = 0x4d03e4e3}
	switch (<event_data>.Result)
		...
		return \{true
			0x4ed04773 = 0}
		case 2
		printf \{'Error return from DWC_CheckProfanity'}
		return \{FALSE
			0x4ed04773 = 1}
	endswitch
endscript
...
script dwc_checkprofanitycallback 
	broadcastevent Type = 0x4d03e4e3 data = {Result = <Result>}
endscript
