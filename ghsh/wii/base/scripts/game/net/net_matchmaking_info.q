...
script net_create_reservation_connection_entry 
	...
	if GotParam \{instrument}
		...
		<instrument_string> = qs(0xc4d5515e)
	endif
	formatText {
		TextName = display_string
		'Fin=%d HasConnH=%e Ready=%f Ret=%g TestConn=%h TestState=%i Instrument=%j'
		d = <finished>
		e = <has_conn_handle>
		f = <ready>
		g = <retrieved>
...
script net_integer_to_string 
	formatText TextName = display_string qs(0x76b3fda7) d = <int>
