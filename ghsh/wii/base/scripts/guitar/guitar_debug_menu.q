...
script create_snapshot_menu 
	...
	if GlobalExists Name = <snapshot_array>
		...
		formatText TextName = text_name qs(0x73307931) s = <snapshot_name>
...
script cameracut_ingame_menu_setprops 
	...
	if ((<DEPTH>) > 1)
		...
		formatText TextName = camname qs(0x3de987c4) s = <Camera_Name> i = (($cameracut_ingame_menu_index) + 1) m = <array_Size> DontAssertForChecksums
...
script create_dlcflags_debug_menu 
	...
	if (<flag_owned> = true)
		formatText TextName = text qs(0x05b2d669) t = <text>
	endif
	if (<flag_present> = true)
		formatText TextName = text qs(0xc8e8d8f7) t = <text>
	endif
	if (<flag_corrupt> = true)
		formatText TextName = text qs(0xa9079965) t = <text>
	endif
	CreateScreenElement {
		Type = TextElement
		parent = dlcflags_debug_vmenu
