...
script clean_up_user_control_helpers 
	...
	if ScreenElementExists \{id = 0x9190c095}
...
script add_user_control_helper \{z = 10
	...
	if GotParam \{gamertag}
		...
		0x0cb310ec = FALSE
		user_control_container :GetSingleTag \{0x0cb310ec}
		if (<0x0cb310ec> = FALSE)
			user_control_container :SetTags \{0x0cb310ec = true}
			<0x9b2729dd> = true
		endif
	...
	user_control_container :se_setprops {
		helper_pill_body_dims = (((1.0, 0.0) * <helper_pill_menu_dims> [0]) + (0.0, 55.0))
	}
