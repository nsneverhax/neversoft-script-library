...
script spawn_reject 
	...
	formatText TextName = reject_text (qs(0xce7ab243)) a = <nickname> b = ($reject_phrases_full [<phrase>])
...
script spawn_invite 
	...
	getfriendname index = <index>
	formatText TextName = friendname qs(0x76b3fda7) d = <nickname>
