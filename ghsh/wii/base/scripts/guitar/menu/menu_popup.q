...
script create_popup_warning_menu player_device = ($primary_controller) popup_event_handlers = ($popup_event_handlers_options) header_offset = (0.0, 0.0) dlg_z_priority = 500 parent = root_window
	...
	printf qs(0x77d0bf50) a = <popup_desc>
	create_popup_warning_text <...>
	if GotParam \{list}
		popupelement :SetProps \{popupbody_text = qs(0x00000000)
			0x03603375 = (0.0, 0.0)}
		popupelement :desc_resolvealias \{Name = alias_dlog_vmenu}
		<resolved_id> :se_setprops Pos = (0.0, -275.0)
	endif
	if GotParam \{options}
...
script create_popup_warning_menu_option 
	...
	printf qs(0x2be3d030) t = (<option>.text) d = <width>
	if (<width> > <0x7357ac68>)
		if (<width> > <0x6ba0818d>)
			printf \{qs(0x01fd1153)}
			<id> :se_setprops {
