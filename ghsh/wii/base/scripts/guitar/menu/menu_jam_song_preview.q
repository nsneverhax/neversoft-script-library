...
script 0x7f6aedfc 
	...
	Wait \{2
		Seconds}
	if ($ghtunes_preview_status = 0x0e800a67)
...
script create_song_preview_menu \{ghtunes = 0
	...
	WaitOneGameFrame
	if ScreenElementExists \{id = song_preview_element}
		song_preview_element :SetProps \{timer_text = qs(0x369c70d7)}
	endif
	Change \{ghtunes_preview_status = 0x0e800a67}
	...
	SpawnScriptNow 0x7f6aedfc params = {<...>}
...
script song_preview_save_song 
	KillSpawnedScript \{Name = 0x7f6aedfc}
...
script song_preview_update_playbar 
	...
	if (<sec_check> < 1)
		formatText TextName = song_time_text qs(0x7994144d) a = <minutes> b = <Seconds>
	else
		formatText TextName = song_time_text qs(0xc6203caa) a = <minutes> b = <Seconds>
	endif
