...
script ui_gig_cash_summary_assign_strips_data 
	...
	formatText TextName = gig_cash_txt qs(0xcb2f9062) d = ($ui_gig_summary_gig_totals [(<Player> -1)])
	formatText TextName = car_earnings_txt qs(0xcb2f9062) d = <career_earnings>
