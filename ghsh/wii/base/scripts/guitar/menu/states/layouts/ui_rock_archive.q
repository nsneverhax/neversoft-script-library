...
script 0xe52f77ea \{0x668c8182 = 0}
	...
	0xb8cfb312
	if (<0x88333d3f> = 1)
		formatText TextName = wii_blocks qs(0x2c8d1333) d = <0x88333d3f> b = (qs(0x5746a2ee))
	else
		formatText TextName = wii_blocks qs(0x2c8d1333) d = <0x88333d3f> b = (qs(0x85ca8f41))
	endif
	...
	if GotParam \{error}
		...
		0x63f397f9
		if (<0xefba12f3> = 1)
			formatText TextName = sd_blocks qs(0x2c8d1333) d = <0xefba12f3> b = (qs(0x5746a2ee))
		else
			formatText TextName = sd_blocks qs(0x2c8d1333) d = <0xefba12f3> b = (qs(0x85ca8f41))
		endif
