...
script jam_ratesong_menu 
	...
	if (<Mod> = 0)
		formatText TextName = rating_text qs(0x11830420) a = (<current_rating> / 2) DecimalPlaces = 0
	else
		<decimal_rating> = (<current_rating> / 2.0)
		formatText TextName = rating_text qs(0x11830420) a = <decimal_rating> DecimalPlaces = 1
	endif
	getsonginfo
