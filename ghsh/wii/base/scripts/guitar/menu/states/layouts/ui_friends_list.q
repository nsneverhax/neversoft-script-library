...
script set_friends_helper_text 
	...
	plat_helper_strings = net_helper_text_strings
...
script invite_to_game 
	RequireParams \{[
		...
		all}
	invite_title = qs(0x65341245)
	base_msg = qs(0xc521125b)
	switch (<instrument>)
		case guitar
		formatText TextName = invite_msg qs(0xb907f2ca) s = <base_msg> i = qs(0xbaa820f9)
		case drum
		formatText TextName = invite_msg qs(0xb907f2ca) s = <base_msg> i = qs(0x67a46594)
		case mic
		formatText TextName = invite_msg qs(0xb907f2ca) s = <base_msg> i = qs(0x252af8f9)
	endswitch
	userlist = [
		{
			Name = <Name>
