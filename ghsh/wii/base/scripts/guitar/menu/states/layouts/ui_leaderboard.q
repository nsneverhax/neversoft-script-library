...
script ui_create_leaderboard 
	...
	if leaderboardinterface :desc_resolvealias \{Name = alias_menu}
		...
		CreateScreenElement \{parent = current_menu
			...
			autosizedims = FALSE
			dims = (0.0, 320.0)}
		current_menu :SetTags leaderboard_head = <id>
		...
		<id> :se_setprops highlight_bars_alpha = 0.0 setlist_b_list_hilite_r_alpha = 0.25
...
script ui_leaderboard_item_focus \{time = 0.1}
	...
	se_setprops bg_rgba = <bg_rgba> highlight_bars_alpha = 0.6 setlist_b_list_hilite_r_alpha = 0.6
	<ratio> = (<index> * (230.0 / 9))
	Pos = ((0.0, 1.0) * (<ratio> - 115))
	printf qs(0x6edf4a99) a = <index>
	0x2108dfbc index = <index>
...
script ui_leaderboard_item_unfocus 
	...
	i = (<i> + 1)
	repeat ($current_num_players)
	se_setprops bg_rgba = <bg_rgba> highlight_bars_alpha = 0.0 setlist_b_list_hilite_r_alpha = 0.25
endscript
		...
		if ($current_leaderboard_instrument = Band)
			if <current_id> :desc_resolvealias Name = alias_difficulty_container
				if GetScreenElementChildren id = <resolved_id>
					...
					ui_leaderboard_get_difficulty_icon num = (<leaderboard_data> [<i>].data [(<j> + 2)])
			...
			if ($current_leaderboard_instrument = Band)
				if <current_id> :desc_resolvealias Name = alias_difficulty_container
					if GetScreenElementChildren id = <resolved_id>
						...
						RemoveParameter \{difficulty_icon}
						RemoveParameter \{difficulty_alpha}
						ui_leaderboard_get_difficulty_icon \{num = qs(0x3bf547a6)}
						difficulty_alpha = 0
						child_id = (<children> [<j>])
						<child_id> :se_setprops {
							texture = <difficulty_icon>
...
script ui_leaderboard_get_difficulty_icon \{num = qs(0x3bf547a6)}
...
script 0x2108dfbc 
	current_menu :GetSingleTag \{menu_items}
	current_menu :GetSingleTag \{title_id}
	current_menu :GetSingleTag \{header_id}
	if ScreenElementExists \{id = current_menu}
		if GotParam \{index}
			switch <index>
				case 0
				...
				0x21421165 = (<menu_items> [0])
				<0x21421165> :se_setprops {
					alpha = 1
				}
				case 4
				0xb7d5034f = (<menu_items> [0])
				<0xb7d5034f> :se_setprops {
					alpha = 0
				}
				0x21421165 = (<menu_items> [1])
				<0x21421165> :se_setprops {
					alpha = 1
				}
				case 5
				0xb7d5034f = (<menu_items> [1])
				<0xb7d5034f> :se_setprops {
					alpha = 0
				}
				0x21421165 = (<menu_items> [2])
				<0x21421165> :se_setprops {
					alpha = 1
				}
				case 6
				0xb7d5034f = (<menu_items> [2])
				<0xb7d5034f> :se_setprops {
					alpha = 0
				}
				0x21421165 = (<menu_items> [3])
				<0x21421165> :se_setprops {
					alpha = 1
				}
				case 7
				0xb7d5034f = (<menu_items> [3])
				<0xb7d5034f> :se_setprops {
					alpha = 0
				}
				0x21421165 = (<menu_items> [4])
				<0x21421165> :se_setprops {
					alpha = 1
				}
				case 8
				0xb7d5034f = (<menu_items> [4])
				<0xb7d5034f> :se_setprops {
					alpha = 0
				}
				0x21421165 = (<menu_items> [5])
				<0x21421165> :se_setprops {
					alpha = 1
				}
				case 9
				0xb7d5034f = (<menu_items> [5])
				<0xb7d5034f> :se_setprops {
					alpha = 0
				}
			endswitch
...
script 0x485f3d66 
	...
	current_menu :GetSingleTag \{title_id}
	current_menu :GetSingleTag \{header_id}
	if ScreenElementExists id = <title_id>
		<title_id> :se_setprops {
			0x9a88c5e7 = 1
			0x36990186 = 1
			0x91db6e8e = 1
	...
	if ScreenElementExists id = <header_id>
		<header_id> :se_setprops {
			alpha = 1
		}
	endif
	i = 0
	begin
	if ScreenElementExists id = (<menu_items> [<i>])
		(<menu_items> [<i>]) :se_setprops {
			alpha = 1
		}
	endif
	<i> = (<i> + 1)
