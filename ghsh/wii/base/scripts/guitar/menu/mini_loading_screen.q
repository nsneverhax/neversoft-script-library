...
script 0x628ef00f 
	...
	WaitOneGameFrame
	printf 'waiting for mini loading screen (show: %a, hide: %b)' a = ($0x562e2f96.0xd777153f) b = ($0x562e2f96.0x41e00715)
	repeat
endscript
...
script 0xd1b27ca2 
	se_setprops alpha = 1.2 time = ($0x562e2f96.background.fade_in_time)
	se_waitprops
	Change structurename = 0x562e2f96 0xd777153f = ($0x562e2f96.0xd777153f + 1)
	Wait ($0x562e2f96.0xbf23998d) Seconds
	Change structurename = 0x562e2f96 0xd777153f = ($0x562e2f96.0xd777153f - 1)
...
script 0x36d6b169 
	...
	se_setprops alpha = 1.2 time = ($0x562e2f96.text.fade_in_time)
	se_waitprops
...
script 0x90f5699a 
	...
	animate_watch_timer
	se_setprops alpha = 1.2 time = ($0x562e2f96.watch_timer.fade_in_time)
	se_waitprops
	Change structurename = 0x562e2f96 0xd777153f = ($0x562e2f96.0xd777153f + 1)
	Wait ($0x562e2f96.0xbf23998d) Seconds
	Change structurename = 0x562e2f96 0xd777153f = ($0x562e2f96.0xd777153f - 1)
...
script 0x967039b8 
	...
	se_setprops alpha = 1.2 time = ($0x562e2f96.message.fade_in_time)
	se_waitprops
	Change structurename = 0x562e2f96 0xd777153f = ($0x562e2f96.0xd777153f + 1)
	Wait ($0x562e2f96.0xbf23998d) Seconds
	Change structurename = 0x562e2f96 0xd777153f = ($0x562e2f96.0xd777153f - 1)
...
script 0x04285d75 \{time = 1.0}
	printf \{'push mini loading screen'}
	0x10b35a47
	printf \{'and wait for it'}
	0x628ef00f
	printf \{'do something that takes a while'}
	Wait <time> Seconds
	printf \{'pop mini loading screen'}
	0xdf9f604d
	printf \{'and wait for it'}
	0x628ef00f
	printf \{'test done'}
