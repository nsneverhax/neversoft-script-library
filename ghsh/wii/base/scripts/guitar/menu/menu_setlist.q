...
script setlist_songpreview_monitor 
	...
	songstoppreview
	begin
	if ($current_setlist_songpreview = jamsession || $target_setlist_songpreview = jamsession)
	...
	if NOT ($current_setlist_songpreview = $target_setlist_songpreview)
		...
		if ($target_setlist_songpreview != <song> || $target_setlist_songpreview = None)
			...
			if NOT songplaypreview FileName = <song_prefix> 0x86586519 = <0x86586519>
				if (<0x86586519> = 1)
					DownloadContentLost
				else
