...
wii_dwc_error_noconnect_gamespy_text = qs(0xa7e69f2b)
...
script 0x54c5997a 
	...
	if ScriptIsRunning \{friendlist_confirm_invite_friend}
		KillSpawnedScript \{Name = friendlist_confirm_invite_friend}
	endif
	if ScriptIsRunning \{ui_band_mode_friends_match}
		KillSpawnedScript \{Name = ui_band_mode_friends_match}
	endif
	if ScriptIsRunning \{start_invite_matchmaking}
		KillSpawnedScript \{Name = start_invite_matchmaking}
	endif
...
script 0x5745e12c 
	...
	KillSpawnedScript \{Name = 0xb7f5cc17}
	SpawnScriptNow \{0xe79b8b2b}
	create_generic_popup \{title = qs(0xf2f5ef0e)
		loading_window
