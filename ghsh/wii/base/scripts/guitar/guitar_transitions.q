...
celeb_intro_transitions = [
	{
		...
		debug_preview_in_venue = load_z_amazon
	}
	{
...
0xe7feff07 = {
	careerintro = 'Other\\Intro\\ecstacyofgold'
	intro_lemmy = 'Other\\Intro\\intro_lemmy'
	intro_kingdiamond = 'Other\\Intro\\intro_kingdiamond'
	0x74acb84c = 'Other\\Encore\\z_donnington_encore'
	0xdeac5429 = 'Other\\Encore\\z_forum_encore'
	0xce0d58ee = 'Other\\Encore\\z_icecave_encore'
	0x37e6daac = 'Other\\Encore\\z_justice_encore'
	0x15b59195 = 'Other\\Encore\\z_meadowlands_encore'
	0x4bedbd0a = 'Other\\Encore\\z_mop_encore'
	0xe8e0400b = 'Other\\Encore\\z_stone_encore'
	0x5eac1ed3 = 'Other\\Encore\\z_tushino_encore'
	0xd60aa96b = 'Other\\Encore\\z_sphinx_encore'
	0x8b15c515 = 'Other\\Encore\\z_london_encore'
	0xf33e5f31 = 'Other\\Encore\\z_icecap_encore'
	0x6ce99340 = 'Other\\Encore\\z_greatwall_encore'
	0x9704c966 = 'Other\\Encore\\z_canyon_encore'
	0x8a9d7e69 = 'Other\\Encore\\z_amazon_encore'
...
metallica_intro_slomo_clip = {
	...
	startnodes = {
		vocalist = 'Career_Intro'
		GUITARIST = 'Career_Intro'
		BASSIST = 'Career_Intro'
		drummer = 'Career_Intro'
	}
	arms = {
		vocalist = {
			ik_targetl = slave
...
script 0x65f34a77 
	...
	Wait \{12
		Seconds}
	SafeKill \{nodeName = z_forum_js_walkway_pipes_intro}
	SafeCreate \{nodeName = 0xca28549f}
endscript
...
script Transition_Play_Spawned \{time_offset = -1}
...
script Transition_Play_Iterator 
	...
	if ScriptExists ($<Transition_Props>.ScriptTable [<array_count>].Scr)
		SpawnScriptNow ($<Transition_Props>.ScriptTable [<array_count>].Scr) id = transitions params = {transition_time = <transition_time> ($<Transition_Props>.ScriptTable [<array_count>].params) time_offset = (0 - <time_offset>)}
	endif
...
script finalbandintro_transitionsetup 
	...
	0x810401fe FileName = ($0xe7feff07.intro_finalgig)
...
script common_finalbandoutro_transitionsetup 
	...
	0x810401fe FileName = ($0xe7feff07.encore_finalgig)
	Change celeb_intro_stream_id = <unique_id>
	begin
...
script preload_celeb_intro_stream 
	...
	if StructureContains structure = ($0xe7feff07) <celeb_intro_checksum>
		0x810401fe FileName = ($0xe7feff07.<celeb_intro_checksum>)
		Change celeb_intro_stream_id = <unique_id>
		begin
...
script 0x7dd62285 
	printf qs(0x62f0813e) d = <time_offset>
	begin
	GetSongTimeMs
	if (<time> >= <time_offset>)
		return
...
script 0x0499d8db 
	0x7dd62285 time_offset = (<time_offset> + ($0x5a01213a))
	StartPreLoadedStream ($celeb_intro_stream_id) buss = Encore_Events forcesafepreload = 1 pitch = 100
	Change 0xc5b024f4 = ($celeb_intro_stream_id)
	Change \{celeb_intro_stream_id = None}
endscript

script start_preloaded_celeb_intro_stream 
	printf \{qs(0x79e771b1)}
	...
	printf \{channel = sfx
		qs(0x9ff5df66)}
	if NOT ($celeb_intro_stream_id = None)
		StartPreLoadedStream 0x8a68ab90 = ($celeb_intro_stream_id) buss = Encore_Events forcesafepreload = 1 pitch = 100
		Change \{celeb_intro_stream_id = None}
	endif
endscript

script 0x11918493 
	KillSpawnedScript \{Name = 0x0499d8db}
	KillSpawnedScript \{Name = 0x2d7f6343}
endscript
...
script preload_encore_event_stream 
	...
	if StructureContains structure = ($0xe7feff07) <encore_stream_name>
		0x810401fe FileName = ($0xe7feff07.<encore_stream_name>)
