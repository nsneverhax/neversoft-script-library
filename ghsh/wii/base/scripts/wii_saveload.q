...
script wii_goto_system_menu 
	resettoipl \{menu = 0x9a96ac71}
endscript

script 0x2037c5cb 
	resettoipl \{menu = wii_data_management}
endscript
...
script open_insufficient_space_dialog 
	destroy_generic_popup
	formatText TextName = message_text (qs(0x779b731d)) d = (<fsblocks>)
