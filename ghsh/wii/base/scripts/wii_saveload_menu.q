wii_trc_menu_font = fontgrid_bordello
...
script get_string_wii \{message = unknown}
	...
	switch <message>
		...
		case no_save_boot
		localized_string = qs(0x1d0bc19e)
		case no_save_ingame
		localized_string = qs(0x31642eed)
		case save_failed
		...
		localized_string = qs(0xc4d5515e)
	endswitch
