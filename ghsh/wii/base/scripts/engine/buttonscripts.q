...
script show_spoofed_velocity 
	...
	formatText TextName = spoof_text qs(0x73307931) s = <spoofs>
	formatText TextName = hit_text qs(0x73307931) s = <hits>
	formatText TextName = percent_text qs(0x73307931) s = <errors>
...
script userselectdown 
	GUITARIST :Unpause
	GUITARIST :hero_play_anim \{anim = GH3_Guit_Axel_A_Slw_Idle1}
endscript
