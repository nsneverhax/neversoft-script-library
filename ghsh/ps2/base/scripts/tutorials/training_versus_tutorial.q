...
script training_7_4_start_tilt_task 
	...
	training_add_lesson_body_text \{number = qs(0x22ee76e7)
		text = qs(0x413e9e92)}
	training_show_lesson_header
	training_set_task_header_body \{text = qs(0x82ba1605)}
	training_show_task_header
	Wait \{2
		Seconds
		ignoreslomo}
