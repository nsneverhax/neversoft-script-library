...
script get_string_ps2 \{message = unknown}
	...
	switch <message>
		...
		case no_save_boot
		format_string = qs(0x9eb61346)
		case no_save_ingame
		format_string = qs(0x73eb0257)
		case save_failed
		...
		format_string = qs(0x03ac90f0)
	endswitch
	memcard = qs(0x77f10427)
	0xc309dd07 = qs(0x3a7c6072)
	0x979e36a1 = <memcard>
	0x80d82aa7 \{progress}
	formatText TextName = 0x08b6f45c qs(0xadbf9f62) d = <SpaceRequired>
	formatText TextName = localized_string <format_string> 0xc309dd07 = <0xc309dd07> memcard = <memcard> 0x979e36a1 = <0x979e36a1> 0x08b6f45c = <0x08b6f45c>
