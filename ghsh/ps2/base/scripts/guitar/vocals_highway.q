...
vocal_lyric_font_scale = (0.51, 0.61)
vocal_lyric_font_offset = (0.0, -51.0)
...
script vocals_highway_slide_in 
	...
	if ScreenElementExists id = <vocals_highway_id>
		...
		if ScreenElementExists id = <root>
			...
			<root> :se_setprops alpha = 0.5 motion = ease_out time = 0.5
		endif
		<vocals_highway_id> :se_setprops alpha = 1.0 time = 0 unhide
	endif
