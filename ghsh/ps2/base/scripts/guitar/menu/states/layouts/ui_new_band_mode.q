...
script 0x1860d142 
	...
	if GotParam \{0xb66264f5}
		...
		formatText TextName = 0xde013e37 qs(0x8c5c152d) n = <menu_name>
		if (<0xde013e37> = qs(0x50666691))
			text_scale = 0.48000002
		endif
		i = 0
		begin
...
script 0x7b218542 
	...
	if display_character_logic profile_struct = <profile_struct> savegame = 0 part = <part> bandplay 0x2f8e5ba4
		if NOT (<profile_struct>.Name = Johnny && <0x59f68d94> = 1)
			Range = (<Range> + 1)
