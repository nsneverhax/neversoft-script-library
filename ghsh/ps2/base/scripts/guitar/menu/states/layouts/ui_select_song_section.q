...
script 0x05924e09 \{extras = 0
		...
		fade = 0.0}
	if (<extras> = 1)
		0x0ae7615f buss = user_leadvox 0xc7b45f0a = <0xc7b45f0a>
		0x0ae7615f buss = user_drums 0xc7b45f0a = <0xc7b45f0a>
		0x0ae7615f buss = user_leadgtr 0xc7b45f0a = <0xc7b45f0a>
		0x0ae7615f buss = user_rhythmgtr 0xc7b45f0a = <0xc7b45f0a>
		0x0ae7615f buss = user_bass 0xc7b45f0a = <0xc7b45f0a>
		0x0ae7615f buss = user_crowdsingalong 0xc7b45f0a = <0xc7b45f0a>
		0x0ae7615f buss = User_Band 0xc7b45f0a = <0xc7b45f0a>
	else
		0x0ae7615f buss = user_leadvox 0xc7b45f0a = <0xc7b45f0a>
		0x0ae7615f buss = user_drums 0xc7b45f0a = <0xc7b45f0a>
		0x0ae7615f buss = user_leadgtr 0xc7b45f0a = <0xc7b45f0a>
		0x0ae7615f buss = user_rhythmgtr 0xc7b45f0a = <0xc7b45f0a>
		0x0ae7615f buss = user_bass 0xc7b45f0a = <0xc7b45f0a>
		0x0ae7615f buss = user_crowd 0xc7b45f0a = <0xc7b45f0a>
		0x0ae7615f buss = user_crowdsingalong 0xc7b45f0a = <0xc7b45f0a>
		0x0ae7615f buss = User_Band 0xc7b45f0a = <0xc7b45f0a>
	endif
endscript
...
script practice_songpreview_monitor 
	...
	if NOT ($current_practice_songpreview = $target_practice_songpreview &&
		...
		if ($shutdown_game_for_signin_change_flag = 0 && $0x4026c71d = 0)
			...
			if ($current_practice_songpreview_starttime = $target_practice_songpreview_starttime)
				Change target_practice_songpreview_starttime = <adjustedtime>
			endif
			Change current_practice_songpreview_starttime = <adjustedtime>
			...
			if ($current_practice_songpreview = $target_practice_songpreview &&
					$current_practice_songpreview_starttime = $target_practice_songpreview_starttime &&
					$force_practice_songpreview_restart = 0)
				0x05924e09 0xc7b45f0a = -9 fade = 1.0 extras = <extras>
				Wait \{2
					gameframe}

				0x05924e09 \{0xc7b45f0a = -9}
				begin_song \{0xb49e19e9 = 1}
				0x05924e09 \{0xc7b45f0a = -9}
				playing_song = 1
				if IsObjectScript
