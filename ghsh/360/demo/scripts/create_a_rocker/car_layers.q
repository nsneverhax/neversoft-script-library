...
car_sponsors = [
	...
	{
		pattern = 'tex/models/Characters/Skater_Male/Decals/CAG_sponsors_PRS.dds'
		frontend_desc = qs(0x3d73e7a4)
		$car_layers_factoredglobal_1
	}
	{
		pattern = 'tex/models/Characters/Skater_Male/Decals/CAG_sponsors_Schecter.dds'
		frontend_desc = qs(0xd6a9e0a0)
		$car_layers_factoredglobal_1
	}
]
car_male_makeup = [
