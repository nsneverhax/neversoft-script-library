...
script ui_create_cag_main 
	...
	elseif ((<instrument_info>.desc_id) = guitar)
		...
		add_generic_menu_text_item {
			...
			pad_choose_params = {state = uistate_cag_custom text = qs(0xb2219f15) instrument_info = <instrument_info> is_prs = 1 is_sch = 0}
		}
		add_generic_menu_text_item {
			text = qs(0x95bb0fca)
			pad_choose_script = ui_cag_main_check_category
			pad_choose_params = {state = uistate_cag_custom text = qs(0x95bb0fca) instrument_info = <instrument_info> is_prs = 0 is_sch = 1}
		}
		add_generic_menu_text_item {
			text = qs(0xc6bd9663)
			pad_choose_script = ui_cag_main_check_category
...
script cag_custom_update_current_category 
	...
	printf qs(0xa8b284d8) d = <category> channel = cag_debug
endscript
