...
script guitar_startup 
	...
	isgreatesthits
	if (<is_greatest_hits>)
		legalscreen_name = 'boot_legal_EU'
	...
	displayloadingscreen <legalscreen_name> spin_texture = 'load_wheel' spin_x = 394 spin_y = 527 localized
	getstarttime
