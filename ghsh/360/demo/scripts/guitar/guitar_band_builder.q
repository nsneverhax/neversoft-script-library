...
script band_builder_add_players 
	...
	if NOT (<part> = none)
		...
		printf \{qs(0x96dfa5a5)
			h = $game_mode}
		if ($game_mode = p1_quickplay)
			0xb68a35dd = (($0x4464785d) [0])
			printf qs(0x3edf6afc) a = <0xb68a35dd>
			character_id = <0xb68a35dd>
		endif
...
script 0x022bf91b 
	...
	if ($0x1d1c0985 = 1)
		...
		begin
		getplayerinfo <player> character_id
		printf qs(0x04a96d82) p = <num_players_shown>
		printf qs(0x785b587b) y = <character_id>
		0x694b7953 = (<0x694b7953> + <character_id>)
		<player> = (<player> + 1)
		repeat <num_players_shown>
		getarraysize <0x694b7953>
		i = 0
		i = 0
		getarraysize \{$0x85a9b6b5}
		begin
		0xb68a35dd = Random (@ casey @ judy @ midori @ pandora )
		printf qs(0xfef07cc7) p = <0xb68a35dd>
		if (<array_size> > 0)
			begin
			if ((arraycontains array = $0x85a9b6b5 contains = <0xb68a35dd>) || (arraycontains array = <0x694b7953> contains = <0xb68a35dd>))
				begin
				0xb68a35dd = Random (@ casey @ judy @ midori @ pandora )
				if NOT ((arraycontains array = $0x85a9b6b5 contains = <0xb68a35dd>) || (arraycontains array = <0x694b7953> contains = <0xb68a35dd>))
					break
				endif
				repeat 10
			endif
			repeat <array_size>
			printf qs(0x9bda5af5) p = <0xb68a35dd>
		endif
		setarrayelement arrayname = 0x85a9b6b5 globalarray index = <i> newvalue = <0xb68a35dd>
		printf qs(0x0c66c03e) p = <i>
		printf qs(0x364ae96c) p = (($0x85a9b6b5) [<i>])
		i = (<i> + 1)
		repeat <array_size>
		i = 0
		getarraysize \{$0x4464785d}
		begin
		0xb68a35dd = Random (@ axel @ izzy @ johnny @ lars @ clive @ eddie )
		printf qs(0xfef07cc7) p = <0xb68a35dd>
		if (<array_size> > 0)
			begin
			if ((arraycontains array = $0x4464785d contains = <0xb68a35dd>) || (arraycontains array = <0x694b7953> contains = <0xb68a35dd>))
				begin
				0xb68a35dd = Random (@ axel @ izzy @ johnny @ lars @ clive @ eddie )
				if NOT ((arraycontains array = $0x4464785d contains = <0xb68a35dd>) || (arraycontains array = <0x694b7953> contains = <0xb68a35dd>))
					break
				endif
				repeat 10
			endif
		...
		setarrayelement arrayname = 0x4464785d globalarray index = <i> newvalue = <0xb68a35dd>
		printf qs(0x0c66c03e) p = <i>
		printf qs(0x364ae96c) p = (($0x4464785d) [<i>])
		i = (<i> + 1)
		repeat <array_size>
	endif
endscript
...
script band_builder_add_cpu_characters 
	...
	if NOT band_builder_is_full
		if NOT band_builder_has_part \{part = drum}
			0xb68a35dd = (($0x4464785d) [1])
			printf qs(0x36db12d1) a = <0xb68a35dd>
			drummer = <0xb68a35dd>
			band_builder_add_member {
				part = drum
				real_part = drum
				character_id = <drummer>
			}
		...
		if NOT band_builder_has_part \{part = vocals}
			...
			if band_builder_get_cpu_singer_id
				switch <singer_id>
					...
					real_part = bass
				endswitch
				0xb68a35dd = (($0x4464785d) [2])
				printf qs(0x15a18b46) a = <0xb68a35dd>
				singer_id = <0xb68a35dd>
				band_builder_add_member {
					part = vocals
					real_part = <real_part>
					character_id = <singer_id>
	...
	if NOT band_builder_is_full
		if NOT band_builder_has_part \{part = bass}
			...
			0xb68a35dd = (($0x85a9b6b5) [0])
			printf qs(0x5ec72667) a = <0xb68a35dd>
			bassist_id = <0xb68a35dd>
			band_builder_add_member {
				part = bass
				real_part = bass
	...
	if NOT band_builder_is_full
		if NOT band_builder_has_part \{part = guitar}
			...
			0xb68a35dd = (($0x85a9b6b5) [1])
			printf qs(0x582fcb35) a = <0xb68a35dd>
			guitarist_id = <0xb68a35dd>
			band_builder_add_member {
				part = guitar
				real_part = guitar
