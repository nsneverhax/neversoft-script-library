...
cas_female_hair = [
	...
	}
	{
		...
		frontend_desc = qs(0x890bf047)
		mesh = 'models/CAR/Female/F_Folk_Hair_SPEgyptianHair.skin'
		$cas_female_hair_common_settings
		materials = [
			amviciousdreads_dreads
		]
		hat_hair = None
		acc_skeleton = skel_f_folk_hair_spegyptianhair
		acc_ragdoll = rag_f_folk_hair_spegyptianhair
		acc_bones = [
			bone_acc_head_01
			bone_acc_head_02
			bone_acc_head_03
	...
	}
	{
		...
		frontend_desc = qs(0x86d538d9)
		mesh = 'models/CAR/Female/F_Folk_Hair_LSBlackHair.skin'
		hat_hair = None
		acc_skeleton = skel_f_folk_hair_lsblackhair
		acc_ragdoll = rag_f_folk_hair_lsblackhair
		acc_bones = [
			bone_acc_head_01
			bone_acc_head_02
			bone_acc_head_03
	...
	}
	{
		...
		frontend_desc = qs(0x44854486)
		mesh = 'models/CAR/Female/F_Folk_Hair_AMDreads.skin'
		deform_mesh = 'models/CAR/Female/F_Folk_Hair_AMDreads_def.skin'
		$cas_female_hair_common_settings
		materials = [
			amviciousdreads_dreads
		]
		hat_hair = None
		acc_skeleton = skel_f_folk_hair_amviciousdreads
		acc_ragdoll = rag_f_folk_hair_amviciousdreads
		acc_bones = [
			bone_acc_head_01
			bone_acc_head_02
			bone_acc_head_03
	...
	}
	{
		...
		frontend_desc = qs(0x91477fb2)
		mesh = 'models/CAR/Female/F_Folk_Hair_ICSpikyHair.skin'
		$cas_female_hair_common_settings
		materials = [
			f_folk_hair_icspikyhairdo_icspikyhairdo
		]
		hat_hair = None
		acc_skeleton = skel_f_folk_hair_icspikyhair
		acc_ragdoll = rag_f_folk_hair_icspikyhair
		acc_bones = [
			bone_acc_head_01
			bone_acc_head_02
			bone_acc_head_03
	...
	}
	{
		...
		frontend_desc = qs(0xeed53d26)
		mesh = 'models/CAR/Female/F_Folk_Hair_GCNavajoHair.skin'
		hat_hair = None
		acc_skeleton = skel_f_folk_hair_gcnavajohair
		acc_ragdoll = rag_f_folk_hair_gcnavajohair
		acc_bones = [
			bone_acc_head_01
			bone_acc_head_02
			bone_acc_head_03
	...
	}
	{
		...
		frontend_desc = qs(0x0e82f0e9)
		mesh = 'models/CAR/Female/F_Folk_Hair_GWWithBow.skin'
		hat_hair = None
		acc_skeleton = skel_f_folk_hair_gwwithbow
		acc_ragdoll = rag_f_folk_hair_gwwithbow
		acc_bones = [
			bone_acc_head_01
			bone_acc_head_02
			bone_acc_head_03
...
cas_female_hat = [
	...
	}
	{
		...
		frontend_desc = qs(0x178a1a14)
		mesh = 'models/CAR/Female/F_Folk_Hat_AMBoarTusk.skin'
		deform_mesh = 'models/CAR/Female/F_Folk_Hat_AMBoarTusk_def.skin'
		materials = [
			amboartusk_hat
		]
		hat_hair = original_hair
	...
	}
	{
		...
		frontend_desc = qs(0x178a1a14)
		mesh = 'models/CAR/Female/F_Folk_ACC_SPEgyptianDiadem.skin'
		materials = [
			spegyptiandiadem_spegyptiandiadem
		]
		hat_hair = original_hair
		genre = [
			folk
	...
	}
	{
		...
		frontend_desc = qs(0xa62bd3ac)
		mesh = 'models/CAR/Female/F_Folk_ACC_ICEarMuffs.skin'
		materials = [
			spegyptiandiadem_spegyptiandiadem
		]
		hat_hair = original_hair
