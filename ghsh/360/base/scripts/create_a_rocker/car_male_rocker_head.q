...
cas_male_hair = [
	...
	{
		desc_id = m_folk_hair_lstailhair
		frontend_desc = qs(0x1d951c66)
		mesh = 'models/CAR/Male/M_Folk_Hair_LSTailHair.skin'
		materials = [
			lstailhair_primary
		]
		$cas_male_hair_common_settings
		hat_hair = m_folk_hair_lstailhair_hat
		acc_skeleton = skel_m_folk_hair_lstailhair
		acc_ragdoll = rag_m_folk_hair_lstailhair
		acc_bones = [
			bone_acc_head_01
			bone_acc_head_02
			bone_acc_head_03
	...
	}
	{
		...
		frontend_desc = qs(0x9ec31f28)
		mesh = 'models/CAR/Male/M_Folk_Hair_AMPonytaill.skin'
		materials = [
			m_amhair_hair_primary
		]
		$cas_male_hair_common_settings
		hat_hair = None
		acc_skeleton = skel_m_folk_hair_amponytail
		acc_ragdoll = rag_m_folk_hair_amponytail
		acc_bones = [
			bone_acc_head_01
			bone_acc_head_02
			bone_acc_head_03
	...
	}
	{
		...
		frontend_desc = qs(0x6bc44d25)
		mesh = 'models/CAR/Male/M_Folk_Hair_ICIcedHair.skin'
		materials = [
			m_folk_hair_icicedhair_icicedhair
		]
		$cas_male_hair_common_settings
		hat_hair = None
		acc_skeleton = skel_m_folk_hair_icicedhair
		acc_ragdoll = rag_m_folk_hair_icicedhair
		acc_bones = [
			bone_acc_head_01
			bone_acc_head_02
			bone_acc_head_03
	...
	{
		desc_id = folk_hair_navajoheadband
		frontend_desc = qs(0x64d264d7)
		mesh = 'models/CAR/Male/M_Folk_Hair_NavajoHeadBand.skin'
		material_groups = [
			{
				materials = [
					navajoheadband_navajohair
				]
				shader = $cas_shader_hair
			}
			{
				materials = [
					navajoheadband_headband
				]
			}
		]
		hat_hair = None
		acc_skeleton = skel_m_folk_hair_navajoheadband
		acc_ragdoll = rag_m_folk_hair_navajoheadband
		acc_bones = [
			bone_acc_head_01
			bone_acc_head_02
			bone_acc_head_03
	...
	}
	{
		...
		frontend_desc = qs(0xbc4188d8)
		mesh = 'models/CAR/Male/M_Folk_Hat_SPSphinxHat.skin'
		deform_mesh = 'models/CAR/Male/M_Folk_Hat_SPSphinxHat_def.skin'
		materials = [
			spsphinxhat_spsphinxhat
		]
		hat_hair = None
		acc_skeleton = skel_m_folk_hat_spsphinxhat
		acc_ragdoll = rag_m_folk_hat_spsphinxhat
		acc_bones = [
			bone_acc_head_01
			bone_acc_head_02
			bone_acc_head_03
	...
	}
	{
		...
		frontend_desc = qs(0xc6dd4c56)
		mesh = 'models/CAR/Male/M_Folk_Hair_GWTwoSideHair.skin'
		hat_hair = None
		acc_skeleton = skel_m_folk_hair_gwtwosidehair
		acc_ragdoll = rag_m_folk_hair_gwtwosidehair
		acc_bones = [
			bone_acc_head_01
			bone_acc_head_02
			bone_acc_head_03
...
cas_male_hat_hair = [
	...
	}
	{
		...
		mesh = 'models/CAR/Male/M_Folk_Hair_LSTailHair_Hat.skin'
		$cas_male_hat_hair_common_settings
		acc_skeleton = skel_m_folk_hair_lstailhair
		acc_ragdoll = rag_m_folk_hair_lstailhair
		acc_bones = [
	...
	{
		desc_id = m_folk_hair_lstailhair_hathair
		frontend_desc = qs(0x1d951c66)
		mesh = 'models/CAR/Male/M_Folk_Hair_LSTailHair.skin'
		materials = [
			lstailhair_primary
...
cas_male_hat = [
	...
	}
	{
		...
		frontend_desc = qs(0x9a9d6378)
		mesh = 'models/CAR/Male/M_Folk_Hat_AMSkull.skin'
		deform_mesh = 'models/CAR/Male/M_Folk_Hat_AMSkull_def.skin'
		genre = [
			folk
		]
		hat_hair = original_hair
		materials = [
			amjaguarskull_jaguarbandeau
		]
		random_weight = 1.0
		hidden
	}
	{
		...
		frontend_desc = qs(0x38316a86)
		mesh = 'models/CAR/Male/M_Folk_Hat_LSHightPlatformHat.skin'
		genre = [
			folk
		]
		materials = [
			lshightplatformhat_lshightplatformhat
		]
		random_weight = 1.0
		hidden
	}
