cas_male_legs = [
	...
	}
	{
		...
		frontend_desc = qs(0x968f7f96)
		mesh = 'models/CAR/Male/M_Rock_Legs_Cords.skin'
		materials = [
	...
	}
	{
		...
		frontend_desc = qs(0x2a37f3ed)
		mesh = 'models/CAR/Male/M_Folk_Legs_AMRitualSkirt.skin'
		materials = [
			m_folk_pants_ickitpants_ickitpants
		]
		genre = [
			folk
		]
	...
	}
	{
		...
		frontend_desc = qs(0x54ddb73b)
		mesh = 'models/CAR/Male/M_Folk_Legs_LSSewerPants.skin'
		materials = [
			lssewerleatherpants_lssewerleatherpants
		]
		genre = [
			folk
		]
	...
	}
	{
		...
		frontend_desc = qs(0x08353d2c)
		mesh = 'models/CAR/Male/M_Folk_Pants_ICKitPants.skin'
		materials = [
			m_folk_pants_ickitpants_ickit_pants
		]
		genre = [
			folk
		]
	...
	}
	{
		...
		frontend_desc = qs(0x00f64278)
		mesh = 'models/CAR/Male/M_Folk_Pants_NavajoLeather.skin'
		materials = [
			navajoleather_navajoleather
		]
		genre = [
			folk
		]
		acc_skeleton = skel_m_folk_pants_navajoleather
		acc_ragdoll = rag_m_folk_pants_navajoleather
		acc_bones = [
			bone_acc_legs_01
			bone_acc_legs_02
			bone_acc_legs_03
	...
	}
	{
		...
		frontend_desc = qs(0x7a697892)
		mesh = 'models/CAR/Male/M_Folk_Pants_SPSphinxdress.skin'
		materials = [
			spsphinxdress_spsphinxdress
		]
		genre = [
			folk
		]
	...
	}
	{
		...
		frontend_desc = qs(0xb7e40fec)
		mesh = 'models/CAR/Male/M_Folk_Legs_GWStapspant.skin'
		genre = [
			folk
		]
		hidden
