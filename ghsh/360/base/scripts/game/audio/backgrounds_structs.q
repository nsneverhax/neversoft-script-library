Skate8_SFX_Background_Areas_And_States = {
	...
	crowd_loop_london_good = {
		Default = london_crowd_good_loop
		Volume_Params = {
			london_crowd_good_loop = 32
		}
		Fade_From = {
			FrontEnd = 3
		}
	}
	crowd_loop_london_neutral = {
		Default = london_crowd_neutral_loop
		Volume_Params = {
			london_crowd_neutral_loop = 32
		}
		Fade_From = {
			FrontEnd = 3
		}
	}
	crowd_loop_london_bad = {
		Default = london_crowd_bad_loop
		Volume_Params = {
			london_crowd_bad_loop = 35
		}
		Fade_From = {
			FrontEnd = 3
		}
