			...
			if StructureContains structure = ($<tier_global>.<Tier>) songs
				...
				if (<unlocked> = 0)
					event_handlers = [
						...
						{pad_square ui_setlist_choose_artifact params = {tier_index = (<i> - 1)}}
...
script ui_setlist_choose_artifact 
	...
	ui_event_wait state = uistate_artifact data = {tier_index = <tier_index>}
endscript
...
script bx_resizesetlistdivider 
	<id> :desc_resolvealias Name = alias_setlist_divider_title
