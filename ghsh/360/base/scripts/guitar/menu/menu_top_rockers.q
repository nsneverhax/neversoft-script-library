...
script create_top_rockers_menu \{for_options = 0}
	...
	if NOT (<new_score> = -1)
		...
		add_user_control_helper text = qs(0xb73cb78f) button = green <all_button_params> z = 100
		add_user_control_helper text = qs(0x2a08d9a6) button = yellow <all_button_params> z = 100
		add_user_control_helper text = qs(0x1c2cd639) button = blue <all_button_params> z = 100
	else
	...
	my_tr_page :Obj_SpawnScriptNow \{bg_swap}
endscript
