...
g_ui_exploding_text_center_pos = (640.0, 310.0)
...
script create_exploding_text \{parent = 'you_rock_physics'
	...
	elseif (<placement> = bottom)
		...
		cont_pos = $g_ui_exploding_text_center_pos
	endif
...
script split_text_into_physics_array_elements \{text = qs(0x6f6d143d)
	...
	if GotParam \{fit_dims}
		...
		if (<placement> = top)
			...
			<cont_pos_x> = ($g_ui_exploding_text_center_pos.(1.0, 0.0))
			<cont_pos_y> = (($g_ui_exploding_text_center_pos.(0.0, 1.0)))
