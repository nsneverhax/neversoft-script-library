...
script jam_tutorial_ghtunes 
	Wait \{1
		Second}
	training_show_title \{title = qs(0x0c6d840e)}
	Wait \{1
		Second}
	...
	LaunchEvent \{Type = unfocus
		target = current_menu}
	jam_tutorial_add_arrow \{Pos = (560.0, 228.0)
		life = 2
		Scale = 0.5
		rot = 90}
	Wait \{3
		Seconds}
	jam_tutorial_add_arrow \{Pos = (560.0, 276.0)
		life = 2
		Scale = 0.5
		rot = 90}
	jam_tutorial_add_arrow \{Pos = (560.0, 330.0)
		life = 2
		Scale = 0.5
		rot = 90}
	Wait \{4
		Seconds}
	jam_tutorial_add_arrow \{Pos = (560.0, 430.0)
		life = 2
		Scale = 0.5
		rot = 90}
	Wait \{2
		Seconds}
	jam_tutorial_add_arrow \{Pos = (560.0, 530.0)
		life = 2
		Scale = 0.5
		rot = 90}
